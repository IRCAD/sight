...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_mesh_by_index")
    {
        ...
        CHECK_EQ(3, (int) m_series->get_reconstruction_db().size());
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_mesh_with_index_out_of_bound")
    {
        // Create new Models Series
        auto m_series = std::make_shared<sight::data::model_series>();
        CHECK(m_series);
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_mesh_by_type")
    {
        ...
        m_series->set_reconstruction_db(recs);
        CHECK_EQ(5, (int) m_series->get_reconstruction_db().size());
        CHECK_EQ(rec1, m_series->get_reconstruction_db()[0]);
        CHECK_EQ(rec2, m_series->get_reconstruction_db()[1]);
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_mesh_by_type_not_found")
    {
        // Create Models Series Object
        auto m_series = std::make_shared<sight::data::model_series>();
        CHECK(m_series);
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_mesh_by_name_not_found")
    {
        // Create Models Series Object
        auto m_series = std::make_shared<sight::data::model_series>();
        CHECK(m_series);
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_with_mesh_type_and_index")
    {
        // Create Models Series Object
        auto m_series = std::make_shared<sight::data::model_series>();
        CHECK(m_series);
...
// //------------------------------------------------------------------------------
    ...
    TEST_CASE("extracts_with_invalid_models_series")
    {
        // Create service
        sight::service::base::sptr get_mesh_serv = sight::service::add("sight::module::data::get_mesh");
        CHECK(get_mesh_serv);
