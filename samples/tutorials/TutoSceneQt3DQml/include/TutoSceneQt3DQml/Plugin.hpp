...
public:
    ...
    TUTOSCENEQT3DQML_API void start();

    /// Overrides stop method. Do nothing
    TUTOSCENEQT3DQML_API void stop() noexcept;

    TUTOSCENEQT3DQML_API void initialize();

    TUTOSCENEQT3DQML_API void uninitialize() noexcept;
};
