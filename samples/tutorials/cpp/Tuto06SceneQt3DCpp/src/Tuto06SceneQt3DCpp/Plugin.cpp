...
static core::runtime::utils::GenericExecutableFactoryRegistrar<Plugin> registrar("::Tuto06SceneQt3DCpp::Plugin");
...
void Plugin::initialize()
{
    ...
    ****************************************************************************************/
    ...
    const auto frameSrv = m_appManager->addService("::modules::ui::base::frame::SDefaultFrame", true, false);
    const auto menuBar  = m_appManager->addService("::modules::ui::base::aspect::SDefaultMenuBar", "menuBar", true,
                                                   false);
    const auto menu =
        m_appManager->addService("::modules::ui::base::aspect::SDefaultMenu", "menuFile", true, false);
    const auto actionOpenMesh = m_appManager->addService("::modules::ui::base::action::SStarter", "actionOpenMesh",
                                                         true,
                                                         false);
    const auto actionQuit = m_appManager->addService("::modules::ui::base::action::SQuit", "actionQuit", true, false);
    const auto mainView   =
