...
void axial_negato::test()
{
    ...
    start(
        ...
        [&snapshot_path, &reference_path](sight::ui::test::tester& _tester)
        {
            ...
            helper::line_edit::match(_tester, helper::selector::from_parent("top_scenes_view/0", "Label"), "67 / 133");

            // For the test to work, we must first reset all negatos to 0
            reset_negatos(_tester);

            helper::line_edit::match(_tester, helper::selector::from_parent("top_scenes_view/0", "Label"), "0 / 133");
            ...
            helper::line_edit::match(_tester, helper::selector::from_parent("top_scenes_view/0", "Label"), "133 / 133");
