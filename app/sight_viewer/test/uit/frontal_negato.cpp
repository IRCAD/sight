...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::sight_viewer::uit::frontal_negato);
...
void frontal_negato::test()
{
    namespace helper = sight::ui::test::helper;

    const std::string test_name               = "sightViewerFrontalNegatoTest";
    ...
    start(
        ...
        [&snapshot_path, &reference_path](sight::ui::test::tester& _tester)
        {
            ...
            helper::scene3d::rotate(_tester, "scene_srv", {0, 1 / 4.});
            ...
            helper::slider::set(
                _tester,
                helper::selector::from_parent("bottom_scenes_view/1", "negato_slicer_srv"),
                250
            );
