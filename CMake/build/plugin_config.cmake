...
function(plugin_setup ${PROJECT})
    ...
    if(REGISTER_SERVICES)
        ...
        configure_file( "${CMAKE_CURRENT_SOURCE_DIR}/CMake/build/registerServices.cpp.in"
                        "${CMAKE_BINARY_DIR}/${PROJECT}/registerServices.cpp")
    else()
        # Clean if necessary
        if(EXISTS "${CMAKE_BINARY_DIR}/${PROJECT}/registerServices.cpp")
            file(REMOVE "${CMAKE_BINARY_DIR}/${PROJECT}/registerServices.cpp")
        endif()
    endif()
