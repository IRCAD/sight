...
macro(fwCppunitTest FWPROJECT_NAME)
    ...
    if(TESTS_XML_OUTPUT)
        add_test(NAME ${FWPROJECT_NAME} WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/bin COMMAND ${${FWPROJECT_NAME}_SCRIPT} --xml)
        set_tests_properties(${FWPROJECT_NAME} PROPERTIES TIMEOUT 240)
    else()
        add_test(NAME ${FWPROJECT_NAME} WORKING_DIRECTORY ${CMAKE_BINARY_DIR}/bin COMMAND ${${FWPROJECT_NAME}_SCRIPT})
    endif()
