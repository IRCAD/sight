...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::sightviewer::test::ui::frontal_negato);
...
void frontal_negato::test()
{
    ...
    start(
        ...
        [&snapshot_path, &reference_path](sight::ui::test_core::tester& _tester)
        {
            ...
            helper::scene3d::rotate(_tester, "sceneSrv", {0, 1 / 2.});
            ...
            helper::slider::set(
                _tester,
                helper::selector::from_parent("bottomScenesView/1", "negatoSlicerSrv"),
                250
            );
