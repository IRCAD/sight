...
#include <ui/testCore/helper/file_dialog.hpp>
    ...
    if(_format == "DICOM" || _format == "Nifti or Inr images")
    {
        ...
        helper::button::wait_for_clickability(
            ...
            helper::selector("toolBarView/Show/hide volume").with_timeout(
                sight::ui::test_core::tester::DEFAULT_TIMEOUT*
                5
            )
        );
    }
...
void test::save_snapshot(sight::ui::test_core::tester& _tester, const std::filesystem::path& _path)
{
...
void test::reset_negatos(sight::ui::test_core::tester& _tester)
{
