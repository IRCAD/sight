 ...
 *
 * @code{.xml}
        <service type="Ex02TimeLine::consumer" >
            <in key="timeline" uid="..." />
            <id>0</id>
            <period>1000</period>
       </service>
...
class EXTIMELINE_CLASS_API consumer : public sight::service::base
{
public:
    ...
    EXTIMELINE_API consumer() noexcept;
    EXTIMELINE_API ~consumer() noexcept override;
