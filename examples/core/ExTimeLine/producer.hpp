 ...
 *
 * @code{.xml}
       <service type="Ex02TimeLine::producer" >
 ...
 */
class EXTIMELINE_CLASS_API producer : public sight::service::base
{
public:

    SIGHT_DECLARE_SERVICE(producer, sight::service::base);

    EXTIMELINE_API producer() noexcept           = default;
    EXTIMELINE_API ~producer() noexcept override = default;
