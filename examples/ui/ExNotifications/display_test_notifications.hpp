 ...
 */
class EXNOTIFICATIONS_CLASS_API display_test_notifications final :
...
public:
    ...
    /// @{
    /// Initializes slot.
    EXNOTIFICATIONS_API display_test_notifications() noexcept;
    EXNOTIFICATIONS_API ~display_test_notifications() noexcept override = default;
    /// @}
