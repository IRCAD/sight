...
//    CPPUNIT_ASSERT_EQUAL(patientDB1->getNumberOfPatients(), patientDB2->getNumberOfPatients());
//
//
...
//
//    CPPUNIT_ASSERT_EQUAL(patient1->getNumberOfStudies(), patient2->getNumberOfStudies());
//
...
//    CPPUNIT_ASSERT_EQUAL(study1->getNumberOfAcquisitions(), study2->getNumberOfAcquisitions());
//
...
//
//    CPPUNIT_ASSERT_EQUAL(acquisition1->getNumberOfReconstructions(), acquisition2->getNumberOfReconstructions());
//
...
////------------------------------------------------------------------------------
//
//void ObjectComparator::compareTransfertFunction(::fwData::TransfertFunction_VERSION_II::sptr tf1, ::fwData::TransfertFunction_VERSION_II::sptr tf2)
//{
//    CPPUNIT_ASSERT(tf1);
//    CPPUNIT_ASSERT(tf2);
//
//    CPPUNIT_ASSERT_EQUAL(tf1->getTFData().size(), tf2->getTFData().size());
//    CPPUNIT_ASSERT_EQUAL(tf1->getName(), tf2->getName());
//    CPPUNIT_ASSERT(tf1->getWindow() == tf2->getWindow());
//    CPPUNIT_ASSERT(tf1->getLevel() == tf2->getLevel());
//    CPPUNIT_ASSERT(tf1->getMinMaxTFValues() == tf2->getMinMaxTFValues());
//}
//
////------------------------------------------------------------------------------
//
