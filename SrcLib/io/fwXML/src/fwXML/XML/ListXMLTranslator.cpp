...
xmlNodePtr ListXMLTranslator::getXMLFrom( ::boost::shared_ptr<fwTools::Object> obj )
{
...
void ListXMLTranslator::updateDataFromXML( ::boost::shared_ptr<fwTools::Object> toUpdate,  xmlNodePtr source)
{
