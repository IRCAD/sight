...
xmlNodePtr StructureTraitsXMLTranslator::getXMLFrom( ::fwTools::Object::sptr obj )
{
...
void StructureTraitsXMLTranslator::updateDataFromXML( ::fwTools::Object::sptr toUpdate,  xmlNodePtr source)
{
