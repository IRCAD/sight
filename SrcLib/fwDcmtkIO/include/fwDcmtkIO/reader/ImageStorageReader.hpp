...
protected:
     ...
     * @param[in] imageType Image Type
     */
    FWDCMTKIO_API void lazyRead(::fwData::Image::sptr image, ::fwDicomData::DicomSeries::sptr series,
                                unsigned short rows, unsigned short columns, int depth, double rescaleSlope,
                                double rescaleIntercept,
                                unsigned short pixelRepresentation, ::fwTools::Type imageType);
     ...
     * @param[in] imageType Image type
     */
    FWDCMTKIO_API void lazyRGBLookupRead(::fwData::Image::sptr image, ::fwDicomData::DicomSeries::sptr series,
