...
void DicomSeriesDBReader::convertDicomSeries(SPTR(::fwDicomData::DicomSeries)dicomSeries,
                                             bool notify)
{
    ...
    else
    {
        ...
        ::fwDicomData::DicomSeries::DicomPathContainerType instances = dicomSeries->getLocalDicomPaths();
        DcmFileFormat fileFormat;
        OFCondition status;
        DcmDataset* dataset;
