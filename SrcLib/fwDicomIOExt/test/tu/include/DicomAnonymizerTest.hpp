...
#ifndef __FWDICOMIOEXT_TEST_TU_DICOMANONYMIZER_HPP__
#define __FWDICOMIOEXT_TEST_TU_DICOMANONYMIZER_HPP__
...
#endif // __FWDICOMIOEXT_TEST_TU_DICOMANONYMIZER_HPP__
