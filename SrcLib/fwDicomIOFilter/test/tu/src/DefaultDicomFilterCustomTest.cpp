...
void DefaultDicomFilterCustomTest::simpleApplication()
{
    ...
    ::fwDicomData::DicomSeries::DicomPathContainerType dicomPaths = dicomSeriesA->getLocalDicomPaths();
    std::vector< std::string > filenames;
    ::fwDicomData::DicomSeries::DicomPathContainerType::iterator itPath = dicomPaths.begin();
