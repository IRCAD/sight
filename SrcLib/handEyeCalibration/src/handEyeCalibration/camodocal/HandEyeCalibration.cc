...
// docs in header
void
HandEyeCalibration::estimateHandEyeScrew(const std::vector<Eigen::Vector3d,
                                                ...
                                                bool planarMotion)
{
    ...
    else
    {
        ...
        else
        {
            ...
            ss <<
                "camodocal::HandEyeCalibration error: normalization could not be handled. Your rotations and translations are probably either not aligned or not passed in properly.";
            ss << "u1:" << std::endl;
            ss << u1 << std::endl;
            ss << "v1:" << std::endl;
            ss << v1 << std::endl;
            ...
            ss << v2 << std::endl;
            ss <<
                "Not handled yet. Your rotations and translations are probably either not aligned or not passed in properly."
               << std::endl;
