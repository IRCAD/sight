...
bool
PlanarHandEyeCalibration::estimate(const std::vector<Eigen::Quaterniond,
...
bool
PlanarHandEyeCalibration::estimateRyx(const std::vector<Eigen::Quaterniond,
                                                        Eigen::aligned_allocator<Eigen::Quaterniond> >& quats1,
                                      const std::vector<Eigen::Vector3d,
                                                        Eigen::aligned_allocator<Eigen::Vector3d> >& tvecs1,
                                      const std::vector<Eigen::Quaterniond,
...
PlanarHandEyeCalibration::refineEstimate(Eigen::Matrix4d& H_12,
                                         ...
                                         const std::vector<Eigen::Quaterniond,
                                                           Eigen::aligned_allocator<Eigen::Quaterniond> >& quats2,
                                         const std::vector<Eigen::Vector3d,
                                                           Eigen::aligned_allocator<Eigen::Vector3d> >& tvecs2) const
{
