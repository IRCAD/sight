...
#include "fwGuiQt/PulseProgressDialog.hpp"


REGISTER_BINDING( ::fwGui::IPulseProgressDialog, ::fwGuiQt::PulseProgressDialog, ::fwGui::IPulseProgressDialog::FactoryRegistryKeyType , ::fwGui::IPulseProgressDialog::REGISTRY_KEY );
