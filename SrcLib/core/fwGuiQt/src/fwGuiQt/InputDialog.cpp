...
#include "fwGuiQt/InputDialog.hpp"


REGISTER_BINDING( ::fwGui::IInputDialog, ::fwGuiQt::InputDialog, ::fwGui::IInputDialog::FactoryRegistryKeyType , ::fwGui::IInputDialog::REGISTRY_KEY );
