 ...
 *
 */
class FWGUIQT_CLASS_API MessageDialog : public ::fwGui::IMessageDialog
{
...
protected:
    ...
    /// List of the button
    ::fwGui::IMessageDialog::Buttons m_buttons;
    /// Icon
    ::fwGui::IMessageDialog::Icons m_icon;

    //static const std::map< ::fwGui::IMessageDialog::Icons, QMessageBox::Icon> qtIcons;
};
