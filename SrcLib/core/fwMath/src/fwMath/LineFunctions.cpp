...
bool intersect(const fwLine& _line, double _radius,fwVec3d _vec0, fwVec3d _vec1, fwVec3d _point)
{
    ...
    fwVec3d pThis;
    if(getClosestPoints(_line, line,pThis,_point) == false)
    {
        return false;
    }
                ...
                fwVec3d &_barycentric, bool& _front)
{
    ...
    if((float)(dot(normal, cross(v01, _point-_v1)))<0.0F)
    {
        return false;
    }
    if((float)(dot(normal, cross(v12, _point-_v2)))<0.0F)
    {
        return false;
    }
    if((float)(dot(normal, cross(v20, _point-_v3)))<0.0F)
    {
        return false;
    }
    return true;
