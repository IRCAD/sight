 ...
 */
class FWGUIQML_CLASS_API ActionCallback :  public QObject,
...
public:
    ...
    FWGUIQML_API ActionCallback(::fwGui::GuiBaseObject::Key key);

    FWGUIQML_API virtual ~ActionCallback();

    /**
     * @brief  Qml slot.
     */
public Q_SLOTS:
    void executeQml(bool checked = false);
    void checkQml(bool checked);
