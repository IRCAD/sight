 ...
 */
class FWGUIQML_CLASS_API LineLayoutManager : public ::fwGui::layoutManager::LineLayoutManagerBase
{
...
public:
    ...
    FWGUIQML_API LineLayoutManager(::fwGui::GuiBaseObject::Key key);

    FWGUIQML_API virtual ~LineLayoutManager();
