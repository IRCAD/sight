 ...
 */
class FWGUIQML_CLASS_API ToolBarLayoutManager : public ::fwGui::layoutManager::IToolBarLayoutManager
{
public:
    ...
    FWGUIQML_API ToolBarLayoutManager(::fwGui::GuiBaseObject::Key key);

    FWGUIQML_API virtual ~ToolBarLayoutManager();
     ...
     */
    FWGUIQML_API virtual void createLayout( ::fwGui::container::fwToolBar::sptr parent ) override;
...
protected:
    ::fwGuiQml::container::QmlToolBarContainer::sptr m_parent;
