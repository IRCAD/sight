...
#ifndef __FWCOMED_HELPER_ARRAYGETTER_HPP__
#define __FWCOMED_HELPER_ARRAYGETTER_HPP__
 ...
 *
 */
class FWCOMED_CLASS_API ArrayGetter
{
...
public:
    ...
    FWCOMED_API ArrayGetter( ::fwData::Array::csptr array );

    FWCOMED_API virtual ~ArrayGetter();
     ...
     */
    FWCOMED_API virtual const void* getItem(const ::fwData::Array::IndexType &id, const size_t component = 0) const;
...
#endif // __FWCOMED_HELPER_ARRAYGETTER_HPP__
