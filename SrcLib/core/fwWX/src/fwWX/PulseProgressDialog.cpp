...
#include "fwWX/PulseProgressDialog.hpp"


REGISTER_BINDING( ::fwGui::IPulseProgressDialog, ::fwWX::PulseProgressDialog, ::fwGui::IPulseProgressDialog::FactoryRegistryKeyType , ::fwGui::IPulseProgressDialog::REGISTRY_KEY );
