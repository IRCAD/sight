...
Data::Data(::fwAtomConversion::AtomHelper& helper) : m_helper(helper)
{
}
...
void Data::processMetaInfos(const ::fwAtoms::Object::MetaInfos& metaInfos)
{
...
void Data::processAttribut(const std::string & name, const Attributes::mapped_type & attribut)
{
    ...
    switch(type)
    {
        ...
        case(::camp::userType):
            ...
            {
                ::fwAtoms::Blob::sptr blob = fwAtoms::Blob::dynamicCast(attribut);
                ::fwTools::BufferObject::sptr buffer;
                buffer = ::camp_ext::ValueMapper< ::fwAtoms::Blob::sptr>::to(blob);
