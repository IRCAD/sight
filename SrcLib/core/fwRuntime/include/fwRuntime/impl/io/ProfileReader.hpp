...
public:
     ...
     */
    static std::shared_ptr< ::fwRuntime::impl::profile::Profile > processProfile(xmlNodePtr node);
    static std::shared_ptr< ::fwRuntime::impl::profile::Starter > processStarter(xmlNodePtr node);
     ...
     */
    static std::shared_ptr< ::fwRuntime::impl::profile::Activater > processActivater(xmlNodePtr node);
    ...
    static void processActivaterParam(xmlNodePtr node,
                                      std::shared_ptr< ::fwRuntime::impl::profile::Activater > activater);
