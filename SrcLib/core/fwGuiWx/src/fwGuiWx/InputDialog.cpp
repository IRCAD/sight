...
#include "fwGuiWx/InputDialog.hpp"

REGISTER_BINDING( ::fwGui::IInputDialog, ::fwGuiWx::InputDialog, ::fwGui::IInputDialog::FactoryRegistryKeyType , ::fwGui::IInputDialog::REGISTRY_KEY );
