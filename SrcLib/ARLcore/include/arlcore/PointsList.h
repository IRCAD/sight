...
namespace arlCore
{
enum ARLCORE_SCE { ARLCORE_SCE_UNKNOWN, ARLCORE_SCE_ANALYTIC, ARLCORE_SCE_GEOMETRIC, ARLCORE_SCE_OPTIMIZATION,
                   ARLCORE_SCE_4POINTS, ARLCORE_SCE_NBMETHOD };
static std::string ARLCORE_SCE_NAMES[ARLCORE_SCE_NBMETHOD] =
{ "ARLCORE_SCE_UNKNOWN", "ARLCORE_SCE_ANALYTIC", "ARLCORE_SCE_GEOMETRIC", "ARLCORE_SCE_OPTIMIZATION",
  "ARLCORE_SCE_4POINTS"};
...
public:
     ...
     */
    ARLCORE_API bool save( const std::string& fileName, ARLCORE_POINT_SAVE_TYPE type = ARLCORE_POINT_SAVE_FULL,
                           bool justVisible = false, bool overwrite = true ) const;
     ...
     */
    ARLCORE_API bool properties( SPTR(Point) gravity, SPTR(Point) boundingBox1, SPTR(
                                     Point) boundingBox2, double& minscalar, double& maxscalar, double& std ) const;
     ...
     */
    ARLCORE_API unsigned int findNearPoint( CSPTR(
     ...
     */
    ARLCORE_API unsigned int shapeRandom( unsigned int nb, ARLCORE_SHAPE type, CSPTR(
                                              Point) centre, const double size, const double angle = 0 );
     ...
     */
    ARLCORE_API unsigned int plane( vgl_plane_3d< double >& plane, double& rms, double& min, double& max,
                                    double scalar = 0, double outliers = 0.0 ) const;
    ARLCORE_API unsigned int plane( vgl_homg_plane_3d< double >& plane, double& rms, double& min, double& max,
                                    double scalar = 0, double outliers = 0.0 ) const;
     ...
     */
    ARLCORE_API bool sphereCenterEstimation( SPTR(
                                                 Point) centerEstimation, double& radius, ARLCORE_SCE type, std::vector<double> &optimiser_parameter,
     ...
     */
    ARLCORE_API bool triangleCircumcircleOrthoLine( SPTR(Point)  centerEstimation,
     ...
     */
    ARLCORE_API unsigned int tagCalibration( const std::vector<arlCore::PointList::sptr >& tag, double delta,
...
ARLCORE_API bool save( const std::vector< Point::csptr >& pl, const std::string& fileName,
                       ARLCORE_POINT_SAVE_TYPE type = ARLCORE_POINT_SAVE_FULL, bool justVisible = false,
                       bool overwrite = true );
ARLCORE_API bool save( const std::vector< Point::sptr >& pl, const std::string& fileName,
                       ARLCORE_POINT_SAVE_TYPE type = ARLCORE_POINT_SAVE_FULL, bool justVisible = false,
                       bool overwrite = true );
...
ARLCORE_API unsigned int matching3D3D( CSPTR( PointList ) a, CSPTR(
                                           PointList ) b, double gaussianError, double decimage, SPTR(
                                           PointList ) Va, SPTR( PointList ) Vb );
} // namespace arlCore
#endif // __ARLCORE_POINTSLIST_H__
