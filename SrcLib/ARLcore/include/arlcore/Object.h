...
#ifndef __ARLCORE_OBJECT_H__
#define __ARLCORE_OBJECT_H__
...
static std::string ARLCORE_CLASS_NAMES[ARLCORE_CLASS_NBTYPES] = { "OBJECT", "PLANESYSTEM", "CAMERA", "TRACKER",
                                                                  "POINT", "POINTLIST", "TAG", "TAGS", "MATRIXR",
                                                                  "SCENE",
                                                                  "SEQUENCE", "XML", "TOOL", "ROBOT", "IMAGE", "VIDEO",
                                                                  "SERVER", "AURORA" };

//! @brief Avalaible levels of verbosity
enum ARLCORE_LOG_VERBOSE { ARLCORE_LOG_MUTE, ARLCORE_LOG_DISCREET, ARL_LOG_REGULAR, ARLCORE_LOG_GARRULOUS,
                           ARLCORE_LOG_UNQUENCHABLE, ARLCORE_LOG_VERBOSE_NBTYPES };
...
protected:
    ...
    ARLCORE_API enum ARLCORE_LOG_SERIOUSNESS { ARLCORE_LOG_ERROR, ARLCORE_LOG_WARNING, ARLCORE_LOG_INFO_LEVEL2,
                                               ARLCORE_LOG_INFO_LEVEL1, ARLCORE_LOG_SERIOUSNESS_NBTYPES };
