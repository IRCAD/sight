...
#ifndef __ARLCORE_MESH_H__
#define __ARLCORE_MESH_H__
...
public:
    ...
    ARLCORE_API bool generateX( double ySize, double zSize, double yStep, double zStep, double degree,
                                double gaussianNoise, PointList::sptr summits );

    //! @brief Generate a surface where altitude is on Y-axis
    ARLCORE_API bool generateY( double xSize, double zSize, double xStep, double zStep, double degree,
                                double gaussianNoise, PointList::sptr summits );

    //! @brief Generate a surface where altitude is on Z-axis
    ARLCORE_API bool generateZ( double xSize, double ySize, double xStep, double yStep, double degree,
                                double gaussianNoise, PointList::sptr summits );
...
private:
    ...
    bool generate( unsigned int axis, double width, double length, double stepW, double stepL, double degree,
                   double gaussianNoise, PointList::sptr summits );
