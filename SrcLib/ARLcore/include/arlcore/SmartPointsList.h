...
public:
     ...
     */
    ARLCORE_API Point::csptr push_back( Point::csptr pt, unsigned int cam,  SPTR(void) videoTag = SPTR(
                                            void)(), int fringe = 0 );
     ...
     * VideoTag pointer and fringe number are optional
     */
    ARLCORE_API unsigned int push_back( const std::vector< arlCore::Point::csptr >&, unsigned int cam, SPTR(
                                            void) videoTag = SPTR(void)(), int fringe = 0 );
     ...
     * VideoTag pointer and fringe number are optional
     */
    ARLCORE_API const std::vector< Point::csptr >& getList( unsigned int cam, SPTR(void) videoTag = SPTR(
                                                                void)(), int fringe = 0 ) const;
     ...
     */
    ARLCORE_API unsigned int findNearPoint(double x, double y, unsigned int cam, std::vector< Point::csptr >& found,
                                           double& distance, double radius = -1.0) const;
     ...
     * @return Number of found points
     */
    ARLCORE_API unsigned int getPointByCam( std::vector<Point::csptr>&pl,
                                            const std::vector<const arlCore::Camera*> &cams, SPTR(
                                                void) videoTag, unsigned int no, std::vector< bool >&whichCams) const;
    ARLCORE_API unsigned int getPointByCam( std::vector<Point::csptr>&pl, const std::vector<arlCore::Camera> &cams, SPTR(
                                                void) videoTag, unsigned int no, std::vector< bool >&whichCams) const;
    /**
     ...
     */
    ARLCORE_API unsigned int getPoints( std::vector<Point::csptr>&pl, unsigned int cam, SPTR(void) videoTag = SPTR(
                                            void)() ) const;
    ...
    ARLCORE_API unsigned int getInvisiblePoints( std::vector<Point::csptr>&, unsigned int cam, SPTR(void) t = SPTR(
                                                     void)() ) const;
 ...
 */
ARLCORE_API unsigned int epipolarMatching( const std::vector<Camera>&cameras, CSPTR(
                                               SmartPointList ) points2D, std::vector< std::vector<Point::csptr> >&matching,
