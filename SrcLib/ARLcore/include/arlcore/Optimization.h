...
#ifndef __ARLCORE_OPTIMIZATION_H__
#define __ARLCORE_OPTIMIZATION_H__
 ...
 */
class OptimisePlane : public vnl_cost_function,
                      public CostFunction
{
public:
 ...
 */
class OptimiseICP : public vnl_cost_function,
                    public CostFunction
{
public:
 ...
 */
class OptimiseICP_LS : public vnl_least_squares_function,
                       public CostFunction
{
public:
 ...
 */
class Optimise3DLine : public vnl_cost_function,
                       public CostFunction
{
public:
 ...
 */
class OptimisePivot : public vnl_cost_function,
                      public CostFunction
{
public:
 ...
 */
class OptimiseVideoRobot1 : public vnl_cost_function,
                            public CostFunction
{
public:
 ...
 * Points 3D dans le repere des cameras apres transformation Modele->cameras = inv(X)*inv(A)*inv(Z)
 */
class OptimiseVideoRobotX : public vnl_cost_function,
                            public OptimiseVideoRobot
{
public:
 ...
 */
class OptimiseVideoRobotX_LS : public vnl_least_squares_function,
                               public OptimiseVideoRobot
{
public:
 ...
 * Points 3D dans le repere des cameras apres transformation Modele->cameras = inv(X)*inv(A)*inv(Z)
 */
class OptimiseVideoRobotZ : public vnl_cost_function,
                            public OptimiseVideoRobot
{
public:
 ...
 */
class OptimiseVideoRobotZ_LS : public vnl_least_squares_function,
                               public OptimiseVideoRobot
{
public:
 ...
 * Points 3D dans le repere des cameras apres transformation Modele->cameras = inv(X)*inv(A)*inv(Z)
 */
class OptimiseVideoRobotXZ : public vnl_cost_function,
                             public OptimiseVideoRobot
{
public:
 ...
 */
class OptimiseVideoRobotXZ_LS : public vnl_least_squares_function,
                                public OptimiseVideoRobot
{
public:
 ...
 */
class OptimiseReprojection : public vnl_cost_function,
                             public CostFunction
{
public:
    ARLCORE_API OptimiseReprojection(const std::vector<const Camera*>& cameras,
                                     const std::vector<Point::csptr>& points2D);
 ...
 */
class Dornaika_cost_function : public vnl_cost_function,
                               public CostFunction
{
public:
    ARLCORE_API Dornaika_cost_function(const std::vector< vnl_rigid_matrix >& A,
                                       const std::vector< vnl_rigid_matrix >& B);
 ...
 * @brief   AX=XB resolution by optimization of Dornaika method
 */
class Dornaika_LS_cost_function : public vnl_least_squares_function,
                                  public CostFunction
{
public:
    ARLCORE_API Dornaika_LS_cost_function(const std::vector< vnl_rigid_matrix >& A,
                                          const std::vector< vnl_rigid_matrix >& B,
 ...
 */
class Polynomial_cost_function : public vnl_cost_function,
                                 public CostFunction
{
public:
 ...
 */
class OptimiseReprojectionUncertainty : public vnl_cost_function,
                                        public CostFunction
{
public:
    ARLCORE_API OptimiseReprojectionUncertainty(const std::vector<const Camera*>& cameras,
                                                const std::vector<Point::csptr>& points2D);
 ...
 */
class OptimiseLineIntersection : public vnl_cost_function,
                                 public CostFunction
{
public:
 ...
 */
class EPPC_cost_function : public vnl_cost_function,
                           public CostFunction
{
public:
    ...
    ARLCORE_API double get3Derror() const
    {
        return m_3Derror(0,0);
    }
    ARLCORE_API double get2Derror() const
    {
        return m_2Derror(0,0);
    }
 ...
 */
class EPPC_LS_cost_function : public vnl_least_squares_function,
                              public CostFunction
{
public:
 ...
 */
class ISPPC_cost_function : public vnl_cost_function,
                            public CostFunction
{
public:
    ...
    double f(vnl_vector<double> const& x);
    void gradf(vnl_vector<double> const& x, vnl_vector<double>& g);
    ARLCORE_API double getNoiseFeature() const
    {
        return m_noise_feature;
    }
    ARLCORE_API void   setNoiseFeature(bool feat)
    {
        m_noise_feature = feat;
    }
 ...
 */
class ISPPC_LS_cost_function : public vnl_least_squares_function,
                               public CostFunction
{
public:
 ...
 * during the minimization
 */
class OSPPC_cost_function : public vnl_cost_function,
                            public CostFunction
{
public:
 ...
 */
class OSPPC_LS_cost_function : public vnl_least_squares_function,
                               public CostFunction
{
public:
 ...
 */
class Intrinsic_cost_function : public vnl_cost_function,
                                public CostFunction
{
public:
    ...
    ARLCORE_API unsigned int addPattern( const std::vector<Point::sptr >& points2D,
                                         const std::vector<Point::sptr >& model3D );
    double f(vnl_vector<double> const& x);
    void gradf(vnl_vector<double> const& x, vnl_vector<double>& g);
 ...
 */
class IntrinsicLS_cost_function : public vnl_least_squares_function,
                                  public CostFunction
{
public:
    ARLCORE_API IntrinsicLS_cost_function(unsigned int number_of_unknowns, unsigned int number_of_residuals,
                                          UseGradient g = use_gradient);
 ...
 */
class Extrinsic_cost_function : public vnl_cost_function,
                                public CostFunction
{
public:
    ...
    double f(vnl_vector<double> const& x);
    ARLCORE_API unsigned int addPattern( const std::vector<std::vector<Point::csptr > >& points2D,
                                         const std::vector<Point::csptr >& model3D );
    //void gradf(vnl_vector<double> const &x, vnl_vector<double>& g);
    ARLCORE_API void setVerbose( bool verbose = true );
    ARLCORE_API std::vector<double> getReprojectionError( vnl_vector< double > const& x );
 ...
 * or of 4 !
 */
class ExtrinsicLS_cost_function : public vnl_least_squares_function,
                                  public CostFunction
{
public:
    ARLCORE_API ExtrinsicLS_cost_function(const std::vector<const Camera*>& a,unsigned int number_of_unknowns,
                                          unsigned int number_of_residuals, UseGradient g = use_gradient);
 ...
 */
class AX_XB_cost_function : public vnl_cost_function,
                            public CostFunction
{
public:
 ...
 */
class AXB_Z_cost_function : public vnl_cost_function,
                            public CostFunction
{
public:
    ARLCORE_API AXB_Z_cost_function(
 ...
 */
class register3D3DUncertainty_cost_function : public vnl_cost_function,
                                              public CostFunction
{
public:
 ...
 */
class register3D3DUncertainty_LS_cost_function : public vnl_least_squares_function,
                                                 public CostFunction
{
public:
 ...
 */
class averageRotation_cost_function : public vnl_cost_function,
                                      public CostFunction
{
public:
    ARLCORE_API averageRotation_cost_function(const std::vector< arlCore::vnl_rotation3d_matrix* > list) :
        vnl_cost_function(6),
        m_rotation_list(
            list)
    {
    ...
    ARLCORE_API inline std::vector< arlCore::vnl_rotation3d_matrix* > get_matrix_list() const
    {
        return this->m_rotation_list;
    }
    ARLCORE_API inline int get_nou() const
    {
        return this->number_of_unknowns;
    }
    ARLCORE_API inline void set_nou(int a)
    {
        this->number_of_unknowns = a;
    }
    ARLCORE_API inline void set_matrix_list(std::vector< arlCore::vnl_rotation3d_matrix* > a)
    {
        this->m_rotation_list = a;
    }
...
#endif // __ARLCORE_OPTIMIZATION_H__
