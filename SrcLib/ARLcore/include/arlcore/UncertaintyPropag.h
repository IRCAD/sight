...
#ifndef __ARLCORE_UNCERTAINTYPROPAG_H__
#define __ARLCORE_UNCERTAINTYPROPAG_H__
 ...
 *
 */
ARLCORE_API bool propagateCovarianceToReconst3D( const std::vector<arlCore::Point::csptr>&list2D,
                                                 const std::vector<const arlCore::Camera*> &camsList,
                                                 SPTR(
                                                     Point ) point3D, arlCore::ARLCORE_RECONSTRUCTION3D methode, std::vector<double> &log,
...
#endif //__ARLCORE_UNCERTAINTYPROPAG_H__
