...
#ifndef __ARLCORE_SCENES_H__
#define __ARLCORE_SCENES_H__
...
{
public:
    ARLCORE_API SceneUnitTestInitIntrinsicCalib( PlaneSystem&, std::vector<double> k_range,
                                                 const unsigned int nbCameras_MAX, const unsigned int nbPoses_MAX);
...
{
public:
    ARLCORE_API SceneCriterionComparison( PlaneSystem&, std::vector<double> parameters,
