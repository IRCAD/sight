...
#ifndef __ARLCORE_CAMERA_H__
#define __ARLCORE_CAMERA_H__
...
public:
     ...
     */
    ARLCORE_API bool syntheticCamera( Point::csptr center, Point::csptr viewPoint,
     ...
     */
    ARLCORE_API bool loadParameters( const std::string& fileName, const long int date, unsigned int width,
                                     unsigned int height );
     ...
     */
    ARLCORE_API bool loadOldParameters( const std::string& fileName, long int date, unsigned int width,
                                        unsigned int height );
     ...
     */
    ARLCORE_API bool projectiveLine( const vnl_vector_fixed<double,3>& focalPt2DH,
                                     vgl_line_3d_2_points <double>& line3D ) const;
     ...
     */
    ARLCORE_API bool project3DPoint( const vnl_vector_fixed<double,4>& point3DH, vnl_vector_fixed<double,2>& point2D,
                                     bool focalPlane = false) const;
     ...
     */
    ARLCORE_API unsigned int project3DPoint( PointList::csptr list3D, PointList::sptr list2D,
                                             bool FocalFrame = false) const;
    ...
    ARLCORE_API bool pixelPlaneToUnitFocalPlane( const vgl_point_2d<double>&, vgl_point_3d<double>&,
                                                 bool perfectDisto ) const;

    //! @brief Set a 3D point from focalframe to extrinsicFrame
    ARLCORE_API bool focalFrameToExtrinsicFrame( const vnl_vector_fixed< double, 3 >&,
     ...
     */
    ARLCORE_API bool focalToPixelLine( double a, double b, double c, CSPTR( Point ) org, CSPTR( Point ) dst, SPTR(
                                           PointList ) pl, unsigned int nbSegments = 0 ) const;
...
ARLCORE_API bool getEpipolar(const vnl_vector_fixed<double,3>& p, const vnl_matrix_fixed<double,4,4>& PM, double& a,
                             double& b, double& c);
ARLCORE_API bool getEpipolar(const vnl_vector_fixed<double,3>& p, const vnl_matrix_fixed<double,4,4>& PM,
                             vgl_line_2d< double >& d);

} // namespace arlCore
#endif // __ARLCORE_CAMERA_H__
