...
namespace arlCore
{
enum ARLCORE_POINT_SAVE_TYPE { ARLCORE_POINT_SAVE_FULL, ARLCORE_POINT_SAVE_LIGHT, ARLCORE_POINT_SAVE_GNUPLOT,
                               ARLCORE_POINT_SAVE_VTK };

enum ARLCORE_SHAPE { ARLCORE_SHAPE_UNKNOWN, ARLCORE_SHAPE_CUBE, ARLCORE_SHAPE_SPHERE, ARLCORE_SHAPE_SPHERESURFACE,
                     ARLCORE_SHAPE_SPHERE_CAP, ARLCORE_SHAPE_DISC,
                     ARLCORE_SHAPE_PLAINSQUARE, ARLCORE_SHAPE_CIRCLE, ARLCORE_SHAPE_EDGESQUARE,
                     ARLCORE_SHAPE_SOLIDANGLE, ARLCORE_SHAPE_SOLIDANGLE_SURFACE, ARLCORE_SHAPE_CHESSBOARD,
                     ARLCORE_SHAPE_NBSHAPES };
static std::string ARLCORE_SHAPE_NAMES[ARLCORE_SHAPE_NBSHAPES] =
...
public:
    ...
    enum ARLCORE_POINT_TYPE { ARLCORE_POINT_TYPE_UNKNOWN, ARLCORE_POINT_TYPE_ARTK, ARLCORE_POINT_TYPE_MRO,
                              ARLCORE_POINT_TYPE_CHESS, ARLCORE_POINT_TYPE_ROI, ARLCORE_POINT_TYPE_CLOUD,
                              ARLCORE_POINT_TYPE_TIP,
                              ARLCORE_POINT_TYPE_TOP, ARLCORE_POINT_TYPE_LINE, ARLCORE_POINT_TYPE_SIFT,
                              ARLCORE_POINT_NBTYPES };

    //! @brief Status of the point (Evolution)
    enum ARLCORE_POINT_STATUS { ARLCORE_POINT_STATUS_UNKNOWN, ARLCORE_POINT_STATUS_DETECTED,
                                ARLCORE_POINT_STATUS_SUBPIXEL, ARLCORE_POINT_STATUS_ESTIMATE,
                                ARLCORE_POINT_STATUS_CLOUD,
                                ARLCORE_POINT_REPROJECTION, ARLCORE_POINT_NBSTATUS };

    //! @brief Constructor
    ARLCORE_API Point( unsigned int dimension = 3, ARLCORE_POINT_TYPE type = ARLCORE_POINT_TYPE_UNKNOWN,
                       long int date = 0, long int time = 0 );

    //! @brief 2D point constructor
    ARLCORE_API Point( double x, double y, ARLCORE_POINT_TYPE type = ARLCORE_POINT_TYPE_UNKNOWN, long int date = 0,
                       long int time = 0 );

    //! @brief 3D point constructor
    ARLCORE_API Point( double x, double y, double z, ARLCORE_POINT_TYPE type = ARLCORE_POINT_TYPE_UNKNOWN,
                       long int date = 0, long int time = 0 );
...
private:
    ...
    ARLCORE_API bool save( std::fstream &f, bool ctf, unsigned int cam, SPTR(
                               void) tag, int fringe, unsigned no, ARLCORE_POINT_SAVE_TYPE type ) const;

    //! @brief Load a point from an open file stream (PointList or SmartPointList)
    ARLCORE_API bool load( std::ifstream &f, unsigned int& cam, SPTR(
                               void) tag, int& fringe, int& no, unsigned int dim = 0 );
 ...
 */
ARLCORE_API unsigned int closestY ( const std::vector< arlCore::Point::csptr >& l, double y, unsigned int index1 = 0,
                                    unsigned int index2 = 0, int indexInit = -1 );
