...
#ifndef __ARLCORE_MATRIXR_H__
#define __ARLCORE_MATRIXR_H__
...
namespace arlCore
{
enum ARLCORE_REGISTER3D3D { ARLCORE_REGISTER3D3D_UNKNOWN, ARLCORE_REGISTER3D3D_LM, ARLCORE_REGISTER3D3D_POW,
                            ARLCORE_REGISTER3D3D_GC, ARLCORE_REGISTER3D3D_NBTYPES };
static std::string ARLCORE_REGISTER3D3D_NAMES[ARLCORE_REGISTER3D3D_NBTYPES] =
{ "ARLCORE_REGISTER3D3D_UNKNOWN", "ARLCORE_REGISTER3D3D_LM",
  "ARLCORE_REGISTER3D3D_POW",
  "ARLCORE_REGISTER3D3D_GC"};

enum ARLCORE_VRM_DISTANCE_METHOD { ARLCORE_VRM_DISTANCE_UNKNOWN, ARLCORE_VRM_DISTANCE_3AXIS,
                                   ARLCORE_VRM_DISTANCE_TRANSLATION,
                                   ARLCORE_VRM_DISTANCE_OX, ARLCORE_VRM_DISTANCE_OY, ARLCORE_VRM_DISTANCE_OZ,
                                   ARLCORE_VRM_DISTANCE_NBTYPES};
static std::string ARLCORE_VRM_DISTANCE_METHOD_NAMES[ARLCORE_VRM_DISTANCE_NBTYPES] = { "ARLCORE_VRM_DISTANCE_UNKNOWN",
                                                                                       "ARLCORE_VRM_DISTANCE_3AXIS",
                                                                                       "ARLCORE_VRM_DISTANCE_TRANSLATION",
                                                                                       "ARLCORE_VRM_DISTANCE_OX",
                                                                                       "ARLCORE_VRM_DISTANCE_OY",
                                                                                       "ARLCORE_VRM_DISTANCE_OZ" };
 ...
 */
class vnl_rigid_matrix : public vnl_matrix_fixed<double,4,4>,
                         public Object
{
public:
     ...
     */
    ARLCORE_API double distance2( const vnl_rigid_matrix& T, ARLCORE_VRM_DISTANCE_METHOD method,
     ...
     */
    ARLCORE_API double distance( const vnl_rigid_matrix& T,
                                 ARLCORE_VRM_DISTANCE_METHOD method = ARLCORE_VRM_DISTANCE_3AXIS ) const;
     ...
     */
    ARLCORE_API bool register3D3DUncertainty( CSPTR(PointList) a, CSPTR(
                                                  PointList) b, ARLCORE_REGISTER3D3D, std::vector<double> optimiserParameters,
                                              std::vector<double> &log /*, unsigned int numberOfPoints=0*/ );
     ...
     * @param[out] B = this * A
     */
    ARLCORE_API bool register3D3DwithoutMatching( CSPTR(PointList) A, CSPTR(
                                                      PointList) B, bool computeRMS = false, double gaussianError = 0.0,
                                                  double decimage = 1.0 );
     ...
     */
    ARLCORE_API bool registerICP( CSPTR(PointList) Model, CSPTR(
                                      PointList) cloud,
                                  double& firstRMS, double& lastRMS, unsigned int& iterations, bool justVisible = false, double RMSMax = 0.01,
                                  unsigned int iterationsMax = 500 );

    //! @brief Deprecated
    ARLCORE_API bool oldRegisterICP( CSPTR(PointList) a, CSPTR(
                                         PointList) b,
                                     double& RMS, unsigned int& iterations, double RMSMax = 0.01,
                                     unsigned int iterationsMax = 500 );
...
ARLCORE_API vnl_matrix_fixed<double,4,4> rotVecFromPoint(double Px, double Py, double Pz, double Ux, double Uy,
                                                         double Uz, double alpha);                                                            // degree

enum ARLCORE_TRF_FILTER_TYPE { ARLCORE_TRF_FILTER_CONSTANT, ARLCORE_TRF_FILTER_LINEAR, ARLCORE_TRF_FILTER_LOG,
                               ARLCORE_TRF_FILTER_SQUARE, ARLCORE_TRF_FILTER_CUBIC  };
...
ARLCORE_API unsigned int filter( const std::vector<const arlCore::vnl_rigid_matrix*> &list, ARLCORE_TRF_FILTER_TYPE,
                                 vnl_rigid_matrix &average );

} // namespace arlCore
#endif // __ARLCORE_MATRIXR_H__
