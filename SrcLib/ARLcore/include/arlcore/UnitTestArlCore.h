...
#ifndef __ARLCORE_UNITTESTARLCORE_H__
#define __ARLCORE_UNITTESTARLCORE_H__
 ...
 *
 */
ARLCORE_API bool testRegistrationCriteriaComparison( long int nbIterations, std::vector<double> parameters,
...
#endif // __ARLCORE_UNITTESTARLCORE_H__
