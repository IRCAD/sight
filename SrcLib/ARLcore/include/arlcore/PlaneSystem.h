...
#ifndef __ARLCORE_PLANESYSTEM_H__
#define __ARLCORE_PLANESYSTEM_H__
...
public:
     ...
     */
    ARLCORE_API bool getTrf( unsigned int Plane1, unsigned int Plane2, vnl_rigid_matrix& T, double ageTolerance,
                             bool verbose = false );
     ...
     */
    ARLCORE_API bool getTrf( unsigned int Plane1, unsigned int Plane2, vnl_rigid_matrix& T, long int date,
                             long int time, double ageTolerance = 0, bool verbose = false );
    ...
    ARLCORE_API bool setTrf( unsigned int Plane1, unsigned int Plane2, const vnl_rigid_matrix& T, long int date,
                             long int time );

    //! @brief Set to identity  and date the transformation from Plane1 and Plane2
    ARLCORE_API bool setIdentity( unsigned int Plane1, unsigned int Plane2, const long int date = 0,
    ...
    ARLCORE_API bool distance( unsigned int Plane1, unsigned int Plane2,
...
private:
     ...
     */
    unsigned int whoIsConnected( unsigned int connectedAt, unsigned int finalDestination,
                                 std::vector<PlaneWeight>& Planes, long int date, long int time, bool SetInv = false,
                                 bool Tag = false);
     ...
     */
    bool isConnected( unsigned int Plane1, unsigned int Plane2, long int date, long int time, bool SetInv = false,
                      bool Tag = false);
...
#endif // __ARLCORE_PLANESYSTEM_H__
