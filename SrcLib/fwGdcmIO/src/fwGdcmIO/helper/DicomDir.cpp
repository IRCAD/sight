...
void DicomDir::retrieveDicomSeries(const ::boost::filesystem::path &dicomdir,
                                   std::vector< SPTR(::fwDicomData::DicomSeries) >& seriesDB,
                                   ...
                                   const SPTR(::fwJobs::Observer) & fileLookupObserver)
{
    ...
    std::map < std::string, ::fwDicomData::DicomSeries::sptr > dicomSeriesMap;
    ::fwDicomData::DicomSeries::sptr currentSeries = nullptr;
