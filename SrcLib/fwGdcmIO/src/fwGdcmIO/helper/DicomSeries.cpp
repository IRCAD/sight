...
::fwDicomData::DicomSeries::sptr DicomSeries::createBlob(FilenameContainerType &filenames)
{
    ::fwDicomData::DicomSeries::sptr series = ::fwDicomData::DicomSeries::New();
    series->setDescription("Processing data...");
    series->setDicomAvailability(::fwDicomData::DicomSeries::BLOB);
                             ...
                             const ::fwJobs::Observer::sptr & completeSeriesObserver)
{
    ...
    // Fill series
    for(::fwDicomData::DicomSeries::sptr series: seriesDB)
    {
                               ...
                               const std::string& filename)
{
    ...
    for(::fwDicomData::DicomSeries::sptr dicomSeries: seriesDB)
    {
