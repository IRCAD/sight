...
#include "fwMedData/Series/V2ToV1Test.hpp"
...
CPPUNIT_TEST_SUITE_REGISTRATION( ::fwStructuralPatch::ut::fwMedData::Series::V2ToV1Test );
...
{
    ::fwAtoms::Object::sptr seriesV2 = ::fwAtoms::Object::New();
    ::fwAtoms::Object::sptr seriesV1;

    ::fwAtomsPatch::helper::setClassname(seriesV2, "::fwMedData::Series");
    ::fwAtomsPatch::helper::setVersion(seriesV2, "2");

    ::fwAtomsPatch::helper::Object helper(seriesV2);
    ...
    {
        seriesV1 = ::fwAtoms::Object::dynamicCast(seriesV2->clone());

        ::fwAtomsPatch::IPatch::NewVersionsType newVersions;
        newVersions[seriesV2] = seriesV1;

        ::fwStructuralPatch::fwMedData::Series::V2ToV1::sptr v2ToV1Patch;
        v2ToV1Patch = ::fwStructuralPatch::fwMedData::Series::V2ToV1::New();
        CPPUNIT_ASSERT_NO_THROW(v2ToV1Patch->apply(seriesV2, seriesV1, newVersions));

        CPPUNIT_ASSERT(seriesV1);
        CPPUNIT_ASSERT_EQUAL(std::string("1"), ::fwAtomsPatch::helper::getVersion(seriesV1));
        const auto attributes = seriesV1->getAttributes();
