...
/// Structural patch to convert a fwMedData::Series from version '1' to version '2'.
class FWSTRUCTURALPATCH_CLASS_API V1ToV2 : public ::fwAtomsPatch::IStructuralPatch
{

public:

    fwCoreClassMacro(V1ToV2, ::fwStructuralPatch::fwMedData::Series::V1ToV2, new V1ToV2)
