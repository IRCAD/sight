...
/// Structural patch to convert a fwMedData::AttachmentSeries from version '1' to version '2'.
class FWSTRUCTURALPATCH_CLASS_API V1ToV2 : public ::fwAtomsPatch::IStructuralPatch
{

public:

    fwCoreClassMacro(V1ToV2, ::fwStructuralPatch::fwMedData::AttachmentSeries::V1ToV2, new V1ToV2)
