...
/// Structural patch to convert a fwMedData::AttachmentSeries from version '2' to version '1'.
class FWSTRUCTURALPATCH_CLASS_API V2ToV1 : public ::fwAtomsPatch::IStructuralPatch
{

public:

    fwCoreClassMacro(V2ToV1, ::fwStructuralPatch::fwMedData::AttachmentSeries::V2ToV1, new V2ToV1)
