...
#ifndef __HANDEYECALIBRATION_CAMODOCAL_DUALQUATERNION_H__
#define __HANDEYECALIBRATION_CAMODOCAL_DUALQUATERNION_H__

#include "handEyeCalibration/camodocal/QuaternionMapping.h"
...
public:
    ...
    friend DualQuaternion<T> operator+<>(const DualQuaternion<T>&dq1,
...
#endif //__HANDEYECALIBRATION_CAMODOCAL_DUALQUATERNION_H__
