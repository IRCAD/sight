...
#ifndef __HANDEYECALIBRATION_CAMODOCAL_EIGENUTILS_H__
#define __HANDEYECALIBRATION_CAMODOCAL_EIGENUTILS_H__
                                    ...
                                    Eigen::Matrix<T, 3, 1>& m)
{
    ...
    if (theta == 0)
    {
        l.setZero();
        m.setZero();
        SLM_WARN("Warning: Undefined screw! Returned 0. ");
    }
...
template<typename T>
Eigen::Matrix<T, 4, 4>
estimate3DRigidTransform(const std::vector<Eigen::Matrix<T, 3, 1>, Eigen::aligned_allocator<Eigen::Matrix<T, 3,
                                                                                                          1> > >& points1,
                         const std::vector<Eigen::Matrix<T, 3, 1>, Eigen::aligned_allocator<Eigen::Matrix<T, 3,
                                                                                                          1> > >& points2)
{
    // compute centroids
...
template<typename T>
Eigen::Matrix<T, 4, 4>
estimate3DRigidSimilarityTransform(const std::vector<Eigen::Matrix<T, 3, 1>, Eigen::aligned_allocator<Eigen::Matrix<T,
                                                                                                                    3,
                                                                                                                    1> > >& points1,
                                   const std::vector<Eigen::Matrix<T, 3, 1>, Eigen::aligned_allocator<Eigen::Matrix<T,
                                                                                                                    3,
                                                                                                                    1> > >& points2)
{
    // compute centroids
...
#endif // __HANDEYECALIBRATION_CAMODOCAL_EIGENUTILS_H__
