...
#ifndef __GDCMIO_WRITER_DICOMFILEWRITER_HXX__
#define __GDCMIO_WRITER_DICOMFILEWRITER_HXX__
...
void FileWriter::write(const std::string& filename, SPTR(::gdcm::Writer) writer)
{
    ...
    if (!writer->Write())
    {
        std::string msg = "Unable to write the file " + filename;
...
#endif /* __GDCMIO_WRITER_DICOMFILEWRITER_HXX__ */
