...
ComprehensiveSRIOD::ComprehensiveSRIOD(SPTR(::gdcmIO::container::DicomInstance) instance, ::boost::filesystem::path folderPath, bool use3DSR):
        ::gdcmIO::writer::iod::InformationObjectDefinition(instance, folderPath), m_use3DSR(use3DSR)
{
}
...
void ComprehensiveSRIOD::write(::fwMedData::Series::sptr series)
{
    ...
    ::gdcmIO::writer::ie::Document documentIE(writer, m_instance, image, m_use3DSR);
    ...
    // Write document
    ::gdcmIO::helper::FileWriter::write(m_folderPath.string() + "/imSR", writer);
