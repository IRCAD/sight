        ...
        unsigned int id, bool useSCoord3D)
{
    ...
    SPTR(::gdcmIO::container::sr::DicomSRUIDRefNode) idNode =
            ...
            ::gdcmIO::container::DicomCodedAttribute("dd1201", "DCM", "Fiducial ID"), "HAS PROPERTIES", ::fwTools::getString(id));
    ...
    SPTR(::gdcmIO::container::sr::DicomSRUIDRefNode) uidNode =
            ::boost::make_shared< ::gdcmIO::container::sr::DicomSRUIDRefNode >(
            ::gdcmIO::container::DicomCodedAttribute("dd1202", "DCM", "Fiducial UID"), "HAS PROPERTIES", generator.Generate());
