...
struct DicomCodedAttributeOrderer
{
    ...
    {
        return a->m_codeValue < b->m_codeValue;
    }
};
...
const ::gdcmIO::container::DicomCodedAttribute * DicomDictionarySegment::guessAnatRegionFromLabel(const std::string& label)
{
...
const ::gdcmIO::container::DicomCodedAttribute * DicomDictionarySegment::guessPropCategoryFromLabel(const std::string& label)
{
    // Delete possible space as last character
    std::string cleanedLabel = ::boost::algorithm::trim_copy(label);
...
const ::gdcmIO::container::DicomCodedAttribute * DicomDictionarySegment::guessPropTypeFromLabel(const std::string& label)
{
    // Delete possible space as last character
    std::string cleanedLabel = ::boost::algorithm::trim_copy(label);
