 ...
 * @brief This class implements a segmentation dictionary.
...
public:
     ...
     * @param[in] label Label from which the anatomic region is guessed.
     */
     ...
     * @note Returned null pointer means organ name is unknown.
     * @param[in] label Label from which the property category is guessed.
     */
     ...
     * @note Returned null pointer means organ name is unknown.
     * @param[in] label Label from which the property type is guessed.
     */
