 ...
 * @code{.xml}
   <service type="::sight::modules::filter::mesh::SVTKMesher" >
 ...
 */
class MODULE_FILTER_MESH_CLASS_API SVTKMesher : public services::IOperator
{

public:

    fwCoreServiceMacro(SVTKMesher, sight::services::IOperator)
