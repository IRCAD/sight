 ...
 * @code{.xml}
   <service uid="..." type="::opUltrasound::generator::SUltrasoundMesh">
       <inout key="mesh" uid="..." />
...
public:
    ...
    OPULTRASOUND_API ~SUltrasoundMesh() override;

protected:

    /// Configures the service.
    OPULTRASOUND_API void configuring() override;

    /// Generate the mesh.
    OPULTRASOUND_API void starting() override;

    /// Generate and update the mesh.
    OPULTRASOUND_API void updating() override;

    /// Does nothing.
    OPULTRASOUND_API void stopping() override;
