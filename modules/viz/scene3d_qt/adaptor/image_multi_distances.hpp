...
public:
     ...
     */
    MODULE_VIZ_SCENE3D_QT_API void buttonPressEvent(MouseButton _button, Modifier _mod, int _x, int _y) override;
    ...
    /// Resets m_pickedData.
    MODULE_VIZ_SCENE3D_QT_API void buttonReleaseEvent(
        MouseButton _button,
        Modifier _mod,
        int _x,
        int _y
    ...
    MODULE_VIZ_SCENE3D_QT_API void keyPressEvent(int _key, Modifier /*_mods*/, int /*_mouseX*/, int /*_mouseY*/) final;
...
protected:
     ...
     */
    MODULE_VIZ_SCENE3D_QT_API void setVisible(bool _visible) override;
...
private:
    ...
    public:
        ...
        explicit DeleteBinButtonWhenFocusOut(image_multi_distances* _s_image_multi_distances);
        bool eventFilter(QObject* _o, QEvent* _e) override;
        image_multi_distances* m_sImageMultiDistances;
    };
    ...
    void removeDistance(data::point_list::sptr _pl);
