...
#include <fwRenderQt3D/IWindowInteractor.hpp>
...
class VISUQT3DQT_CLASS_API WindowInteractor : public QObject,
                                              public ::fwRenderQt3D::IWindowInteractor
{
...
public:
    ...
    fwCoreClassMacro(WindowInteractor, ::fwRenderQt3D::IWindowInteractor)

    /// Initialize members.
    VISUQT3DQT_API WindowInteractor(::fwRenderQt3D::IWindowInteractor::Key);

    /// Destroys the window container.
    VISUQT3DQT_API ~WindowInteractor() final;
    /**
     ...
     */
    VISUQT3DQT_API void createContainer(ui::base::container::fwContainer::sptr _parent) final;
