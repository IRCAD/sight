...
#include "visuQt3DQt/WindowInteractor.hpp"
...
fwRenderQt3DRegisterMacro( ::visuQt3DQt::WindowInteractor,
                           ::fwRenderQt3D::IWindowInteractor::REGISTRY_KEY );
...
WindowInteractor::WindowInteractor(::fwRenderQt3D::IWindowInteractor::Key)
{
}
