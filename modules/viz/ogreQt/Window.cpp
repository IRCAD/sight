...
#include <viz/ogre/WindowManager.hpp>
...
static inline sight::viz::ogre::interactor::IInteractor::Modifier convertModifiers(::Qt::KeyboardModifiers _qmods)
{
    using SightOgreModType = sight::viz::ogre::interactor::IInteractor::Modifier;
...
void Window::initialize()
{
    ...
    m_glContext = modules::viz::ogreQt::OpenGLContext::getGlobalOgreOpenGLContext();
    this->makeCurrent();
    ...
    sight::viz::ogre::WindowManager::sptr mgr = sight::viz::ogre::WindowManager::get();
    mgr->registerWindow(m_ogreRenderWindow);

    sight::viz::ogre::IWindowInteractor::InteractionInfo info;
    info.interactionType     = sight::viz::ogre::IWindowInteractor::InteractionInfo::RESIZE;
...
{
    sight::viz::ogre::IWindowInteractor::InteractionInfo info;
    info.interactionType = sight::viz::ogre::IWindowInteractor::InteractionInfo::KEYPRESS;
...
{
    sight::viz::ogre::IWindowInteractor::InteractionInfo info;
    info.interactionType = sight::viz::ogre::IWindowInteractor::InteractionInfo::KEYRELEASE;
    info.modifiers       = convertModifiers(QApplication::keyboardModifiers());
    info.key             = _e->key();
                                                  ...
                                                  InteractionInfo::InteractionEnum _interactionType) const
{
    ...
    switch (button)
    {
        case Qt::NoButton:
            info.button =
                (activeButtons& Qt::LeftButton) ? sight::viz::ogre::interactor::IInteractor::LEFT : (activeButtons& Qt::
                                                                                                     MiddleButton) ? ::
                sight::viz::ogre::interactor::IInteractor::MIDDLE : (activeButtons& Qt::RightButton) ? ::
                sight::viz::ogre::interactor::IInteractor::RIGHT : sight::viz::ogre::interactor::IInteractor::UNKNOWN;
            break;
        case Qt::LeftButton:
            info.button = sight::viz::ogre::interactor::IInteractor::LEFT;
            break;
        case Qt::MiddleButton:
            info.button = sight::viz::ogre::interactor::IInteractor::MIDDLE;
            break;
        case Qt::RightButton:
            info.button = sight::viz::ogre::interactor::IInteractor::RIGHT;
            break;
        default:
            info.button = sight::viz::ogre::interactor::IInteractor::UNKNOWN;
            break;
    }
...
{
    sight::viz::ogre::IWindowInteractor::InteractionInfo info;
    info.interactionType     = sight::viz::ogre::IWindowInteractor::InteractionInfo::WHEELMOVE;
