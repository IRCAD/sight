...
class MODULE_VIZ_SCENE3DQT_CLASS_API offscreen_window_interactor final :
...
public:
     ...
     */
    MODULE_VIZ_SCENE3DQT_API offscreen_window_interactor(
        unsigned int _width,
        unsigned int _height
    );

    /// Destroys the render window.
    MODULE_VIZ_SCENE3DQT_API ~offscreen_window_interactor() final;
    ...
    MODULE_VIZ_SCENE3DQT_API void createContainer(ui::container::widget::sptr /*_parent*/,
                                                  bool /*fullscreen*/,
