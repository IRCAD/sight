...
public:
    ...
    /// Initialize slots.
    MODULE_VIZ_SCENE3DQT_API image_multi_distances() noexcept;

    /// Destroys the adaptor.
    MODULE_VIZ_SCENE3DQT_API ~image_multi_distances() noexcept override = default;
...
protected:
     ...
     */
    MODULE_VIZ_SCENE3DQT_API connections_t auto_connections() const override;
...
private:
    ...
    public:
        ...
        explicit DeleteBinButtonWhenFocusOut(image_multi_distances* sImageMultiDistances);
    ...
    void removeDistance(data::point_list::sptr pl);
