 ...
 */
class MODULE_VIZ_SCENE3DQT_CLASS_API landmarks final :
...
public:
    ...
    /// Creates the adaptor.
    MODULE_VIZ_SCENE3DQT_API landmarks() noexcept;

    /// Destroys the adaptor.
    MODULE_VIZ_SCENE3DQT_API ~landmarks() noexcept final = default;
...
protected:
     ...
     */
    MODULE_VIZ_SCENE3DQT_API service::connections_t auto_connections() const final;
...
private:
    ...
    public:
        ...
        explicit DeleteContextualMenuWhenFocusOut(landmarks* sLandmarks);
