...
#include "modules/viz/scene3dQt/offscreen_window_interactor.hpp"
...
SIGHT_REGISTER_SCENE3D_OFFSCREEN(
    sight::module::viz::scene3dQt::offscreen_window_interactor,
...
sight::viz::scene3d::IGraphicsWorker* offscreen_window_interactor::createGraphicsWorker()
{
