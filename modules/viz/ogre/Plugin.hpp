 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SightOgreListener final : public ::Ogre::LogListener
{
...
public:
     ...
     */
    MODULE_VIZ_OGRE_API void messageLogged(const ::Ogre::String& _message,
...
class MODULE_VIZ_OGRE_CLASS_API Plugin final : public core::runtime::Plugin
{
public:
    ...
    MODULE_VIZ_OGRE_API void start() override;

    /// Stops the plugin, destroys Ogre resources.
    MODULE_VIZ_OGRE_API void stop() noexcept override;
