 ...
 * @code{.xml}
    <service uid="..." type="::sight::modules::viz::ogre::adaptor::SPointList" >
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SPointList final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SPointList() noexcept override;
...
private:
     ...
     */
    modules::viz::ogre::adaptor::SMaterial::sptr createMaterialService(const std::string& _materialSuffix = "");
    ...
    std::vector< sight::viz::ogre::Text* > m_labels;
