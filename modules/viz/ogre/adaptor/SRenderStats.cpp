...
void SRenderStats::starting()
{
    ...
    sight::viz::ogre::SRender::sptr renderSrv = this->getRenderService();
    ...
    m_statsText = sight::viz::ogre::Text::New(this->getID() + "_fpsText",
    ...
    m_listener = std::make_unique<modules::viz::ogre::adaptor::PostWindowRenderListener>(*this);
