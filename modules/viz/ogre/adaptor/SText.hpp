 ...
 *
 * @code{.xml}
    <service type="::sight::modules::viz::ogre::adaptor::SText">
        <in key="object" uid="..." />
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SText final : public sight::viz::ogre::IAdaptor
{
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SText() noexcept override;
...
private:
    ...
    sight::viz::ogre::Text* m_text { nullptr };
