 ...
 * @code{.xml}
    <service type="::sight::modules::viz::ogre::adaptor::SReconstruction">
 ...
 *      match the flag.
 */
class MODULE_VIZ_OGRE_CLASS_API SReconstruction final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SReconstruction() noexcept override;
     ...
     */
    MODULE_VIZ_OGRE_API modules::viz::ogre::adaptor::SMesh::sptr getMeshAdaptor();
...
private:
    ...
    sight::viz::ogre::IAdaptor::wptr m_meshAdaptor;
