 ...
 * @code{.xml}
    <service uid="lightAdaptor" type="::sight::modules::viz::ogre::adaptor::SLight">
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SLight final : public ::sight::viz::ogre::ILight
{
...
public:
    ...
    /// Creates the service.
    MODULE_VIZ_OGRE_API SLight(sight::viz::ogre::ILight::Key key);

    /// Destroys the adaptor.
    MODULE_VIZ_OGRE_API ~SLight() noexcept override;

    /**
     * @brief Gets the name of the light.
     * @return The name of the light.
     */
    MODULE_VIZ_OGRE_API const std::string& getName() const override;

    /**
     * @brief Sets the name of the light.
     * @param _name the new light name.
     */
    MODULE_VIZ_OGRE_API void setName(const std::string& _name) override;

    /**
     * @brief Gets the type of the light.
     * @return The light type.
     */
    MODULE_VIZ_OGRE_API ::Ogre::Light::LightTypes getType() const override;

    /**
     * @brief Sets the type of the light.
     * @param _type the new light type.
     */
    MODULE_VIZ_OGRE_API void setType(::Ogre::Light::LightTypes _type) override;

    /**
     * @brief Gets the diffuse color of the light.
     * @return The light diffuse color.
     */
    MODULE_VIZ_OGRE_API ::Ogre::ColourValue getDiffuseColor() const override;

    /**
     * @brief Sets the diffuse color of the light.
     * @param _diffuseColor the new light diffuse color.
     */
    MODULE_VIZ_OGRE_API void setDiffuseColor(::Ogre::ColourValue _diffuseColor) override;

    /**
     * @brief Gets the specular color of the light.
     * @return The light specular color.
     */
    MODULE_VIZ_OGRE_API ::Ogre::ColourValue getSpecularColor() const override;

    /**
     * @brief Sets the specular color of the light.
     * @param _specularColor the new light specular color.
     */
    MODULE_VIZ_OGRE_API void setSpecularColor(::Ogre::ColourValue _specularColor) override;

    /**
     * @brief Gets the light activation state.
     * @return The light activation state.
     */
    MODULE_VIZ_OGRE_API bool isSwitchedOn() const override;

    /**
     * @brief Sets the light activation state.
     * @param _on the light new activation state.
     */
    MODULE_VIZ_OGRE_API void switchOn(bool _on) override;

    /**
     * @brief Gets the angle in degrees defining the rotation of the light around x axis.
     * @return The theta offset of the light.
     */
    MODULE_VIZ_OGRE_API float getThetaOffset() const override;
     ...
     */
    MODULE_VIZ_OGRE_API void setThetaOffset(float _thetaOffset) override;

    /**
     * @brief Gets the angle in degrees defining the rotation of the light around y axis.
     * @return The phi of the light.
     */
    MODULE_VIZ_OGRE_API float getPhiOffset() const override;
     ...
     * @pre The type of the light must be ::Ogre::Light::LT_DIRECTIONAL to used this value.
     */
    MODULE_VIZ_OGRE_API void setPhiOffset(float _phiOffset) override;

    /**
     * @brief Enables the light visual feedback.
     * @param _enable the visual feedback visibility state.
     */
    MODULE_VIZ_OGRE_API void enableVisualFeedback(bool _enable) override;

    /**
     * @brief Indicates if the visual feedback is enabled.
     * @return True if the visual feedback is activated.
     */
    MODULE_VIZ_OGRE_API bool isVisualFeedbackOn() const override;
