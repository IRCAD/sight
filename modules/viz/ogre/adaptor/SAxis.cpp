...
#include "modules/viz/ogre/adaptor/SAxis.hpp"
...
void SAxis::configuring()
{
    ...
    const std::string transformId = config.get<std::string>(modules::viz::ogre::adaptor::STransform::s_TRANSFORM_CONFIG,
...
void SAxis::starting()
{
    ...
    if(m_originVisibility)
    {
        ...
        sight::viz::ogre::helper::ManualObject::createSphere(m_origin, materialAdaptor->getMaterialName(),
    ...
    // X axis
    sight::viz::ogre::helper::ManualObject::createCylinder(m_xLine, materialAdaptor->getMaterialName(),
    ...
    // Y axis
    sight::viz::ogre::helper::ManualObject::createCylinder(m_yLine,
    ...
    // Z axis
    sight::viz::ogre::helper::ManualObject::createCylinder(m_zLine,
                                                           materialAdaptor->getMaterialName(),
    ...
    // X cone
    sight::viz::ogre::helper::ManualObject::createCone(m_xCone, materialAdaptor->getMaterialName(),
                                                       ::Ogre::ColourValue(::Ogre::ColourValue::Red),
                                                       coneRadius,
                                                       coneLength,
                                                       sample);
    ...
    if(m_enableLabel)
    {
        m_axisLabels[0] = sight::viz::ogre::Text::New(
    ...
    // Y cone
    sight::viz::ogre::helper::ManualObject::createCone(m_yCone, materialAdaptor->getMaterialName(),
                                                       ::Ogre::ColourValue(::Ogre::ColourValue::Green),
                                                       coneRadius,
                                                       coneLength,
                                                       sample);
    ...
    if(m_enableLabel)
    {
        m_axisLabels[1] = sight::viz::ogre::Text::New(
    ...
    // Z cone
    sight::viz::ogre::helper::ManualObject::createCone(m_zCone, materialAdaptor->getMaterialName(),
                                                       ::Ogre::ColourValue(::Ogre::ColourValue::Blue),
                                                       coneRadius,
                                                       coneLength,
                                                       sample);
    ...
    if(m_enableLabel)
    {
        m_axisLabels[2] = sight::viz::ogre::Text::New(
...
void SAxis::stopping()
{
    ...
    if(m_enableLabel)
    {
        for(sight::viz::ogre::Text* label : m_axisLabels)
        {
...
void SAxis::setVisible(bool _visible)
{
    if(m_sceneNode)
    {
        ...
        if(m_enableLabel)
        {
            for(sight::viz::ogre::Text* const label : m_axisLabels)
            {
                SLM_ASSERT("label should not be null", label);
