 ...
 * @code{.xml}
    <service uid="..." type="::sight::modules::viz::ogre::adaptor::SShapeExtruder">
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SShapeExtruder final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SShapeExtruder() noexcept override;
