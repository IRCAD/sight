...
#include "modules/viz/ogre/adaptor/SShaderParameter.hpp"
...
void SMaterial::starting()
{
    this->initialize();
    {
        ...
        m_materialFw = std::make_unique< sight::viz::ogre::Material>(m_materialName, m_materialTemplateName);
    ...
    if(!m_textureName.empty())
    {
        ...
        m_textureConnection.connect(m_texAdaptor, modules::viz::ogre::adaptor::STexture::s_TEXTURE_SWAPPED_SIG,
                                    this->getSptr(),
                                    modules::viz::ogre::adaptor::SMaterial::s_SWAP_TEXTURE_SLOT);
...
void SMaterial::stopping()
{
    ...
    ::Ogre::MaterialManager::getSingleton().remove(m_materialName, sight::viz::ogre::RESOURCE_GROUP);
...
void SMaterial::createShaderParameterAdaptors()
{
    ...
    const auto constants = sight::viz::ogre::helper::Shading::findMaterialConstants(*material);
    for(const auto& constant : constants)
    {
        ...
        auto obj = sight::viz::ogre::helper::Shading::createObjectFromShaderParameter(constantType, constantValue);
        if(obj != nullptr)
        {
            ...
            auto srv =
                this->registerService< sight::modules::viz::ogre::adaptor::SShaderParameter>(
                    "::sight::modules::viz::ogre::adaptor::SShaderParameter", id);
...
void SMaterial::updateField( data::Object::FieldsContainerType _fields)
{
    for(auto elt : _fields)
    {
        ...
        {
            this->unregisterServices("::sight::modules::viz::ogre::adaptor::SShaderParameter");
            {
                const auto material = this->getLockedInOut< data::Material >(s_MATERIAL_INOUT);
...
void SMaterial::createTextureAdaptor()
{
    ...
    if(material->getDiffuseTexture())
    {
        ...
        m_texAdaptor = this->registerService< modules::viz::ogre::adaptor::STexture >(
            "::sight::modules::viz::ogre::adaptor::STexture");
...
void SMaterial::removeTextureAdaptor()
{
    ...
    m_textureConnection.disconnect();
    this->unregisterServices("::sight::modules::viz::ogre::adaptor::STexture");
    m_texAdaptor.reset();
