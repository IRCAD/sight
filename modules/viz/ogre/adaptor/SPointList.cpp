...
#include "modules/viz/ogre/adaptor/SPointList.hpp"
...
void SPointList::createLabel(const data::PointList::csptr& _pointList)
{
    ...
    for(auto& point: _pointList->getPoints())
    {
        ...
        m_labels.push_back(sight::viz::ogre::Text::New(this->getID() + labelNumber, sceneMgr, textContainer,
...
void SPointList::destroyLabel()
{
    ...
    for(sight::viz::ogre::Text* label : m_labels)
    {
...
ogre::adaptor::SMaterial::sptr SPointList::createMaterialService(const std::string& _materialSuffix)
{
        ...
        if(m_entity)
        {
            ...
            if(!m_textureName.empty())
            {
                ...
                ::Ogre::MaterialPtr material = ::Ogre::MaterialManager::getSingleton().getByName(
                    m_materialAdaptor->getMaterialName(), sight::viz::ogre::RESOURCE_GROUP);
