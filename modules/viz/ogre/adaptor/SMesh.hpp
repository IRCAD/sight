 ...
 * @code{.xml}
    <service uid="..." type="::sight::modules::viz::ogre::adaptor::SMesh" >
        <inout key="mesh" uid="..." />
 ...
 *       modules::viz::ogre::adaptor::SMaterial you want to be bound to.
 ...
 *       match the flag.
 */
class MODULE_VIZ_OGRE_CLASS_API SMesh final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SMesh() noexcept override;

    /**
     * @brief Gets the associated material.
     * @return The material.
     */
    MODULE_VIZ_OGRE_API data::Material::sptr getMaterial() const;

    /**
     * @brief Sets the current material.
     * @param _material new material.
     */
    MODULE_VIZ_OGRE_API void setMaterial(data::Material::sptr _material);
     ...
     */
    MODULE_VIZ_OGRE_API void setAutoResetCamera(bool _autoResetCamera);

    /**
     * @brief Gets the associated entity.
     * @return The entity.
     */
    MODULE_VIZ_OGRE_API ::Ogre::Entity* getEntity() const;

    /**
     * @brief Gets the mesh visibility.
     * @return True if the mesh is visible.
     */
    MODULE_VIZ_OGRE_API bool getVisibility() const;
     ...
     */
    MODULE_VIZ_OGRE_API void setDynamicVertices(bool _isDynamic);
     ...
     */
    MODULE_VIZ_OGRE_API void setDynamic(bool _isDynamic);

    /**
     * @brief Sets the query flag.
     * @param _queryFlags value of the query flag.
     */
    MODULE_VIZ_OGRE_API void setQueryFlags(std::uint32_t _queryFlags);
     ...
     */
    MODULE_VIZ_OGRE_API void setIsReconstructionManaged(bool _isReconstructionManaged);

    /// Flags the r2vb objects as dirty and asks the render service to update.
    MODULE_VIZ_OGRE_API void requestRender() override;
...
private:
     ...
     */
    modules::viz::ogre::adaptor::SMaterial::sptr createMaterialService(const data::Mesh::sptr& _mesh,
    ...
    /// Ogre mesh.
    sight::viz::ogre::Mesh::sptr m_meshGeometry { nullptr };

    /// Stores material adaptors attached to the r2vb objects.
    std::map< data::Mesh::CellTypes, modules::viz::ogre::adaptor::SMaterial::sptr> m_r2vbMaterialAdaptor;
