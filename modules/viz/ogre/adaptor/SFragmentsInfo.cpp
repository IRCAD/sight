...
#include "modules/viz/ogre/adaptor/SFragmentsInfo.hpp"
...
fwServicesRegisterMacro(::sight::viz::ogre::IAdaptor, ::sight::modules::viz::ogre::adaptor::SFragmentsInfo)
...
struct FragmentsInfoMaterialListener final : public ::Ogre::MaterialManager::Listener
{
                                                    ...
                                                    const ::Ogre::Renderable*)
    {
        ...
        if(_schemeName == "PrimitiveID_MS")
        {
            ...
            newTech                        = sight::viz::ogre::helper::Technique::copyToMaterial(defaultTech,
                                                                                                 _schemeName,
                                                                                                 _originalMaterial);
...
void SFragmentsInfo::updating() noexcept
{
    const auto imageW = this->getWeakInOut< data::Image >(s_IMAGE_INOUT);
    {
        ...
        if(image)
        {
            ...
            sight::viz::ogre::Utils::convertFromOgreTexture(text, image.get_shared(), m_flipImage);
    ...
    const auto depthW = this->getWeakInOut< data::Image >(s_DEPTH_INOUT);
    {
        ...
        if(depth)
        {
            ...
            sight::viz::ogre::Utils::convertFromOgreTexture(depthText, depth.get_shared(), m_flipImage);
    ...
    const auto primitiveIDW = this->getWeakInOut< data::Image>(s_PRIMITIVE_ID_INOUT);
    {
        ...
        if(primitiveID)
        {
            ...
            sight::viz::ogre::Utils::convertFromOgreTexture(primitiveIDText, primitiveID.get_shared(), m_flipImage);
