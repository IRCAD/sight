...
#include "modules/viz/ogre/adaptor/SVector.hpp"
...
void SVector::createVector()
{
    ...
    // Line
    sight::viz::ogre::helper::ManualObject::createCylinder(m_line, m_materialAdaptor->getMaterialName(),
                                                           ogreColor,
                                                           cylinderRadius,
                                                           cylinderLength,
                                                           sample);
    ...
    // Cone
    sight::viz::ogre::helper::ManualObject::createCone(m_cone, m_materialAdaptor->getMaterialName(),
                                                       ogreColor,
                                                       coneRadius,
                                                       coneLength,
                                                       sample);
