...
void SReconstruction::createMeshService()
{
    ...
    if(mesh)
    {
        ...
        auto meshAdaptor = this->registerService< modules::viz::ogre::adaptor::SMesh >(
            "::sight::modules::viz::ogre::adaptor::SMesh");
...
adaptor::SMesh::sptr SReconstruction::getMeshAdaptor()
{
    ...
    sight::viz::ogre::IAdaptor::sptr adaptor             = m_meshAdaptor.lock();
    modules::viz::ogre::adaptor::SMesh::sptr meshAdaptor = modules::viz::ogre::adaptor::SMesh::dynamicCast(adaptor);
