...
#include "modules/viz/ogre/adaptor/STrackballCamera.hpp"
...
void STrackballCamera::starting()
{
    ...
    m_trackball = std::make_shared< sight::viz::ogre::interactor::TrackballInteractor >(layer, m_layerOrderDependant);
