...
#include "modules/viz/ogre/adaptor/SImageMultiDistances.hpp"
...
static constexpr std::uint8_t s_DISTANCE_RQ_GROUP_ID = sight::viz::ogre::compositor::Core::s_SURFACE_RQ_GROUP_ID;
...
void SImageMultiDistances::starting()
{
    ...
    m_sphereMaterial = std::make_unique< sight::viz::ogre::Material >(m_sphereMaterialName,
                                                                      sight::viz::ogre::Material::DEFAULT_MATERIAL_TEMPLATE_NAME);
    ...
    m_lineMaterial = std::make_unique< sight::viz::ogre::Material >(m_lineMaterialName,
                                                                    sight::viz::ogre::Material::DEFAULT_MATERIAL_TEMPLATE_NAME);
    ...
    m_dashedLineMaterial = std::make_unique< sight::viz::ogre::Material >(m_dashedLineMaterialName,
                                                                          sight::viz::ogre::Material::DEFAULT_MATERIAL_TEMPLATE_NAME);
    ...
    const ::Ogre::MaterialPtr ogreSphereMaterial = ::Ogre::MaterialManager::getSingleton().getByName(
        m_sphereMaterialName, sight::viz::ogre::RESOURCE_GROUP);
    ...
    const ::Ogre::MaterialPtr ogreDashedLineMaterial = ::Ogre::MaterialManager::getSingleton().getByName(
        m_dashedLineMaterialName, sight::viz::ogre::RESOURCE_GROUP);
...
{
    const sight::viz::ogre::Layer::csptr layer = this->getLayer();
...
std::optional< ::Ogre::Vector3 > SImageMultiDistances::getNearestPickedPosition(int _x, int _y)
{
    ...
    {
        const auto* const camera = sm->getCamera(sight::viz::ogre::Layer::s_DEFAULT_CAMERA_NAME);
...
void SImageMultiDistances::createDistance(data::PointList::sptr _pl)
{
    ...
    sight::viz::ogre::helper::ManualObject::createSphere(sphere1, m_sphereMaterialName, colour, m_distanceSphereRadius);
    ...
    sight::viz::ogre::helper::ManualObject::createSphere(sphere2, m_sphereMaterialName, colour, m_distanceSphereRadius);
    ...
    line->begin(m_lineMaterialName, ::Ogre::RenderOperation::OT_LINE_LIST, sight::viz::ogre::RESOURCE_GROUP);
    line->colour(colour);
    line->position(begin);
    line->position(end);
    line->end();
    ...
    sight::viz::ogre::Text* label = sight::viz::ogre::Text::New(
