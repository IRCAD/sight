...
#include "modules/viz/ogre/adaptor/SCompositorParameter.hpp"
...
private:
    ...
    modules::viz::ogre::adaptor::SCompositorParameter::wptr m_adaptor;
};
...
void SCompositorParameter::starting()
{
    ...
    sight::viz::ogre::Layer::sptr layer = this->getRenderService()->getLayer(m_layerID);
