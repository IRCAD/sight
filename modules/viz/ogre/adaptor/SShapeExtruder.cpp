...
#include "modules/viz/ogre/adaptor/SShapeExtruder.hpp"
...
void SShapeExtruder::starting()
{
    ...
    const sight::viz::ogre::interactor::IInteractor::sptr interactor =
        std::dynamic_pointer_cast< sight::viz::ogre::interactor::IInteractor >(this->getSptr());
