 ...
 * @code{.xml}
    <service type="::sight::modules::viz::ogre::adaptor::SNegato2DCamera" >
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SNegato2DCamera final : public sight::viz::ogre::IAdaptor,
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SNegato2DCamera() noexcept override;
     ...
     */
    MODULE_VIZ_OGRE_API void wheelEvent(Modifier, int _delta, int _x, int _y) override;
     ...
     * @param _y current height coordinate of the mouse cursor.
     */
    MODULE_VIZ_OGRE_API void mouseMoveEvent(IInteractor::MouseButton _button, Modifier, int _x, int _y, int _dx,
                                            int _dy) override;
     ...
     * @param _y current height coordinate of the mouse cursor.
     */
    MODULE_VIZ_OGRE_API void buttonPressEvent(IInteractor::MouseButton _button, Modifier, int _x, int _y) override;
     ...
     * @param _y current height coordinate of the mouse cursor.
     */
    MODULE_VIZ_OGRE_API void buttonReleaseEvent(IInteractor::MouseButton _button, Modifier, int _x, int _y) override;
     ...
     * @param _y current height coordinate of the mouse cursor.
     */
    MODULE_VIZ_OGRE_API void keyPressEvent(int _key, Modifier, int _x, int _y) override;
