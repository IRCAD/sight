 ...
 * @code{.xml}
    <service uid="paramAdaptor" type="::sight::modules::viz::ogre::adaptor::SShaderParameter">
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SShaderParameter final : public ::sight::viz::ogre::IParameter
{
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SShaderParameter() noexcept override;
...
protected:
    ...
    /// Does nothing.
    MODULE_VIZ_OGRE_API void swapping() override;
