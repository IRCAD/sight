 ...
 * @code{.xml}
    <service type="::sight::modules::viz::ogre::adaptor::SVideo" autoConnect="yes" >
        <in key="image" uid="..." />
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SVideo final : public sight::viz::ogre::IAdaptor
{
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SVideo() noexcept override;
...
private:
    ...
    sight::viz::ogre::IAdaptor::sptr m_pointListAdaptor { nullptr };
