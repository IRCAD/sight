 ...
 * @code{.xml}
    <service uid="cameraAdaptor" type="::sight::modules::viz::ogre::adaptor::SCamera">
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SCamera final : public sight::viz::ogre::IAdaptor
{
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SCamera() noexcept override;
