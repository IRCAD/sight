 ...
 * @code{.xml}
    <service uid="..." type="::sight::modules::viz::ogre::adaptor::SAxis">
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SAxis final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SAxis() noexcept override;
...
private:
    ...
    std::array< sight::viz::ogre::Text*, 3> m_axisLabels {{ nullptr, nullptr, nullptr }};
