 ...
 *
 * This picker has a different behaviour than modules::viz::ogre::adaptor::SPicker, in fact,
 * modules::viz::ogre::adaptor::SPicker performs
 ...
 * @code{.xml}
        <service type="::sight::modules::viz::ogre::adaptor::SVoxelPicker">
            <in key="image" uid="..." />
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SVoxelPicker final :
...
public:
    ...
    MODULE_VIZ_OGRE_API ~SVoxelPicker() noexcept override;
