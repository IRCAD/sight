 ...
 * @code{.xml}
    <service type="::sight::modules::viz::ogre::adaptor::SNegato2D">
        <inout key="image" uid="..." />
 ...
 */
class MODULE_VIZ_OGRE_CLASS_API SNegato2D final : public sight::viz::ogre::IAdaptor
{
...
public:
    ...
    fwCoreServiceMacro(SNegato2D, ::sight::viz::ogre::IAdaptor)

    /// Creates the service and initializes slots.
    MODULE_VIZ_OGRE_API SNegato2D() noexcept;

    /// Destroys the adaptor.
    MODULE_VIZ_OGRE_API ~SNegato2D() noexcept override;
...
private:
    ...
    void setFiltering(sight::viz::ogre::Plane::FilteringEnumType _filtering);
    ...
    std::unique_ptr< sight::viz::ogre::TransferFunction> m_gpuTF;

    /// Contains the plane on which we will apply our texture.
    std::unique_ptr< sight::viz::ogre::Plane > m_plane { nullptr };
    ...
    sight::viz::ogre::Plane::FilteringEnumType m_filtering { sight::viz::ogre::Plane::FilteringEnumType::NONE };
...
inline void SNegato2D::setFiltering( sight::viz::ogre::Plane::FilteringEnumType _filtering )
{
