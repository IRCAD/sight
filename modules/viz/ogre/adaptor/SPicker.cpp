...
#include "modules/viz/ogre/adaptor/SPicker.hpp"
...
{
    m_pickedSig = newSignal< sight::viz::ogre::interactor::MeshPickerInteractor::PointClickedSigType >(s_PICKED_SIG);
}
...
void SPicker::starting()
{
    ...
    m_interactor = std::make_shared< sight::viz::ogre::interactor::MeshPickerInteractor >(layer, m_layerOrderDependant);
