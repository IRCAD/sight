 ...
 * @code{.xml}
        <service uid="..." type="sight::module::geometry::SManagePointList">
 ...
 */
class MODULE_GEOMETRY_CLASS_API SManagePointList final : public service::controller
{
public:

    /// Generates default methods as New, dynamicCast, ...
    SIGHT_DECLARE_SERVICE(SManagePointList, sight::service::controller);

    /// Initialize slots.
    MODULE_GEOMETRY_API SManagePointList() noexcept;

    /// Destroys the service.
    MODULE_GEOMETRY_API ~SManagePointList() noexcept final;
