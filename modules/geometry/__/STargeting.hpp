 ...
 * @code{.xml}
        <service type="sight::module::geometry::STargeting">
            <in key="landmark" uid="..." />
            <in key="matrix" uid="..." />
 ...
 */
class MODULE_GEOMETRY_CLASS_API STargeting final : public service::base
{
public:

    /// Generates default methods as New, dynamicCast, ...
    SIGHT_DECLARE_SERVICE(STargeting, service::base);

    /// Initializes member variables and slots.
    MODULE_GEOMETRY_API STargeting() noexcept;

    /// Destroys the service.
    MODULE_GEOMETRY_API ~STargeting() noexcept override;
