...
#include "modules/geometry/__/SPointToLandmarkDistance.hpp"
...
SPointToLandmarkDistance::SPointToLandmarkDistance() noexcept
{
    ...
    new_slot(SELECTED_POINT_SLOT, &SPointToLandmarkDistance::updateSelectedPoint, this);
    new_slot(UPDATE_POINT_SLOT, &SPointToLandmarkDistance::updatePoint, this);
    new_slot(REMOVE_POINT_SLOT, &SPointToLandmarkDistance::removePoint, this);
}
