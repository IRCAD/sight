 ...
 * @code{.xml}
        <service type="sight::module::geometry::SMatrixList">
 ...
 */
class MODULE_GEOMETRY_CLASS_API SMatrixList final : public service::base
{
public:

    /// Generates default methods like New, dynamicCast,...
    SIGHT_DECLARE_SERVICE(SMatrixList, service::base);

    /// Initializes signals.
    MODULE_GEOMETRY_API SMatrixList() noexcept;

    /// Destroys the service.
    MODULE_GEOMETRY_API ~SMatrixList() noexcept override;
