 ...
 * @code{.xml}
   <service type="sight::module::geometry::SPointToLandmarkDistance">
 ...
 */
class MODULE_GEOMETRY_CLASS_API SPointToLandmarkDistance final : public service::base
{
public:

    /// Generates default methods like New, dynamicCast, ...
    SIGHT_DECLARE_SERVICE(SPointToLandmarkDistance, service::base);

    /// Initializes signals and slots.
    MODULE_GEOMETRY_API SPointToLandmarkDistance() noexcept;

    /// Destroys the service.
    MODULE_GEOMETRY_API ~SPointToLandmarkDistance() noexcept override;
