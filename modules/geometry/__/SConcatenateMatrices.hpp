 ...
 *
 * @code{.xml}
        <service uid="..." type="sight::module::geometry::SConcatenateMatrices">
            <in group="matrix">
                <key uid="..." />
...
class MODULE_GEOMETRY_CLASS_API SConcatenateMatrices : public service::controller
{
public:

    SIGHT_DECLARE_SERVICE(SConcatenateMatrices, sight::service::controller);

    MODULE_GEOMETRY_API SConcatenateMatrices() noexcept = default;
