...
#include "modules/geometry/__/STargeting.hpp"
...
{
    new_slot(SELECTED_POINT_SLOT, &STargeting::updateSelectedPoint, this);
    new_slot(UPDATE_POINT_SLOT, &STargeting::updatePoint, this);
    new_slot(REMOVE_POINT_SLOT, &STargeting::removePoint, this);
}
...
service::connections_t STargeting::getAutoConnections() const
{
