...
#include <sight/modules/geometry/vision/config.hpp>
...
struct plugin : public core::runtime::plugin
{
     ...
     */
    SIGHT_MODULE_GEOMETRY_VISION_API void start() override;

    /**
     * @brief Stop method.
     * This method is used by runtime in order to close the module.
     */
    SIGHT_MODULE_GEOMETRY_VISION_API void stop() noexcept override;
};
