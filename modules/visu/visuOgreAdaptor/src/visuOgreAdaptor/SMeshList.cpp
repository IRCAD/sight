...
void SMeshList::starting()
{
    ...
    for (size_t i = 0; i < m_capacity; ++i)
    {
        ...
        const ::fwRenderOgre::IAdaptor::sptr transformAdaptor
            = this->registerService< ::fwRenderOgre::IAdaptor >("::visuOgreAdaptor::STransform");
        ...
        const ::fwRenderOgre::IAdaptor::sptr textureAdaptor =
            this->registerService< ::fwRenderOgre::IAdaptor >("::visuOgreAdaptor::STexture");
        ...
        const ::fwRenderOgre::IAdaptor::sptr meshAdaptor =
            this->registerService< ::fwRenderOgre::IAdaptor >("::visuOgreAdaptor::SMesh");
...
void SMeshList::setVisible(bool _visible)
{
    for (const auto& instance: m_meshes)
    {
        ...
        {
            const ::fwRenderOgre::IAdaptor::sptr mesh = instance.m_mesh;
...
void SMeshList::add()
{
    if (m_dropCount % m_dropData == 0)
    {
        ...
        const ::fwRenderOgre::IAdaptor::sptr textureAdp = instance.m_texture;
        {
            // set current image
        ...
        // update the texture
        const ::fwRenderOgre::IAdaptor::sptr transformAdp = instance.m_transform;
        {
            // set current matrix
        ...
        const ::fwRenderOgre::IAdaptor::sptr meshAdp = instance.m_mesh;
