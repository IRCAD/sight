...
const ::fwServices::IService::KeyType s_ULTRASOUND_IMAGE_INPUT = "ultrasoundImage";
...
fwServicesRegisterMacro( ::fwServices::IOperator, ::cvSegmentation::SUltrasoundImage )
