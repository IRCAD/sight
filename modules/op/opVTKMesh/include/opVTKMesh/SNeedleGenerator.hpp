 ...
 * @code{.xml}
        <service uid="cylinderGenerator" type="::opVTKMesh::SNeedleGenerator" >
            <inout key="mesh" uid="..." />
 ...
 */
class OPVTKMESH_CLASS_API SNeedleGenerator final : public ::opVTKMesh::IGenerator
{

public:

    /// Generates default methods as New, dynamicCast, ...
    fwCoreServiceMacro(SNeedleGenerator, ::opVTKMesh::IGenerator)

    /// Initializes slots.
    OPVTKMESH_API SNeedleGenerator() noexcept;

    /// Destroys the service.
    OPVTKMESH_API ~SNeedleGenerator() noexcept override;
