 ...
 */
class UIVISU_CLASS_API CrossTypeAction : public ::sight::gui::IActionSrv
{

public:

    fwCoreServiceMacro(CrossTypeAction, ::sight::gui::IActionSrv)
...
protected:
     ...
     * @code{.xml}
       <service type="::gui::IActionSrv" impl="::uiData::action::CrossTypeAction" autoConnect="no">
