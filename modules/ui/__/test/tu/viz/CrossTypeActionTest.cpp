...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::module::ui::viz::ut::CrossTypeActionTest);
...
{
    m_crossTypeAction = service::add("sight::module::ui::viz::CrossTypeAction");
    CPPUNIT_ASSERT_MESSAGE(
        "Failed to create service 'sight::module::ui::viz::CrossTypeAction'",
        m_crossTypeAction
    );
}
