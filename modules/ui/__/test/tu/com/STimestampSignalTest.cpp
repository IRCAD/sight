...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::module::ui::com::ut::STimestampSignalTest);
...
{
    m_timestampSignal = service::add("sight::module::ui::com::STimestampSignal");
    CPPUNIT_ASSERT_MESSAGE(
        "Failed to create service 'sight::module::ui::com::STimestampSignal'",
        m_timestampSignal
    );
}
