...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::module::ui::com::ut::SStarterTest);
...
{
    m_starter = service::add("sight::module::ui::com::SStarter");
    CPPUNIT_ASSERT_MESSAGE("Failed to create service 'sight::module::ui::com::SStarter'", m_starter);
}
