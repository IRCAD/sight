...
CPPUNIT_TEST_SUITE_REGISTRATION(sight::module::ui::ut::SJobBarTest);
...
{
    m_jobBar = service::add("sight::module::ui::SJobBar");
    CPPUNIT_ASSERT_MESSAGE("Failed to create service 'sight::module::ui::SJobBar'", m_jobBar);
}
