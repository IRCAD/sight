 ...
 */
class MODULE_UI_CLASS_API SView : public sight::ui::view::IView
{
public:

    SIGHT_DECLARE_SERVICE(SView, sight::ui::view::IView);

    /// Constructor. Do nothing.
    MODULE_UI_API SView() noexcept = default;

    /// Destructor. Do nothing.
    MODULE_UI_API ~SView() noexcept override = default;
