 ...
 */
class MODULE_UI_CLASS_API SMenuBar : public sight::ui::menu_bar
{
public:

    SIGHT_DECLARE_SERVICE(SMenuBar, sight::ui::menu_bar);

    /// Constructor. Do nothing.
    MODULE_UI_API SMenuBar() noexcept;

    /// Destructor. Do nothing.
    MODULE_UI_API ~SMenuBar() noexcept override;
