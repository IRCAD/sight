 ...
 */
class MODULE_UI_CLASS_API SFrame : public sight::ui::frame
{
public:

    SIGHT_DECLARE_SERVICE(SFrame, sight::ui::frame);

    /// Constructor. Do nothing.
    MODULE_UI_API SFrame() noexcept;

    /// Destructor. Do nothing.
    MODULE_UI_API ~SFrame() noexcept override;
