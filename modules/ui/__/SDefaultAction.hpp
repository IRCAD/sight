 ...
 * @deprecated Replaced by sight::module::ui::SAction since Sight 22.0, will be removed in Sight 23.0
 */
class MODULE_UI_CLASS_API SDefaultAction : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SDefaultAction, sight::ui::action);

    /**
     * @brief Constructor. Do nothing.
     */
    MODULE_UI_API SDefaultAction() noexcept;

    /**
     * @brief Destructor. Do nothing.
     */
    MODULE_UI_API ~SDefaultAction() noexcept override;
