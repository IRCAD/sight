 ...
 */
class MODULE_UI_CLASS_API SConfigLauncher : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SConfigLauncher, sight::ui::action);

    /// Constructor. Do nothing.
    MODULE_UI_API SConfigLauncher() noexcept;

    /// Destructor. Do nothing.
    MODULE_UI_API ~SConfigLauncher() noexcept override;
...
protected:
     ...
     * @code{.xml}
       <service impl="sight::module::ui::SConfigLauncher" type="ui::action">
           <config>
