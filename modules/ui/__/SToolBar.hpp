 ...
 */
class MODULE_UI_CLASS_API SToolBar : public sight::ui::toolbar
{
public:

    SIGHT_DECLARE_SERVICE(SToolBar, sight::ui::toolbar);

    /// Constructor. Do nothing.
    MODULE_UI_API SToolBar() noexcept;

    /// Destructor. Do nothing.
    MODULE_UI_API ~SToolBar() noexcept override;
