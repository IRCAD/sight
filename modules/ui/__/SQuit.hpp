 ...
 */
class MODULE_UI_CLASS_API SQuit : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SQuit, sight::ui::action);

    /**
     * @brief Constructor. Do nothing.
     */
    MODULE_UI_API SQuit() noexcept;

    /**
     * @brief Destructor. Do nothing.
     */
    MODULE_UI_API ~SQuit() noexcept override;
