 ...
 *
 * @code{.xml}
        <service type="sight::module::ui::io::SFolderSelector" >
 ...
 */
class MODULE_UI_CLASS_API SFolderSelector : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SFolderSelector, sight::ui::action);
    ...
    MODULE_UI_API SFolderSelector() noexcept;
    MODULE_UI_API ~SFolderSelector() noexcept override;
