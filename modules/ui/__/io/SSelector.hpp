 ...
 * @code{.xml}
          <service uid="..." type="sight::module::ui::io::SSelector">
 ...
 */
class MODULE_UI_CLASS_API SSelector : public sight::ui::dialog_editor
{
public:
    ...
    SIGHT_DECLARE_SERVICE(SSelector, sight::ui::dialog_editor);
     ...
     */
    MODULE_UI_API SSelector();

    /// Destructor. Do nothing.
    MODULE_UI_API ~SSelector() noexcept override;
