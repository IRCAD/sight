 ...
 *
 * @code{.xml}
   <service uid="..." type=sight::module::ui::com::STimestampSlotCaller" autoConnect="false">
        <slots>
 ...
 */
class MODULE_UI_CLASS_API STimestampSlotCaller : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(STimestampSlotCaller, sight::ui::action);

    MODULE_UI_API STimestampSlotCaller()           = default;
    MODULE_UI_API ~STimestampSlotCaller() override = default;
