 ...
 *
 * @code{.xml}
        <service type="sight::module::ui::com::signal" />
   @endcode
 *
...
class MODULE_UI_CLASS_API signal : public sight::ui::action
{
public:
     ...
     */
    MODULE_UI_API signal() noexcept;

    /**
     * @brief Destructor. Do nothing.
     */
    MODULE_UI_API ~signal() noexcept override;
