 ...
 *   - Start a service :
 * @code{.xml}
           <service uid="actionUid" type="ui::action" impl="sight::module::ui::com::SStarter"
 * autoConnect="false">
...
class MODULE_UI_CLASS_API SStarter : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SStarter, sight::ui::action);

    /**
     * @brief Constructor. Do nothing.
     */
    MODULE_UI_API SStarter() noexcept;

    /**
     * @brief Destructor. Do nothing.
     */
    MODULE_UI_API ~SStarter() noexcept override;
