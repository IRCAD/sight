 ...
 *
 * @code{.xml}
        <service type="sight::module::ui::com::STimestampSignal">
...
class MODULE_UI_CLASS_API STimestampSignal : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(STimestampSignal, sight::ui::action);
     ...
     */
    MODULE_UI_API STimestampSignal() noexcept;

    /**
     * @brief Destructor. Do nothing.
     */
    MODULE_UI_API ~STimestampSignal() noexcept override;
