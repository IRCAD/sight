 ...
 * @code{.xml}
   <service type="sight::module::ui::metrics::SRemoveDistance">
       <inout key="image" uid="..." />
   </service>
   @endcode
 *
 ...
 * @code{.xml}
    <service uid="SRemoveDistanceAct" type="sight::module::ui::metrics::SRemoveDistance">
            <inout key="image" uid="${image}" />
    </service>

    <service uid="removeLastDistance" type="sight::module::ui::SAction" />
 ...
 */
class MODULE_UI_CLASS_API SRemoveDistance final : public sight::ui::action
{
public:

    /// Generates default methods as New, dynamicCast, ...
    SIGHT_DECLARE_SERVICE(SRemoveDistance, sight::ui::action);

    /// Initialize slots.
    MODULE_UI_API SRemoveDistance() noexcept;

    /// Destroys the service.
    MODULE_UI_API ~SRemoveDistance() noexcept override;
