 ...
 * @code{.xml}
   <service uid="action" type="sight::module::ui::series::SDBMerger">
 ...
 */
class MODULE_UI_CLASS_API SDBMerger : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(SDBMerger, sight::ui::action);
    ...
    MODULE_UI_API SDBMerger() noexcept;

    MODULE_UI_API ~SDBMerger() noexcept override;
...
protected:
     ...
     *
     * @code{.xml}
        <service impl="sight::module::ui::series::SDBMerger">
