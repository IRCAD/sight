 ...
 *
 * @code{.xml}
   <service uid="..." type="sight::module::ui::video::SImagePicker" >
 ...
 *    ------------
 **/
class MODULE_UI_CLASS_API SImagePicker : public service::controller
{
public:

    SIGHT_DECLARE_SERVICE(SImagePicker, service::controller);

    /// Creates the video reference map..
    MODULE_UI_API SImagePicker() noexcept;

    /// Destroys the service.
    MODULE_UI_API ~SImagePicker() noexcept override;
