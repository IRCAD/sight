 ...
 * @code{.xml}
          <service uid="..." type="::sight::modules::ui::base::editor::SIOSelector">
              <inout key="data" uid="${selection}" />
              <type mode="writer" />
              <selection mode="include" />
              <addSelection service="::sight::modules::io::atoms::SWriter" />
              <config id="ioAtomsConfig" service="::sight::modules::io::atoms::SWriter" />
          </service>
 * @endcode
 *
...
public:
     ...
     */
    MODULE_UI_BASE_API SIOSelector();

    /// Destructor. Do nothing.
    MODULE_UI_BASE_API virtual ~SIOSelector() noexcept;
