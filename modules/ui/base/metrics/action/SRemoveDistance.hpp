 ...
 * @code{.xml}
   <service type="::sight::modules::ui::base::metrics::action::SRemoveDistance">
       <inout key="image" uid="..." />
   </service>
   @endcode
 *
 ...
 * @code{.xml}
    <service uid="SRemoveDistanceAct" type="::sight::modules::ui::base::metrics::action::SRemoveDistance">
            <inout key="image" uid="${image}" />
    </service>

    <service uid="removeLastDistance" type="::sight::modules::ui::base::action::SSlotCaller">
        <slots>
