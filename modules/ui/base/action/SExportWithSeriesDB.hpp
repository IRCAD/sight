 ...
 * It creates a new SeriesDB containing this series, and then launchs an modules::ui::base::editor::SIOSelector service
 * on the
 ...
 *  @code{.xml}
    ...
    @endcode
 */
class MODULE_UI_BASE_CLASS_API SExportWithSeriesDB : public ::sight::ui::base::IActionSrv
{
public:
