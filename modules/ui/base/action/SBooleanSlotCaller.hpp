...
#include "modules/ui/base/action/SSlotCaller.hpp"
...
class MODULE_UI_BASE_CLASS_API SBooleanSlotCaller : public modules::ui::base::action::SSlotCaller
{
...
public:
     ...
     */
    MODULE_UI_BASE_API virtual ~SBooleanSlotCaller() noexcept;
