 ...
 *            Boolean object.
 */
class UIACTIVITIESQT_CLASS_API SActivityLauncher : public ::sight::ui::base::IActionSrv
{
...
protected:
     ...
     */
    UIACTIVITIESQT_API virtual KeyConnectionsMap getAutoConnections() const override;
