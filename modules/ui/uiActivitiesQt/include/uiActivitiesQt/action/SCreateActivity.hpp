 ...
 */
class UIACTIVITIESQT_CLASS_API SCreateActivity : public ::sight::ui::base::IActionSrv
{
...
public:
     ...
     * @{
     */
    UIACTIVITIESQT_API static const core::com::Signals::SignalKeyType s_ACTIVITY_SELECTED_SIG;
