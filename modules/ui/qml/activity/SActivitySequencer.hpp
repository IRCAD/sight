...
public:
    ...
    fwCoreServiceMacro(SActivitySequencer, ::sight::ui::qml::IQmlEditor)

    /// Constructor. Do nothing.
    MODULE_UI_QML_API SActivitySequencer();

    /// Destructor. Do nothing.

    MODULE_UI_QML_API virtual ~SActivitySequencer() override;
