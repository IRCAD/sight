 ...
 * @code{.xml}
    <service uid="action_newActivity" type="::sight::modules::ui::qt::action::SActivityLauncher" autoConnect="yes" >
        <in key="series" uid="..." />
        <config>
...
public:
    ...
    MODULE_UI_QT_API virtual ~SActivityLauncher() noexcept override;
