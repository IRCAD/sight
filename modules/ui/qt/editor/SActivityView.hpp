 ...
 */
class MODULE_UI_QT_CLASS_API SActivityView : public sight::ui::base::view::IActivityView
{

public:

    fwCoreServiceMacro(SActivityView, sight::ui::base::view::IActivityView)

    /// Constructor. Do nothing.
    MODULE_UI_QT_API SActivityView();

    /// Destructor. Do nothing.

    MODULE_UI_QT_API virtual ~SActivityView();
