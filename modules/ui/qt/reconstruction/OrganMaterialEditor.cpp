...
#include "modules/ui/qt/reconstruction/OrganMaterialEditor.hpp"
...
fwServicesRegisterMacro( sight::ui::base::editor::IEditor, sight::modules::ui::qt::reconstruction::OrganMaterialEditor,
                         data::Reconstruction )
...
{
    FW_DEPRECATED("::modules::ui::qt::reconstruction::OrganMaterialEditor",
                  "::modules::ui::qt::reconstruction::SOrganMaterialEditor", "21.0");
