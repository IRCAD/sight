...
void image_series_reader::openLocationDialog()
{
    ...
    dialog_file.setTitle(m_windowTitle.empty() ? "Choose a file to load an ImageSeries" : m_windowTitle);
...
void init_series(data::series::sptr _series)
{
    ...
    _series->setSeriesDescription("image imported with VTK");
...
void image_series_reader::updating()
{
    ...
    if(this->hasLocationDefined())
    {
        ...
        if(image_reader::loadImage(this->get_file(), image_series, m_sigJobCreated))
        {
