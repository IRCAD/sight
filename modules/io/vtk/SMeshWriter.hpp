 ...
 * define the path.
 */
class MODULE_IO_VTK_CLASS_API SMeshWriter : public sight::io::service::writer
{
public:

    ~SMeshWriter() noexcept override =
        default;

    SIGHT_DECLARE_SERVICE(SMeshWriter, sight::io::service::writer);
