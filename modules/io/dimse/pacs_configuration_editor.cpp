...
void pacs_configuration_editor::modifiedNotify(sight::io::dimse::data::PacsConfiguration::sptr _pacsConfiguration)
{
...
void pacs_configuration_editor::onSCPPortChanged(int value)
{
    const auto pacsConfiguration = m_config.lock();
