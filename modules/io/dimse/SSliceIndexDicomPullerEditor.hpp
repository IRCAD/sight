 ...
 * @deprecated it will be removed in sight 21.0, use modules::io::dimse::SSliceIndexDicomEditor instead.
 *
 * @section Slots Slots
 ...
 * @code{.xml}
        <service type="::sight::modules::io::dimse::SSliceIndexDicomPullerEditor">
 ...
 * - \b pacsConfig [dimse::data::PacsConfiguration]: PACS configuration data.
 *
 ...
 */
class MODULE_IO_DIMSE_CLASS_API SSliceIndexDicomPullerEditor final :
    public QObject,
...
public:
    ...
    /// Creates slots.
    [[deprecated("Will be removed in sight 21.0, use modules::io::dimse::SSliceIndexDicomEditor instead")]]
    MODULE_IO_DIMSE_API SSliceIndexDicomPullerEditor() noexcept;

    /// Destroys the service.
    MODULE_IO_DIMSE_API virtual ~SSliceIndexDicomPullerEditor() noexcept;
