 ...
 */
class MODULE_IO_IGTL_CLASS_API STDataListener : public module::io::igtl::network_listener
{
public:

    SIGHT_DECLARE_SERVICE(STDataListener, module::io::igtl::network_listener);
