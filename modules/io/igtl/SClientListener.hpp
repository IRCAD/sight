 ...
 */
class MODULE_IO_IGTL_CLASS_API SClientListener : public module::io::igtl::network_listener
{
public:

    SIGHT_DECLARE_SERVICE(SClientListener, module::io::igtl::network_listener);
