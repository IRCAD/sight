...
CPPUNIT_TEST_SUITE_REGISTRATION( sight::modules::io::atoms::ut::PatchTest );
...
void PatchTest::setUp()
{
    ...
    service::registry::ActiveWorkers::setDefaultWorker( core::thread::Worker::New() );
}
...
void PatchTest::patchMedicalDataTest()
{
    ...
    patcherCfg->setAttributeValue("version", sight::io::patch::semantic::PatchLoader::getCurrentVersion());
