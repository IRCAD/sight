...
class MODULE_DEBUG_CLASS_API memory_info : public sight::ui::action
{
public:

    SIGHT_DECLARE_SERVICE(memory_info, sight::ui::action);

    /// Does nothing
    MODULE_DEBUG_API memory_info() noexcept;

    /// Does nothing
    MODULE_DEBUG_API ~memory_info() noexcept override;
