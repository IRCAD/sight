 ...
 */
class MODULE_SYNC_CLASS_API SSynchronizer final : public service::synchronizer
{
public:

    SIGHT_DECLARE_SERVICE(SSynchronizer, service::synchronizer);
     ...
     *
     * Connect data::TimeLine::CLEARED_SIG to RESET_TIMELINE_SLOT
     */
    MODULE_SYNC_API service::connections_t getAutoConnections() const final;
