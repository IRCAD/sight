...
public:
    ...
    void initStandardInOut()
    {
        ...
        frameTL1 = std::make_shared<data::FrameTL>();
        ...
        frameTL2 = std::make_shared<data::FrameTL>();
        ...
        matrixTL1 = std::make_shared<data::MatrixTL>();
...
void SSynchronizerTest::singleMatrixTLConfigTest()
{
    ...
    // create input TLs
    data::MatrixTL::sptr matrixTL1 = std::make_shared<data::MatrixTL>();
    matrixTL1->initPoolSize(4);
...
void SSynchronizerTest::mixtMatrixTLConfigTest()
{
    ...
    // create input TLs
    data::MatrixTL::sptr matrixTL1 = std::make_shared<data::MatrixTL>();
    data::MatrixTL::sptr matrixTL2 = std::make_shared<data::MatrixTL>();
    matrixTL1->initPoolSize(4);
...
void SSynchronizerTest::singleFrameTLConfigTest()
{
    ...
    // create input TL
    auto frameTL = std::make_shared<data::FrameTL>();
...
void SSynchronizerTest::mixtFrameTLConfigTest()
{
    ...
    // create input TL
    auto frameTL1 = std::make_shared<data::FrameTL>();
    frameTL1->initPoolSize(
        tester.frameSize[0],
        tester.frameSize[1],
        core::type::UINT8,
    ...
    auto frameTL4 = std::make_shared<data::FrameTL>();
    ...
    auto frameTL6 = std::make_shared<data::FrameTL>();
...
void SSynchronizerTest::imageSeriesTimeTaggingTest()
{
    ...
    // create and set the input TL
    data::FrameTL::sptr frameTL1 = std::make_shared<data::FrameTL>();
    frameTL1->initPoolSize(
        frameSize[0],
        frameSize[1],
        core::type::UINT8,
    ...
    // create and set the inout which will be filled in the synchronization process
    sight::data::ImageSeries::sptr frame1 = std::make_shared<sight::data::ImageSeries>();
...
void SSynchronizerTest::singleImageSeriesTLPopulation()
{
    ...
    data::FrameTL::sptr frameTL2 = std::make_shared<data::FrameTL>();
    frameTL2->initPoolSize(
        frameSize[0],
        frameSize[1],
        core::type::UINT8,
