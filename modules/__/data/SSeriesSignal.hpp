 ...
 */
class MODULE_DATA_CLASS_API SSeriesSignal : public service::controller
{
public:

    SIGHT_DECLARE_SERVICE(SSeriesSignal, service::controller);
...
protected:
     ...
     */
    MODULE_DATA_API service::connections_t getAutoConnections() const override;
