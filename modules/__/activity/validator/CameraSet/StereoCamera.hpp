 ...
 *        matrix.
 */
class MODULE_ACTIVITY_CLASS_API StereoCamera : public sight::activity::validator::object
{
public:
    ...
    SIGHT_DECLARE_CLASS(
        ...
        sight::activity::validator::factory::make<StereoCamera>
    )

    /// Destructor. Do nothing.
    MODULE_ACTIVITY_API ~StereoCamera() override = default;
