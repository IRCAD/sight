 ...
 *        calibrated.
 */
class MODULE_ACTIVITY_CLASS_API MonoCamera : public sight::activity::validator::object
{
public:
    ...
    SIGHT_DECLARE_CLASS(
        ...
        sight::activity::validator::factory::make<MonoCamera>
    )

    /// Destructor. Do nothing.
    MODULE_ACTIVITY_API ~MonoCamera() override = default;
