 ...
 */
class MODULE_ACTIVITY_CLASS_API ContainOneSkin : public sight::activity::validator::object
{
public:
    ...
    SIGHT_DECLARE_CLASS(
        ...
        sight::activity::validator::factory::make<ContainOneSkin>
    )

    /// Destructor. Do nothing.
    MODULE_ACTIVITY_API ~ContainOneSkin() override;
