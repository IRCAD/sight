 ...
 *        matrix.
 */
class MODULE_ACTIVITY_CLASS_API stereo_camera : public sight::activity::validator::object
{
public:
    ...
    SIGHT_DECLARE_CLASS(
        ...
        sight::activity::validator::factory::make<stereo_camera>
    )

    /// Destructor. Do nothing.
    MODULE_ACTIVITY_API ~stereo_camera() override = default;
