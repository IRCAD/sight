...
SIGHT_REGISTER_ACTIVITY_VALIDATOR(sight::module::activity::validator::model_series::contain_one_tool);

//-----------------------------------------------------------------------------

sight::activity::validator::return_t contain_one_tool::validate(const data::object::csptr& _current_data) const
{
