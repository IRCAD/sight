...
private:
    ...
    sight::data::ptr<sight::data::Object, sight::data::Access::inout> m_source {this, s_SOURCE, true};
    sight::data::ptr_vector<sight::data::Object, sight::data::Access::out> m_target {this, s_TARGET, false};
};
