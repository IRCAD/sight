...
#ifndef _UIIMAGE_SLICE_LIST_EDITOR_HPP_
#define _UIIMAGE_SLICE_LIST_EDITOR_HPP_
 ...
 * @date    2010.
 */
class UIIMAGE_CLASS_API SliceListEditor : public ::gui::editor::IEditor
{
...
public :
    ...
    UIIMAGE_API virtual ~SliceListEditor() throw() ;
