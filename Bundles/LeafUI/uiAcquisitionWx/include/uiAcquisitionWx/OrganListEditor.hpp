#ifndef _UIACQUISITIONWX_ORGAN_LIST_EDITOR_HPP_
#define _UIACQUISITIONWX_ORGAN_LIST_EDITOR_HPP_
...
#include "uiAcquisitionWx/config.hpp"
 ...
 * @date    2010.
 */
class UIACQUISITIONWX_CLASS_API OrganListEditor : public ::gui::editor::IEditor
{
...
public :
    ...
    UIACQUISITIONWX_API OrganListEditor() throw() ;

    /// Destructor. Do nothing.
    UIACQUISITIONWX_API virtual ~OrganListEditor() throw() ;
...
#endif /*_UIACQUISITIONWX_ORGAN_LIST_EDITOR_HPP_*/
