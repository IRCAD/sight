...
#ifndef __UIIGTL__SCONNEXIONSTATUSVIEWER_HPP__
#define __UIIGTL__SCONNEXIONSTATUSVIEWER_HPP__
...
protected:
    ...
    /// Overrides
    UIIGTL_API virtual void receiving (::fwServices::ObjectMsg::csptr _msg) throw (::fwTools::Failed);
...
#endif /*__UIIGTL__SCONNEXIONSTATUSVIEWER_HPP__*/
