...
void SNegato2DCamera::resetCamera()
{
    ...
    switch(m_currentNegatoOrientation)
    {
        case Orientation::X_AXIS:
            ...
            camera->setOrthoWindowHeight(static_cast< ::Ogre::Real >(size[2] * spacing[2]));
            break;
        ...
        case Orientation::Z_AXIS:
            ...
            camera->setOrthoWindowHeight(static_cast< ::Ogre::Real >(size[1] * spacing[1]));
            break;
    }

    const size_t orientation = static_cast<size_t>(m_currentNegatoOrientation);
    ::Ogre::Vector3 camPos( static_cast< ::Ogre::Real >(origin[0] + size[0] * spacing[0] * 0.5),
                            static_cast< ::Ogre::Real >(origin[1] + size[1] * spacing[1] * 0.5),
                            static_cast< ::Ogre::Real >(origin[2] + size[2] * spacing[2] * 0.5));

    camPos[orientation] = static_cast< ::Ogre::Real >(origin[orientation] - size[orientation] * spacing[orientation]);
