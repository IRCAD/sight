...
void main()
{
    ...
    {
        colors[0] = vec4(1.0,0.0,0.0,1.0);//texture(u_srcTextures0, uv);
        colors[1] = vec4(0.0,1.0,0.0,1.0);//texture(u_srcTextures1, uv);
#if (VIEWPOINTS > 2)
        colors[2] = vec4(0.0,0.0,1.0,1.0);//texture(u_srcTextures2, uv);
#endif    /*(VIEWPOINTS > 2)    */
#if (VIEWPOINTS > 3)
        colors[3] = vec4(1.0,1.0,1.0,1.0);//texture(u_srcTextures3, uv);
#endif    /*(VIEWPOINTS > 3)    */
#if (VIEWPOINTS > 4)
        colors[4] = vec4(1.0,1.0,0.0,1.0);//texture(u_srcTextures4, uv);
#endif    /*(VIEWPOINTS > 4)    */
#if (VIEWPOINTS > 5)
        colors[5] = vec4(1.0,0.0,1.0,1.0);//texture(u_srcTextures5, uv);
#endif    /*(VIEWPOINTS > 5)    */
#if (VIEWPOINTS > 6)
        colors[6] = vec4(0.0,1.0,1.0,1.0);//texture(u_srcTextures6, uv);
#endif    /*(VIEWPOINTS > 6)    */
#if (VIEWPOINTS > 7)
        colors[7] = vec4(0.0,0.0,0.0,1.0);//texture(u_srcTextures7, uv);
#endif    /*(VIEWPOINTS > 7)    */
