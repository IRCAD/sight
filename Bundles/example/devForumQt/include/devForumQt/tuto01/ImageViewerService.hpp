...
#ifndef _DEVFORUMQT_TUTO1_IMAGEVIEWERSERVICE_HPP_
#define _DEVFORUMQT_TUTO1_IMAGEVIEWERSERVICE_HPP_
 ...
 * @date    2009.
 */
class DEVFORUMQT_CLASS_API ImageViewerService : public ::fwRender::IRender
{
...
protected :
    ...
    */
    ...
    DEVFORUMQT_API void createSyntheticImage( ::fwData::Image::sptr _pImage );

    /// Align negato to image center
    DEVFORUMQT_API void alignNegatoOnImageCenter();

    /// This method get associated image and initializes a VTK pipeline to render this image
    DEVFORUMQT_API void initVTKPipeline();
...
#endif // _DEVFORUMQT_TUTO1_IMAGEVIEWERSERVICE_HPP_
