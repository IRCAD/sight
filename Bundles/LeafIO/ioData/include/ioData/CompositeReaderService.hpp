...
// * ****** END LICENSE BLOCK ****** */
//
//#ifndef _IODATA_COMPOSITEREADER_HPP_
//#define _IODATA_COMPOSITEREADER_HPP_
//
...
//{
///**
// * @brief   Composite reader service.
// * @class   CompositeReaderService.
// * @author  IRCAD (Research and Development Team).
// * @date    2009.
// *
// * Service reading a composite object. Read the composite object and read all the object it contains.
// * @li Use setConfiguration(cfg) and configure() methods to configure the composite elements.
// * @li Use start() to initialize the service.
// * @li Use update() to load the composite and load all its elements.
...
// */
//class IODATA_CLASS_API CompositeReaderService : public ::io::IReader
//{
//
//
//public:
//    fwCoreServiceClassDefinitionsMacro ( (CompositeReaderService)(::io::IReader) ) ;
//
...
//     */
//    IODATA_API CompositeReaderService() ;
//
//    /**
//     * @brief   Destructor
//     */
//    IODATA_API ~CompositeReaderService() throw() ;
//
//    /**
...
//     * @verbatim
//     <service type="::io::IReader" implementation="::ioData::CompositeReaderService">
//        <input id="OBJ0A">
...
//     * For each composite input, one tries to start the io service. For configured input io service, the configuration is applied
//     */
...
//} // namespace ioData
//
//#endif // _IODATA_COMPOSITEREADER_HPP_
