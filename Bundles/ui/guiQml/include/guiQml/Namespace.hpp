...
{
/**
 * @page  guiQml guiQml Qml style
 *
 * @tableofcontents
 *
 * guiQml bundle contains the basic services to run a Qml application and style the application.
 *
 * The style in Qml is located inside guiQml.
 *
 ...
 * To setup Material for all projects, inside guiQml we apply it using QQuickStyle: `QQuickStyle::setStyle("Material");`
 ...
 * It is made in the qmldir in the subfolder rc/guiQml of the bundle guiQml. This line: `singleton Theme 1.0
 ...
 * Each control has his own Qml file inside rc/guiQml. E.g if the Button.qml is change to customize the style, it will
 ...
 * Like the singleton, it is manage inside the qmldir. `module guiQml` regroup all Component inside the module, so we
 * just need to import guiQml 1.0 inside each Qml you create.
 *
