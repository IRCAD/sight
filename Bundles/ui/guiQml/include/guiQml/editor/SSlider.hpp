...
//TO-DO Slider with integer data
 ...
 */
class GUIQML_CLASS_API SSlider : public QObject,
...
public:
    ...
    GUIQML_API SSlider() noexcept;

    /// Destructor. Do nothing.
    GUIQML_API virtual ~SSlider() noexcept;

    /**@name Signals API
     * @{
     */

    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_VALUE_CHANGED_SIG;
    ...
    GUIQML_API static const ::fwCom::Slots::SlotKeyType s_SET_VALUE_SLIDER_SLOT;
    GUIQML_API static const ::fwCom::Slots::SlotKeyType s_SET_MIN_VALUE_SLIDER_SLOT;
    GUIQML_API static const ::fwCom::Slots::SlotKeyType s_SET_MAX_VALUE_SLIDER_SLOT;
