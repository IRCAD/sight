...
#include <QPointer>
#include <QString>
//TO-DO use Qml TextEdit and then modify textDocument QQuickTextDocument property with QSyntaxHighlighter
 ...
 *  @code{.xml}
    <service uid="codeEditor" type="::guiQml::editor::Code" autoConnect="yes">
 ...
 */
class GUIQML_CLASS_API Code : public QObject,
...
public:
    ...
    GUIQML_API Code() noexcept;

    /// Destructor. Do nothing.
    GUIQML_API virtual ~Code() noexcept;
...
protected:
     ...
     */
    GUIQML_API virtual KeyConnectionsMap getAutoConnections() const override;
