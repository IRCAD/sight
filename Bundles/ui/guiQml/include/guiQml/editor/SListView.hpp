...
#include <QListWidget>
#include <QPointer>
//TO-DO SListView that draw a list
namespace guiQml
{
 ...
 */
class GUIQML_CLASS_API SListView : public QObject,
...
public:
    ...
    GUIQML_API SListView() noexcept;

    /// Destructor. Do nothing.
    GUIQML_API virtual ~SListView() noexcept;

    /**@name Signals API
     * @{
     */

    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_ITEM_ADDED_SIG;
    typedef ::fwCom::Signal<void (int)> ItemAddedSignalType;

    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_ITEM_REMOVED_SIG;
    typedef ::fwCom::Signal<void (int)> ItemRemovedSignalType;

    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_ITEM_DOUBLE_CLICKED_SIG;
    ...
    GUIQML_API static const ::fwCom::Slots::SlotKeyType s_INSERT_ITEM_SLOT;
    GUIQML_API static const ::fwCom::Slots::SlotKeyType s_REMOVE_ITEM_SLOT;
