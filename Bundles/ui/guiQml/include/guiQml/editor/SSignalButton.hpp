...
//TO-DO Editor button that send signal
 ...
 */
class GUIQML_CLASS_API SSignalButton : public QObject,
...
public:
    ...
    GUIQML_API SSignalButton() noexcept;

    /// Destructor. Do nothing.
    GUIQML_API virtual ~SSignalButton() noexcept;
...
protected:
     ...
     */
    GUIQML_API virtual void info(std::ostream& _sstream ) override;
