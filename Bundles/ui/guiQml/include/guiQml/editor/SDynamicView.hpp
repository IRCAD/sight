 ...
 */
class GUIQML_CLASS_API SDynamicView : public QObject,
...
public:
    ...
    GUIQML_API SDynamicView() noexcept;

    /// Destructor. Do nothing.

    GUIQML_API virtual ~SDynamicView() noexcept;

    typedef ::fwCom::Signal< void ( ::fwData::Object::sptr ) > ActivitySelectedSignalType;
    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_ACTIVITY_SELECTED_SIG;
    typedef ::fwCom::Signal< void () > NothingSelectedSignalType;
    GUIQML_API static const ::fwCom::Signals::SignalKeyType s_NOTHING_SELECTED_SIG;
protected:
...
private:
    ...
    {
        ::fwGuiQml::container::QmlContainer::sptr container;
