...
//TO-DO SParameters to setup an editor with several param
 ...
 */
class GUIQML_CLASS_API SParameters : public QObject,
...
public:
    ...
    GUIQML_API SParameters() noexcept;

    /// Destructor. Does nothing
    GUIQML_API virtual ~SParameters() noexcept;

    /// Configure the editor.
    GUIQML_API void configuring() override;

    /// Initializes Qt input widgets for parameters according to xml configuration
    GUIQML_API void starting() override;

    /// This method launches the IEditor::stopping method
    GUIQML_API void stopping() override;

    /// This method is used to update services. Does nothing
    GUIQML_API void updating() override;
