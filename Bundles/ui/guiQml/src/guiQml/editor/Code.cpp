...
#include "guiQml/editor/Code.hpp"
...
fwServicesRegisterMacro( ::fwGui::editor::IEditor, ::guiQml::editor::Code, ::fwData::String );
...
void Code::starting()
{
    ...
    ::fwGuiQml::container::QmlContainer::sptr qtContainer = ::fwGuiQml::container::QmlContainer::dynamicCast(
        this->getContainer() );
    ...
    {
        m_highlighter = new ::fwGuiQml::highlighter::PythonHighlighter(m_valueCtrl->document());
    }
