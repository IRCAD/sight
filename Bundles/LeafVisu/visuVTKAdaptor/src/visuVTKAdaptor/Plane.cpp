...
Plane::Plane() throw()
{
    ...
    addNewHandlingEvent( ::fwComEd::PointMsg::START_POINT_INTERACTION );
    addNewHandlingEvent( ::fwComEd::PlaneMsg::PLANE_MODIFIED );
    addNewHandlingEvent( ::fwComEd::PlaneMsg::WAS_SELECTED );
    addNewHandlingEvent( ::fwComEd::PlaneMsg::WAS_DESELECTED );
