...
SIGHT_REGISTER_DATA_VALIDATOR(sight::data::validator::camera_set::mono_camera);

//-----------------------------------------------------------------------------

sight::data::validator::return_t mono_camera::validate(const data::object::csptr& _current_data) const
{
