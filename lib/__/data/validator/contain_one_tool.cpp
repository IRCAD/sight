...
SIGHT_REGISTER_DATA_VALIDATOR(sight::data::validator::model_series::contain_one_tool);

//-----------------------------------------------------------------------------

sight::data::validator::return_t contain_one_tool::validate(const data::object::csptr& _object) const
{
