...
// This file was automatically generated by the '/lib/__/data/dicom/class_generator.py' script. DO NOT EDIT !
// Used arguments: 'Namespace(verbose=False, source_url='http://dicom.nema.org/medical/dicom/2023e/source/docbook',
...
TEST_SUITE("sight::data::dicom::attribute")
{
// cspell: ignore WADO Wundefined afterloader angio ascan autorefraction autosequence boli bscan cadsr ciexy ctdi
// cspell: ignore ctdivol decf deidentification dermoscopic diconde dicos dvhroi exif fiducials fluence fnumber framek
// cspell: ignore frameof gpsdop hicpp hpgl imager inms inua inus iods isop ivol ivus keratoconus keratometer
// cspell: ignore keratometric kerma lensometry lookat macid meterset metersets mrfov multiway nmpet nmtomo nolintbegin
// cspell: ignore nolintend octb octz oecf olink postamble powerline prcs presaturation radiofluoroscopic relaxivity
// cspell: ignore reprojection rgblut rtdvh rtroi sddn sdhn sdvn softcopy soundpath stereometric stowrs tlhc tomo
// cspell: ignore tomosynthesis tomotherapeutic toric tractography xaxrf
...
// NOLINTBEGIN
    ...
    TEST_CASE("enum")
    {
        ...
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::SOPClassUID>::s_keyword,
            attribute::get(0x0008, 0x0016).m_keyword
        );
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::SOPClassUID>::s_keyword,
            attribute::get(attribute::Keyword::SOPClassUID).m_keyword
        );
        CHECK_EQ(
        ...
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::RelatedGeneralSOPClassUID>::s_keyword,
            attribute::get(
                0x0008,
                0x001A
            ).m_keyword
        ...
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::RelatedGeneralSOPClassUID>::s_keyword,
            attribute::get(attribute::Keyword::RelatedGeneralSOPClassUID).m_keyword
        );
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::OriginalSpecializedSOPClassUID>::s_keyword,
            attribute::get(0x0008, 0x001B).m_keyword
        );
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::OriginalSpecializedSOPClassUID>::s_keyword,
            attribute::get(attribute::Keyword::OriginalSpecializedSOPClassUID).m_keyword
        );
        CHECK_EQ(
    ...
    TEST_CASE("enum2")
    {
        ...
        CHECK_EQ(
            attribute::Attribute<attribute::Keyword::ParallelRTBeamDelimiterDeviceOrientationLabelCodeSequence>::
            s_keyword,
