...
public:
     ...
     */
    [[nodiscard]] SIGHT_CORE_API core::clock::type get_elapsed_time_in_sec() const;

    /**
     * @return Elapsed time in milliseconds
     */
    [[nodiscard]] SIGHT_CORE_API core::clock::type get_elapsed_time_in_milli_sec() const;

    /**
     * @return Elapsed time in microseconds
     */
    [[nodiscard]] SIGHT_CORE_API core::clock::type get_elapsed_time_in_micro_sec() const;
