 ...
 */
class SIGHT_UI_DICOM_CLASS_API tag_value_configurable_sorter : public sight::filter::dicom::sorter::tag_value_sorter
{
public:
    ...
    /// Destructor
    SIGHT_UI_DICOM_API ~tag_value_configurable_sorter() override = default;
