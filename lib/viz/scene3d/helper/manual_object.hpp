...
public:
     ...
     */
    SIGHT_VIZ_SCENE3D_API static void create_cylinder(
     ...
     */
    SIGHT_VIZ_SCENE3D_API static void create_cone(
        Ogre::ManualObject* _object,
        const std::string& _material,
        const Ogre::ColourValue& _color = Ogre::ColourValue(1.F, 1.F, 1.F),
        float _radius                   = 1.F,
     ...
     */
    SIGHT_VIZ_SCENE3D_API static void create_cube(
        Ogre::ManualObject* _object,
        const std::string& _material,
        const Ogre::ColourValue& _color = Ogre::ColourValue(1.F, 1.F, 1.F),
        float _length                   = 100.F
     ...
     * @param _sample the number of samples used to create the sphere
     */
    SIGHT_VIZ_SCENE3D_API static void create_sphere(
        Ogre::ManualObject* _object,
        const std::string& _material,
        const Ogre::ColourValue& _color = Ogre::ColourValue(1.F, 1.F, 1.F),
        float _radius                   = 100.F,
     ...
     */
    SIGHT_VIZ_SCENE3D_API static void create_frustum(
        Ogre::ManualObject* _object,
        const std::string& _material,
     ...
     */
    SIGHT_VIZ_SCENE3D_API static void draw_dashed_line(
        Ogre::ManualObject* _object,
