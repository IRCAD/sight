...
/**
 * @brief Test image_position_patient_splitter class
 */
class image_position_patient_splitter_test : public CPPUNIT_NS::TestFixture
{
CPPUNIT_TEST_SUITE(image_position_patient_splitter_test);
CPPUNIT_TEST(simple_application);
CPPUNIT_TEST(negative_spacing_application);
...
public:
    ...
    static void negative_spacing_application();
};
