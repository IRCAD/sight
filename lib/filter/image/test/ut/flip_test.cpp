...
TEST_SUITE("sight::filter::image::flip")
{
//------------------------------------------------------------------------------

    TEST_CASE("flip_along_x_axis")
    {
        const sight::data::image::size_t size                = {3, 3, 3};
        const sight::data::image::spacing_t spacing          = {0.1, 0.4, 1.6};
        ...
        sight::filter::image::flipper::flip(image_in, image_out, flip_axes);
        ...
        for(std::size_t i = 0 ; i < size[0] ; ++i)
        {
            for(std::size_t j = 0 ; j < size[1] ; ++j)
            {
                for(std::size_t k = 0 ; k < size[2] ; ++k)
                {
                    ...
                    CHECK_EQ(static_cast<int>(value_in), static_cast<int>(value_out));
                }
            }
        }
    }
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("flip_along_y_axis")
    {
        const sight::data::image::size_t size                = {3, 3, 3};
        const sight::data::image::spacing_t spacing          = {0.5, 0.5, 0.5};
        const sight::data::image::origin_t origin            = {8., 4., 2.};
        const sight::data::image::orientation_t orientation  = {0.36, 0.48, -0.8, -0.8, 0.6, 0.0, 0.48, 0.64, 0.6};
        const sight::core::type type                         = sight::core::type::UINT8;
        const enum sight::data::image::pixel_format_t format = sight::data::image::gray_scale;
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("flip_along_z_axis")
    {
        const sight::data::image::size_t size                = {3, 3, 3};
        const sight::data::image::spacing_t spacing          = {2.0, 2.0, 2.0};
        const sight::data::image::origin_t origin            = {0., 0., 0.};
        const sight::data::image::orientation_t orientation  = {0.36, 0.48, -0.8, -0.8, 0.6, 0.0, 0.48, 0.64, 0.6};
        const sight::core::type type                         = sight::core::type::UINT8;
        const enum sight::data::image::pixel_format_t format = sight::data::image::gray_scale;
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("flip_along_multiple_axes")
    {
        {
            const sight::data::image::size_t size                = {3, 3, 3};
            const sight::data::image::spacing_t spacing          = {0.5, 0.5, 0.5};
...
//------------------------------------------------------------------------------
    ...
    TEST_CASE("flip_empty_image")
    {
        const sight::data::image::size_t size                = {0, 0, 0};
        const sight::data::image::spacing_t spacing          = {0., 0., 0.};
        const sight::data::image::origin_t origin            = {0., 0., 0.};
        const sight::data::image::orientation_t orientation  = {0.36, 0.48, -0.8, -0.8, 0.6, 0.0, 0.48, 0.64, 0.6};
        const sight::core::type type                         = sight::core::type::UINT8;
        const enum sight::data::image::pixel_format_t format = sight::data::image::gray_scale;
        ...
        const sight::data::image::size_t image_size     = image_in->size();
        const sight::data::image::size_t image_out_size = image_out->size();

        CHECK_EQ(image_size[0], image_out_size[0]);
        CHECK_EQ(image_size[1], image_out_size[1]);
        CHECK_EQ(image_size[2], image_out_size[2]);
    }
