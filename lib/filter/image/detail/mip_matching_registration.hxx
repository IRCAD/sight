...
)
{
    ...
    const image_3d_ptr_t itk_moving = sight::filter::image::detail::cast_to<PIX>(*moving);
    const image_3d_ptr_t itk_fixed  = sight::filter::image::detail::cast_to<PIX>(*fixed);
