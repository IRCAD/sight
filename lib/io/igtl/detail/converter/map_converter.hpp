...
/**
 *
 * @brief class to manage conversion between data::map and igtl::TrackingDataMessage
 */
class SIGHT_IO_IGTL_CLASS_API map_converter : public base
{
public:

    /// Constructor
    SIGHT_IO_IGTL_API map_converter();

    /// Destructor
    SIGHT_IO_IGTL_API ~map_converter() override;
    ...
    /**
     * @brief create new MapConverter
     * @return a smart pointer to a MapConverter
     */
