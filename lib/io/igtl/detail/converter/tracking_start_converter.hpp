...
/**
 *
 * @brief class to manage conversion between data::map and STT_TDATA in igtl::TrackingDataMessage
 */
class SIGHT_IO_IGTL_CLASS_API tracking_start_converter : public base
{
public:

    /// Constructor
    SIGHT_IO_IGTL_API tracking_start_converter();

    /// Destructor
    SIGHT_IO_IGTL_API ~tracking_start_converter() override;
