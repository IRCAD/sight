 ...
 */
class SIGHT_IO_DICOM_CLASS_API series : public io::dicom::reader::ie::information_entity<data::series>
{
public:
     ...
     * @see PS 3.3 C.7.3.1
     */
    SIGHT_IO_DICOM_API virtual void read_general_series_module();
};
