 ...
 */
class SIGHT_IO_DICOM_CLASS_API measurement_report : public io::dicom::writer::tid::template_id<data::image>
{
public:
     ...
     */
    SIGHT_IO_DICOM_API virtual SPTR(io::dicom::container::sr::dicom_sr_node) create_root_node(
