...
void matrix::copy_from_cv(const cv::Mat& _rvec, const cv::Mat& _tvec, data::matrix4& _dst)
{
...
void matrix::copy_from_cv(const cv::Mat& _src, data::matrix4& _dst)
{
...
void matrix::copy_to_cv(const data::matrix4& _src, cv::Mat& _rvec, cv::Mat& _tvec)
{
    // reinitialize _R & _T.
    ...
    cv::Mat mat4x4 = copy_to_cv<double>(_src);
