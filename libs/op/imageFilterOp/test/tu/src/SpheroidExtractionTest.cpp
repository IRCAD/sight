...
CPPUNIT_TEST_SUITE_REGISTRATION( ::imageFilterOp::ut::SpheroidExtractionTest );
...
static void makeNoise(const ::fwData::Image::sptr& _image,
...
void SpheroidExtractionTest::extractionTest()
{
    ...
    const ::fwData::Image::Size SIZE = {{ 128, 128, 128 }};
    ...
    ::fwItkIO::itkImageToFwDataImage(itkImage, image);

    ::fwData::PointList::sptr extractedSpheroids =
        ::imageFilterOp::SpheroidExtraction::extract(image, 200., 4., 9., 0.8, 1.2);
