 ...
 */
class app_config_manager : public service::app_config_manager,
                           public core::com::has_slots
{
public:

    SIGHT_DECLARE_CLASS(app_config_manager, service::app_config_manager);
...
private:
    ...
    service::base::sptr createService(const detail::ServiceConfig& srvConfig);
...
inline std::string app_config_manager::msgHead() const
{
    return "[" + m_configId + "] ";
}
