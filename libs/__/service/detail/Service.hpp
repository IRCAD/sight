...
public:
    ...
    const service::config_t& getConfiguration() const;

    // Configures the service
    void configure();

    // Slot: starts the service
    base::SharedFutureType start(bool _async);

    // Slot: stops the service
    base::SharedFutureType stop(bool _async);

    // Slot: swaps an object
    base::SharedFutureType swapKey(std::string_view _key, data::Object::sptr _obj, bool _async);

    // Slot: updates the service
    base::SharedFutureType update(bool _async);
    ...
    static core::com::connection connectRegisterOut(const core::com::slot_base::sptr& _slot);
    static core::com::connection connectUnregisterOut(const core::com::slot_base::sptr& _slot);
