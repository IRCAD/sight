...
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest1OptInput);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest2Inputs);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest2InputsV2);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest4Inputs);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest1Inout);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest3Inouts);
...
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest2InputGroups);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest1Input1Output2Inouts);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest1Input1InputGroup);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STest1Input1OptInput1OptInOut);
SIGHT_REGISTER_SERVICE(sight::service::ut::test_srv, sight::service::ut::STestOut);
SIGHT_REGISTER_SERVICE(sight::service::base, sight::service::ut::TestServiceWithData);
...
const service::base::KeyType TestServiceWithData::s_INPUT       = "input";
const service::base::KeyType TestServiceWithData::s_INOUT_GROUP = "inoutGroup";
const service::base::KeyType TestServiceWithData::s_OUTPUT      = "output";
