 ...
 */
class TestService : public service::base
{
public:
    ...
    SIGHT_DECLARE_SERVICE(TestService, service::base);
 ...
 */
class test_srv : public TestService
{
public:

    SIGHT_DECLARE_CLASS(test_srv, TestService);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STestNoData, service::ut::test_srv);
};
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STestNoData2, service::ut::test_srv);
};
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1Input, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1OptInput, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest2Inputs, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest2InputsV2, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest4Inputs, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1Inout, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest3Inouts, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest3InoutsV2, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest2Inouts1Input, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1Input1OptInput1OptInOut, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest2InputGroups, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1Input1InputGroup, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STest1Input1Output2Inouts, service::ut::test_srv);
...
public:
    ...
    SIGHT_DECLARE_SERVICE(STestOut, service::ut::test_srv);
...
class TestServiceWithData : public service::base
{
public:
    ...
    SIGHT_DECLARE_SERVICE(TestServiceWithData, service::base);
