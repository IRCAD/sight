...
public:
    ...
    static const service::base::KeyType s_INPUT;
    static const service::base::KeyType s_INOUT;
    static const service::base::KeyType s_OUTPUT;
...
const service::base::KeyType LockedService::s_INPUT  = "input";
const service::base::KeyType LockedService::s_INOUT  = "inout";
const service::base::KeyType LockedService::s_OUTPUT = "output";
