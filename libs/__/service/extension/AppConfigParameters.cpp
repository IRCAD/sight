...
AppConfigParameters::sptr AppConfigParameters::s_appConfigParameters = std::make_shared<AppConfigParameters>();
...
{
    auto extensions = core::runtime::get_all_extensions_for_point("sight::service::extension::AppConfigParameters");
