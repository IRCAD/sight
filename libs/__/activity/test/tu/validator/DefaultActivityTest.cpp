...
void DefaultActivityTest::requirementsTest()
{
    activity::validator::base::sptr validator =
        activity::validator::factory::make("sight::activity::validator::DefaultActivity");
    ...
    data::ImageSeries::sptr imageSeries  = std::make_shared<data::ImageSeries>();
...
void DefaultActivityTest::bigActivityTest()
{
    ...
    data::ImageSeries::sptr imageSeries1 = std::make_shared<data::ImageSeries>();
    data::ImageSeries::sptr imageSeries2 = std::make_shared<data::ImageSeries>();
    data::ImageSeries::sptr imageSeries3 = std::make_shared<data::ImageSeries>();
    ...
    data::Float::sptr floatObj  = std::make_shared<data::Float>();
