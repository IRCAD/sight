 ...
 */
class ACTIVITY_CLASS_API ImageProperties : public validator::object
{
public:

    SIGHT_DECLARE_CLASS(ImageProperties, validator::object)

    /// Destructor. Do nothing.
    ACTIVITY_API ~ImageProperties() override = default;
