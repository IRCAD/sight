 ...
 */
class ACTIVITY_CLASS_API DefaultActivity : public validator::activity
{
public:

    SIGHT_DECLARE_CLASS(DefaultActivity, validator::activity)

    /// Destructor. Do nothing.
    ACTIVITY_API ~DefaultActivity() override = default;
