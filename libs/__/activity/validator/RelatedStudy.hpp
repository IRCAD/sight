 ...
 */
class ACTIVITY_CLASS_API RelatedStudy : public activity::validator::base
{
public:

    SIGHT_DECLARE_CLASS(RelatedStudy, activity::validator::base);

    /// Destructor. Do nothing.
    ACTIVITY_API ~RelatedStudy() override = default;
