 ...
 */
CORE_API void add_modules(const std::filesystem::path& directory);
 ...
 */
CORE_API std::shared_ptr<module> find_module(const std::string& identifier);
 ...
 */
CORE_API std::shared_ptr<module> load_module(const std::string& identifier);
 ...
 * @param   identifier  a string containing a module identifier
 */
CORE_API void start_module(const std::string& identifier);
 ...
 * @return  a shared pointer to the found module, or empty when it is not found
 */
CORE_API void unload_module(const std::string& identifier);
 ...
 * @return  success
 */
CORE_API bool load_library(const std::string& identifier);
 ...
 */
CORE_API std::shared_ptr<extension> find_extension(const std::string& identifier);

/// Returns extensions extending the _extension_pt extension point
CORE_API std::vector<std::shared_ptr<core::runtime::extension> > get_all_extensions_for_point(std::string extension_pt);

/// Utility function used to trim leading '::' in identifiers of modules, services, objects, extensions, etc...
CORE_API std::string filter_id(const std::string& identifier);
