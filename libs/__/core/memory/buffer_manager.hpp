...
public:
     ...
     */
    CORE_API virtual std::shared_future<void> register_buffer(buffer_ptr_t buffer_ptr);
     ...
     * @param bufferPtr BufferObject's buffer pointer.
     */
    CORE_API virtual std::shared_future<void> unregister_buffer(buffer_ptr_t buffer_ptr);
     ...
     */
    CORE_API virtual std::shared_future<void> reallocate_buffer(buffer_ptr_t buffer_ptr, size_t new_size);
     ...
     * @param bufferPtr BufferObject's buffer pointer
     */
    CORE_API virtual std::shared_future<void> destroy_buffer(buffer_ptr_t buffer_ptr);
     ...
     */
    CORE_API virtual std::shared_future<void> swap_buffer(buffer_ptr_t buf_a, buffer_ptr_t buf_b);
     ...
     */
    CORE_API virtual std::shared_future<SPTR(void)> lock_buffer(const_buffer_ptr_t buffer_ptr);
     ...
     * @return false if the BufferManager supported the action
     */
    CORE_API virtual std::shared_future<bool> unlock_buffer(const_buffer_ptr_t buffer_ptr);
     ...
     * @{ */
    CORE_API std::shared_future<bool> dump_buffer(const_buffer_ptr_t buffer_ptr);
    CORE_API std::shared_future<bool> restore_buffer(const_buffer_ptr_t buffer_ptr);
    /**  @} */
    ...
    CORE_API static buffer_stats compute_buffer_stats(const buffer_info_map_t& buffer_info);

    /**
     * @brief Sets the dump policy
     */
    CORE_API void set_dump_policy(const SPTR(core::memory::policy::base)& policy);
     ...
     */
    CORE_API std::shared_future<stream_info> get_stream_info(const_buffer_ptr_t buffer_ptr) const;
    ...
    CORE_API void set_loading_mode(loading_mode_type mode);
...
protected:
     ...
     * @{ */
    virtual void register_buffer_impl(buffer_ptr_t buffer_ptr);
    virtual void unregister_buffer_impl(buffer_ptr_t buffer_ptr);
    ...
    virtual void reallocate_buffer_impl(buffer_ptr_t buffer_ptr, size_t new_size);
    virtual void destroy_buffer_impl(buffer_ptr_t buffer_ptr);
    virtual void swap_buffer_impl(buffer_ptr_t buf_a, buffer_ptr_t buf_b);
    virtual SPTR(void) lock_buffer_impl(const_buffer_ptr_t buffer_ptr);
    virtual bool unlock_buffer_impl(const_buffer_ptr_t buffer_ptr);
    virtual std::string to_string_impl() const;
    bool dump_buffer_impl(const_buffer_ptr_t buffer);
    bool restore_buffer_impl(const_buffer_ptr_t buffer);
    static bool write_buffer_impl(const_buffer_t buffer, size_t size, const std::filesystem::path& path);
    static bool read_buffer_impl(buffer_t buffer, size_t size, const std::filesystem::path& path);
    buffer_info_map_t get_buffer_infos_impl() const;
    stream_info get_stream_info_impl(const_buffer_ptr_t buffer_ptr) const;
     ...
     * @{ */
    CORE_API bool dump_buffer(buffer_info& info, buffer_ptr_t buffer_ptr);
    CORE_API bool restore_buffer(buffer_info& info, buffer_ptr_t buffer_ptr, size_t size = 0);
    /**  @} */
