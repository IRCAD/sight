...
void SeriesSetTest::generationTest()
{
    ...
    CPPUNIT_ASSERT(std::dynamic_pointer_cast<data::ImageSeries>(series_set->at(0)));
    ...
    for(const auto& series : *series_set)
    {
        ...
        data::ImageSeries::sptr imgSeries   = std::dynamic_pointer_cast<data::ImageSeries>(series);
