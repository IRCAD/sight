...
class DATA_CLASS_API ActivitySet final : public data::container<sequenced_set<std::shared_ptr<Activity> > >
{
public:

    SIGHT_DECLARE_CLASS(ActivitySet, container<ActivitySet::container_type>);
    ...
    using container<ActivitySet::container_type>::container;
    using container<ActivitySet::container_type>::operator=;
    /// @}
