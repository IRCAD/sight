...
template<class BUFFER_TYPE>
void GenericTL<BUFFER_TYPE>::shallow_copy(const Object::csptr&)
{
...
template<class BUFFER_TYPE>
void GenericTL<BUFFER_TYPE>::deep_copy(const Object::csptr& source, const std::unique_ptr<DeepCopyCacheType>& cache)
{
    const auto& other = std::dynamic_pointer_cast<const GenericTL<BUFFER_TYPE> >(source);
...
template<class BUFFER_TYPE>
CSPTR(typename GenericTL<BUFFER_TYPE>::BufferType)
GenericTL<BUFFER_TYPE>::get_buffer(core::hires_clock::type timestamp) const
{
...
GenericTL<BUFFER_TYPE>::createObject(core::hires_clock::type timestamp)
{
...
GenericTL<BUFFER_TYPE>::createBuffer(core::hires_clock::type timestamp)
{
