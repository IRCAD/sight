 ...
 */
class DATA_CLASS_API TransferFunctionPiece final : public ContainerWrapper<std::map<transfer_function_base::value_t,
...
public:
    ...
    static TransferFunctionPiece::sptr make();
...
public:
    ...
    SIGHT_DECLARE_CLASS(TransferFunction, Object);
...
inline TransferFunctionPiece::sptr TransferFunctionPiece::make()
{
