...
class DATA_CLASS_API SeriesSet final : public data::container<sequenced_set<std::shared_ptr<Series> > >
{
public:

    SIGHT_DECLARE_CLASS(SeriesSet, container<SeriesSet::container_type>);
    ...
    using container<SeriesSet::container_type>::container;
    using container<SeriesSet::container_type>::operator=;
    /// @}
