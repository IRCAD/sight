...
void RawBufferTL::shallow_copy(const Object::csptr& /*source*/)
{
...
void RawBufferTL::deep_copy(const Object::csptr& source, const std::unique_ptr<DeepCopyCacheType>& cache)
{
    const auto& other = std::dynamic_pointer_cast<const RawBufferTL>(source);
...
CSPTR(data::timeline::RawBuffer) RawBufferTL::get_buffer(core::hires_clock::type timestamp) const
{
...
SPTR(data::timeline::Object) RawBufferTL::createObject(core::hires_clock::type timestamp)
{
...
SPTR(data::timeline::RawBuffer) RawBufferTL::createBuffer(core::hires_clock::type timestamp)
{
