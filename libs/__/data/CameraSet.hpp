...
class DATA_CLASS_API CameraSet final : public data::container<std::vector<std::pair<std::shared_ptr<Camera>,
                                                                                    std::shared_ptr<Matrix4> > > >
{
public:

    SIGHT_DECLARE_CLASS(CameraSet, container<CameraSet::container_type>);
    ...
    using container<CameraSet::container_type>::container;
    using container<CameraSet::container_type>::operator=;
    /// @}
