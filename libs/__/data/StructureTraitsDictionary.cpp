...
void StructureTraitsDictionary::shallow_copy(const Object::csptr& source)
{
    const auto& other = std::dynamic_pointer_cast<const StructureTraitsDictionary>(source);
...
void StructureTraitsDictionary::deep_copy(const Object::csptr& source, const std::unique_ptr<DeepCopyCacheType>& cache)
{
    const auto& other = std::dynamic_pointer_cast<const StructureTraitsDictionary>(source);
