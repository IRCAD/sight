...
public:
    ...
    typedef core::hires_clock::type TimestampType;
    ...
    DATA_API CSPTR(timeline::object) getObject(core::hires_clock::type timestamp)
    const override;
    ...
    DATA_API void set_object(TimestampType timestamp, const SPTR(timeline::object)& obj) override;
    ...
    /// @{
    DATA_API bool operator==(const buffer_tl& other) const noexcept;
    DATA_API bool operator!=(const buffer_tl& other) const noexcept;
    /// @}
