...
public:
    ...
    DATA_API static DicomType getDicomType(const std::string& sop_classUID) noexcept;
    ...
    DATA_API std::filesystem::path get_file(std::size_t instance                   = 0) const;
    DATA_API void set_file(const std::filesystem::path& file, std::size_t instance = 0);
