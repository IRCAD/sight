...
{
    data::MarkerMap::sptr markerMap = std::make_shared<data::MarkerMap>();
...
void MarkerMapTest::shallow_copyTest()
{
    data::MarkerMap::sptr markerMap1 = std::make_shared<data::MarkerMap>();
    markerMap1->setMarker("101", marker101);
    markerMap1->setMarker("102", marker102);

    data::MarkerMap::sptr markerMap2 = std::make_shared<data::MarkerMap>();
...
void MarkerMapTest::deep_copyTest()
{
    data::MarkerMap::sptr markerMap1 = std::make_shared<data::MarkerMap>();
    markerMap1->setMarker("101", marker101);
    markerMap1->setMarker("102", marker102);
