...
void TransferFunctionTest::shallowAndDeepCopyTest()
{
    ...
    const data::TransferFunction::sptr shallow_copyTf = std::make_shared<data::TransferFunction>();
    shallow_copyTf->shallow_copy(tf);
    sight::data::ut::TransferFunctionTest::checkTFColor(shallow_copyTf);
    CPPUNIT_ASSERT_EQUAL(tf->pieces()[0], shallow_copyTf->pieces()[0]);

    const data::TransferFunction::sptr deep_copyTf = data::Object::copy(tf);
    sight::data::ut::TransferFunctionTest::checkTFColor(deep_copyTf);
...
{
    const auto tfData = std::make_shared<data::TransferFunctionPiece>();
...
{
    auto tf = std::make_shared<data::TransferFunction>();

    auto piece_0 = std::make_shared<data::TransferFunctionPiece>();
    ...
    auto piece_1 = std::make_shared<data::TransferFunctionPiece>();
...
{
    auto function1 = std::make_shared<data::TransferFunction>();
    auto function2 = std::make_shared<data::TransferFunction>();
    ...
    TEST(pieces().push_back(std::make_shared<data::TransferFunctionPiece>()));
