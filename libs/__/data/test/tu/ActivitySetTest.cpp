...
void ActivitySetTest::nominalTest()
{
    ...
    CPPUNIT_ASSERT(activity_set->insert(activity_set->end(), std::make_shared<Activity>()).second == true);
...
void ActivitySetTest::copyTest()
{
    ...
    shallow_activity_set->shallow_copy(original_activity_set);
    ...
    deep_activity_set->deep_copy(original_activity_set);
