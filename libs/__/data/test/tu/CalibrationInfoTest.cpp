...
void CalibrationInfoTest::shallow_copyTest()
{
    data::CalibrationInfo::sptr calInfo = std::make_shared<data::CalibrationInfo>();
    ...
    data::CalibrationInfo::sptr calInfo2 = std::make_shared<data::CalibrationInfo>();
...
void CalibrationInfoTest::deep_copyTest()
{
    data::CalibrationInfo::sptr calInfo = std::make_shared<data::CalibrationInfo>();
...
void CalibrationInfoTest::getImageTest()
{
    ...
    auto pl2 = std::make_shared<data::PointList>();
    pl2->setPoints(
