...
void DoubleTest::methode1()
{
    ...
    {
        auto d0 = std::make_shared<data::Double>();
        d0->value() = VALUE;
        auto d1 = std::make_shared<data::Double>(VALUE);
        auto d2 = std::make_shared<data::Double>(VALUE + 0.1);
        auto d3 = std::make_shared<data::Double>();
        d3->shallow_copy(d1);
        auto d4 = std::make_shared<data::Double>();
        d4->deep_copy(d1);
        ...
        CPPUNIT_ASSERT_EQUAL(VALUE, std::make_shared<data::Double>(VALUE)->value());
    ...
    for(double VALUE : NAN_VALUES)
    {
        ...
        d0->value() = VALUE;
        auto d1 = std::make_shared<data::Double>(VALUE);
        auto d2 = std::make_shared<data::Double>();
        d2->shallow_copy(d1);
        auto d3 = std::make_shared<data::Double>();
        d3->deep_copy(d1);
        ...
        CPPUNIT_ASSERT(!(VALUE == std::make_shared<data::Double>(VALUE)->value()));
        CPPUNIT_ASSERT(!(VALUE < std::make_shared<data::Double>(VALUE)->value()));
        CPPUNIT_ASSERT(!(VALUE > std::make_shared<data::Double>(VALUE)->value()));
    }
}
