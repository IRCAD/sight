...
{
    auto fs = std::make_shared<sight::data::FiducialsSeries>();
...
void FiducialsSeriesTest::shallow_copyTest()
{
    auto fs1 = initFiducialsSeries();
    auto fs2 = std::make_shared<data::FiducialsSeries>();
...
void FiducialsSeriesTest::deep_copyTest()
{
    auto fs1 = initFiducialsSeries();
    auto fs2 = std::make_shared<data::FiducialsSeries>();
