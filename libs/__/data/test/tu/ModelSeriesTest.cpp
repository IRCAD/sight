...
void ModelSeriesTest::setUp()
{
    ...
    m_series = std::make_shared<data::ModelSeries>();
}
...
void ModelSeriesTest::deep_copyTest()
{
    CPPUNIT_ASSERT(m_series);
    ...
    auto secondSeries = std::make_shared<data::ModelSeries>();
...
void ModelSeriesTest::shallow_copyTest()
{
    CPPUNIT_ASSERT(m_series);
...
{
    auto series1 = std::make_shared<data::ModelSeries>();
    auto series2 = std::make_shared<data::ModelSeries>();
    ...
    TEST(setDicomReference(std::make_shared<data::DicomSeries>()));
