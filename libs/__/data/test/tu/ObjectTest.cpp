...
void ObjectTest::fieldTest()
{
    ...
    data::Object::sptr fieldObj1 = std::make_shared<data::Float>();
    data::Object::sptr fieldObj2 = std::make_shared<data::Float>();
...
{
    data::Object::sptr object = std::make_shared<data::Float>();
...
{
    auto object1 = std::make_shared<data::Float>();
    auto object2 = std::make_shared<data::Float>();
