...
void ImageSeriesTest::setUp()
{
    ...
    m_series = std::make_shared<data::ImageSeries>();
}
...
void ImageSeriesTest::imageTest()
{
    ...
    auto series2 = std::make_shared<data::ImageSeries>();
...
{
    auto series1 = std::make_shared<data::ImageSeries>();
    auto series2 = std::make_shared<data::ImageSeries>();
    ...
    auto dicomSeries = std::make_shared<data::DicomSeries>();
    ...
    auto series3 = std::make_shared<data::ImageSeries>();
