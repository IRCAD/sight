...
void DicomSeriesTest::setUp()
{
    ...
    m_series = std::make_shared<data::DicomSeries>();
}
...
{
    auto dicomSeries1 = std::make_shared<data::DicomSeries>();
    auto dicomSeries2 = std::make_shared<data::DicomSeries>();
    ...
    auto dicomSeries3 = std::make_shared<data::DicomSeries>();
