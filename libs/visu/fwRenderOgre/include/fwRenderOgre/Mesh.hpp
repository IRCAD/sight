...
public:
    ...
    FWRENDEROGRE_API void updateMesh(const data::Mesh::sptr& _mesh, bool _pointsOnly = false);
    FWRENDEROGRE_API void updateMesh(const data::PointList::csptr& _pointList);
    FWRENDEROGRE_API std::pair<bool, std::vector<R2VBRenderable*> > updateR2VB(const data::Mesh::sptr& _mesh,
                                                                               ::Ogre::SceneManager& _sceneMgr,
                                                                               const std::string& _materialName,
                                                                               bool _hasTexture);

    /// Updates the vertices position
    FWRENDEROGRE_API void updateVertices(const data::Mesh::csptr& _mesh);
    /// Updates the vertices position
    FWRENDEROGRE_API void updateVertices(const data::PointList::csptr& mesh);
    /// Updates the vertices colors.
    FWRENDEROGRE_API void updateColors(const data::Mesh::csptr& _mesh);
    /// Updates the vertices texture coordinates.
    FWRENDEROGRE_API void updateTexCoords(const data::Mesh::csptr& _mesh);
    ...
    FWRENDEROGRE_API bool hasColorLayerChanged(const data::Mesh::csptr& _mesh);
...
private:
    ...
    std::map< data::Mesh::CellType, ::fwRenderOgre::R2VBRenderable*> m_r2vbObject;
