...
static void testDiffEquality(const ImageDiff& diff1, const ImageDiff& diff2)
{
    ...
    {
        data::tools::ImageDiff::ElementType diff1Elt = diff1.getElement(i);
        data::tools::ImageDiff::ElementType diff2Elt = diff2.getElement(i);
...
void ImageDiffTest::storeDiffsTest()
{
    ...
    data::tools::ImageDiff diff(sizeof(OLDVALUE));
    ...
    for(int i = 0; i < 8; ++i)
    {
        data::tools::ImageDiff::ElementType elt = diff.getElement(i);
    ...
    data::tools::ImageDiff diff2(sizeof(OLDVALUE));
...
void ImageDiffTest::undoRedoTest()
{
    ...
    {
        CPPUNIT_ASSERT_EQUAL_MESSAGE("it: " + std::to_string(it), (int)std::uint8_t(0),
