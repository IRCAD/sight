...
/**
 * @brief Test default_dicom_filter class
 */
class default_dicom_filter_custom_test : public CPPUNIT_NS::TestFixture
{
CPPUNIT_TEST_SUITE(default_dicom_filter_custom_test);
