 ...
 */
class FILTER_DICOM_CLASS_API temporal_position_splitter : public sight::filter::dicom::splitter::tag_value_splitter
{
public:

    SIGHT_DECLARE_CLASS(
        temporal_position_splitter,
        base,
        sight::filter::dicom::factory::make<temporal_position_splitter>
    );

    /// Constructor
    FILTER_DICOM_API temporal_position_splitter();

    /// Destructor
    FILTER_DICOM_API ~temporal_position_splitter() override;
