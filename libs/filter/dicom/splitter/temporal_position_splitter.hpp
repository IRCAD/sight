 ...
 */
class SIGHT_FILTER_DICOM_CLASS_API temporal_position_splitter : public sight::filter::dicom::splitter::
                                                                tag_value_splitter
{
public:
    ...
    /// Constructor
    SIGHT_FILTER_DICOM_API temporal_position_splitter();

    /// Destructor
    SIGHT_FILTER_DICOM_API ~temporal_position_splitter() override;
