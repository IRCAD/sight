 ...
 */
class FILTER_DICOM_CLASS_API image_dimensions_splitter : public base
{
public:
    ...
    /// Constructor
    FILTER_DICOM_API image_dimensions_splitter() = default;

    /// Destructor
    FILTER_DICOM_API ~image_dimensions_splitter() override = default;
