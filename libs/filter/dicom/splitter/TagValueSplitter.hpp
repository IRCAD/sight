 ...
 */
class FILTER_DICOM_CLASS_API TagValueSplitter : public base
{
public:

    SIGHT_DECLARE_CLASS(TagValueSplitter, base, sight::filter::dicom::factory::make<TagValueSplitter>);

    /// Constructor
    FILTER_DICOM_API TagValueSplitter();

    /// Destructor
    FILTER_DICOM_API ~TagValueSplitter() override;
