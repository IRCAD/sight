 ...
 */
class FILTER_DICOM_CLASS_API image_type_splitter : public sight::filter::dicom::splitter::tag_value_splitter
{
public:
    ...
    /// Constructor
    FILTER_DICOM_API image_type_splitter();

    /// Destructor
    FILTER_DICOM_API ~image_type_splitter() override;
