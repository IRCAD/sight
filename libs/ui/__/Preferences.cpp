...
void Preferences::set_password_policy(const core::crypto::password_keeper::password_policy policy)
{
    std::unique_lock guard(s_preferences_mutex);
...
void Preferences::set_encryption_policy(const core::crypto::password_keeper::encryption_policy policy)
{
    std::unique_lock guard(s_preferences_mutex);
