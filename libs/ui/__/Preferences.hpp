...
class UI_CLASS_API PreferencesDisabled : public core::exception
{
public:
...
class UI_CLASS_API BadPassword : public PreferencesDisabled
{
public:
...
public:
    ...
    static UI_API void erase(const std::string& key);
    ...
    UI_API static void set_enabled(bool enable);

    /// Enable / disable loading/saving from the filesystem.
    UI_API static void ignoreFilesystem(bool ignore);

    /// Set a password and enable encryption
    UI_API static void set_password(const core::crypto::secure_string& password);

    /// Set the password policy
    /// @param policy @see sight::core::crypto::password_keeper::password_policy
    UI_API static void set_password_policy(core::crypto::password_keeper::password_policy policy);

    /// Set the encryption policy
    /// @param policy @see sight::core::crypto::password_keeper::encryption_policy
    UI_API static void set_encryption_policy(core::crypto::password_keeper::encryption_policy policy);

    /// If true, the application will be terminated in case of password error
    UI_API static void exit_on_password_error(bool exit);
    ...
    UI_API static void set_password_dialog_strings(const PasswordDialogStrings& strings);
    /// @}
