 ...
 *
 */
class UI_BASE_CLASS_API ViewRegistrar : public ui::base::GuiBaseObject
{

public:

    fwCoreClassMacro(ViewRegistrar, ui::base::GuiBaseObject)
    ...
    /// Constructor.
    UI_BASE_API ViewRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    UI_BASE_API virtual ~ViewRegistrar();
     ...
     * @code{.xml}
        <service uid="subView1" type="::sight::modules::ui::base::SView" autoConnect="no" >
            <gui>
