 ...
 */
class UI_BASE_CLASS_API ToolBarRegistrar : public ui::base::GuiBaseObject
{

public:

    fwCoreClassMacro(ToolBarRegistrar, ui::base::GuiBaseObject)
    ...
    /// Constructor.
    UI_BASE_API ToolBarRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    UI_BASE_API virtual ~ToolBarRegistrar();
     ...
     * impl="::sight::modules::ui::base::SToolBar"
     * autoConnect="no" >
               <gui>
                   <layout>
     ...
     * @see ui::base::registrar::MenuRegistrar for more information on interaction between menubar and toolbar.
     *
