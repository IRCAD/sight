 ...
 */
class UI_BASE_CLASS_API ActionRegistrar : public ui::base::GuiBaseObject
{

public:

    fwCoreClassMacro(ActionRegistrar, ui::base::GuiBaseObject)
    ...
    /// Constructor.
    UI_BASE_API ActionRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    UI_BASE_API virtual ~ActionRegistrar();
