...
ui::base::container::fwToolBar::sptr ToolBarRegistrar::getParent()
{
...
ui::base::container::fwMenuItem::sptr ToolBarRegistrar::getFwMenuItem(std::string actionSid,
...
void ToolBarRegistrar::manage(std::vector< ui::base::container::fwMenuItem::sptr > menuItems )
{
...
void ToolBarRegistrar::manage(std::vector< ui::base::container::fwMenu::sptr > menus )
{
...
void ToolBarRegistrar::manage(std::vector< ui::base::container::fwContainer::sptr > containers )
{
