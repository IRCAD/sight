...
public:
     ...
     */
    GUITEST_API static void select(tester& _tester, const selector& _color_param, const QColor& _color);
     ...
     */
    GUITEST_API static void color_equals(tester& _tester, const selector& _color_param, const QColor& _color);
};
