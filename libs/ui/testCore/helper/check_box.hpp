...
public:
     ...
     */
    GUITEST_API static void toggle(tester& _tester, const selector& _check_box);
     ...
     */
    GUITEST_API static void should_be_checked(tester& _tester, const selector& _check_box);
     ...
     * @param checkBox How to get the check box to verify
     */
    GUITEST_API static void should_not_be_checked(tester& _tester, const selector& _check_box);
};
