...
public:
     ...
     * @{
     */
    GUITEST_API static void move(tester& _tester, const selector& _slider, position _pos);
    GUITEST_API static void move(tester& _tester, const selector& _slider, position _pos, int _times);
    /// @}
     ...
     */
    GUITEST_API static void set(tester& _tester, const selector& _slider, int _value);
};
