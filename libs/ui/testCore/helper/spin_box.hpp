...
public:
     ...
     */
    GUITEST_API static void increment(tester& _tester, const selector& _spin_box, int _times = 1);
     ...
     * @note This method assumes that the spin box uses a style where the buttons are at the left and right.
     */
    GUITEST_API static void decrement(tester& _tester, const selector& _spin_box, int _times = 1);
     ...
     */
    GUITEST_API static void value_equals(tester& _tester, const selector& _spin_box, const std::string& _expected);
     ...
     */
    GUITEST_API static void value_equals(tester& _tester, const selector& _spin_box, int _expected);
};
