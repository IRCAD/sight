...
public:
     ...
     */
    GUITEST_API static void select(tester& _tester, const selector& _combo_box, const std::string& _text);
     ...
     */
    GUITEST_API static void value_equals(tester& _tester, const selector& _combo_box, const std::string& _expected);
};
