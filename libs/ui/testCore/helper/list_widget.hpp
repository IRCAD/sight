...
public:
     ...
     */
    GUITEST_API static void count_equals(tester& _tester, const selector& _list, int _count);
     ...
     */
    GUITEST_API static void set_current_row(tester& _tester, const selector& _list, int _index);
     ...
     */
    GUITEST_API static void set_current_text(tester& _tester, const selector& _list, const std::string& _text);
};
