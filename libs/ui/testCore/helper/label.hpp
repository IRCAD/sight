...
public:
     ...
     */
    GUITEST_API static void contain(tester& _tester, const selector& _label, const std::string& _expected);
     ...
     */
    GUITEST_API static void exactly_match(tester& _tester, const selector& _label, const std::string& _expected);
     ...
     */
    GUITEST_API static std::string get(tester& _tester, const selector& _label_name);
};
