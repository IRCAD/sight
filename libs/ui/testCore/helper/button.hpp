...
public:
     ...
     */
    GUITEST_API static void push(tester& _tester, const selector& _button);
     ...
     */
    GUITEST_API static void push_menu_bar_item(tester& _tester, const selector& _button);
     ...
     */
    GUITEST_API static void wait_for_clickability(
        tester& _tester,
