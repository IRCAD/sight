...
public:
    ...
    GUITEST_API test_event(std::function<void()> _f);
...
public:
    ...
    class GUITEST_CLASS_API backtrace_lock
    {
    public:

        GUITEST_API backtrace_lock(tester& _tester);
        GUITEST_API ~backtrace_lock();
    ...
    GUITEST_API void do_something(std::function<void(QObject*)> _f);
    /// @}
    ...
    GUITEST_API void do_something_asynchronously(std::function<void(QObject*)> _f);
    /// @}
     ...
     */
    GUITEST_API void take_screenshot(const std::filesystem::path& _path);
     ...
     */
    GUITEST_API void should_be_hidden(
        const std::string& _component_description,
     ...
     */
    GUITEST_API void should_be_present(
        const std::string& _component_description,
        std::function<QWidget* ()> _graphic_component,
        std::function<bool(QWidget*)> _condition = always_true,
        int _timeout                             = DEFAULT_TIMEOUT
     ...
     */
    GUITEST_API QWidget* get_main_window();
     ...
     */
    [[nodiscard]] GUITEST_API std::string get_failure_message() const;
    ...
    [[nodiscard]] GUITEST_API backtrace_lock add_in_backtrace(const std::string& _description);
     ...
     */
    [[nodiscard]] GUITEST_API std::string get_description() const;
     ...
     */
    GUITEST_API static QWidget* get_widget_from_action(QAction* _action);
     ...
     * @{
     */
    GUITEST_API static void mouse_move(
        QWidget* _component,
        QPoint _pos                      = QPoint(),
        int _delay                       = -1,
     ...
     */
    GUITEST_API static double compare_images_pixel_perfect(QImage _a, QImage _b, bool _strict = false);
     ...
     * @returns a real between 0 (totally different images) and 1 (identical images)
     */
    GUITEST_API static double compare_images_mse(QImage _a, QImage _b, bool _strict = false);
     ...
     * @returns a real between 0 (totally different images) and 1 (identical images)
     */
    GUITEST_API static double compare_images_cosine(QImage _a, QImage _b, bool _strict = false);
     ...
     * @returns a real between 0 (totally different images) and 1 (identical images)
     */
    GUITEST_API static double compare_images_histogram(const QImage& _a, const QImage& _b);
     ...
     * @returns a real between 0 (totally different images) and 1 (identical images)
     */
    GUITEST_API static double compare_images_correlation(QImage _a, QImage _b, bool _strict = false);
     ...
     * @returns a real between 0 (totally different images) and 1 (identical images)
     */
    GUITEST_API static double compare_images_voodoo(const QImage& _a, const QImage& _b);
     ...
     * @{
     */
    GUITEST_API static QPoint center_of(const QWidget* _widget);
    GUITEST_API static QPoint left_of(const QWidget* _widget);
    GUITEST_API static QPoint right_of(const QWidget* _widget);
    GUITEST_API static QPoint top_of(const QWidget* _widget);
    GUITEST_API static QPoint bottom_of(const QWidget* _widget);
    /// @}
     ...
     */
    GUITEST_API static std::filesystem::path get_image_output_path();
...
private:
    ...
    GUITEST_API static bool wait_for_asynchronously(std::function<bool()> _predicate, int _timeout = DEFAULT_TIMEOUT);
