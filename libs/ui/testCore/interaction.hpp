...
class GUITEST_CLASS_API mouse_click : public interaction
{
public:

    GUITEST_API mouse_click(
...
class GUITEST_CLASS_API mouse_double_click : public interaction
{
public:

    GUITEST_API mouse_double_click(
        Qt::MouseButton _button          = Qt::MouseButton::LeftButton,
        Qt::KeyboardModifiers _modifiers = Qt::NoModifier,
        const QPoint& _pos               = QPoint()
    );
...
class GUITEST_CLASS_API mouse_drag : public interaction
{
public:

    GUITEST_API mouse_drag(
        const QPoint& _from,
        const QPoint& _to,
        Qt::MouseButton _button          = Qt::MouseButton::LeftButton,
        Qt::KeyboardModifiers _modifiers = Qt::NoModifier
...
class GUITEST_CLASS_API mouse_wheel : public interaction
{
public:
...
class GUITEST_CLASS_API keyboard_sequence : public interaction
{
public:

    GUITEST_API keyboard_sequence(std::string _text, Qt::KeyboardModifiers _modifiers = Qt::NoModifier);
...
class GUITEST_CLASS_API keyboard_click : public interaction
{
public:

    GUITEST_API keyboard_click(Qt::Key _key, Qt::KeyboardModifiers _modifiers = Qt::NoModifier);
...
class GUITEST_CLASS_API pinch_gesture : public interaction
{
public:
