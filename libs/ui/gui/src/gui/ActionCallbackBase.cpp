...
const ActionCallbackBase::RegistryKeyType ActionCallbackBase::REGISTRY_KEY = "::gui::ActionCallback";
...
void ActionCallbackBase::check(bool checked)
{
    ...
    services::IService::sptr service = services::get( m_sid );
    SLM_ASSERT("Service "<<m_sid<<" not instanced.", service);
    gui::IActionSrv::sptr action = gui::IActionSrv::dynamicCast(service);
