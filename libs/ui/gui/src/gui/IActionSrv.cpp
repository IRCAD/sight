...
{
    m_registrar = gui::registrar::ActionRegistrar::New(this->getID());
...
bool IActionSrv::confirmAction()
{
    ...
    if (m_confirmAction)
    {
        ...
        {
            dialog.setDefaultButton( gui::dialog::IMessageDialog::YES );
        }
        else if(m_defaultButton == "no")
        {
            dialog.setDefaultButton( gui::dialog::IMessageDialog::NO );
        }
        ...
        dialog.addButton( gui::dialog::IMessageDialog::YES_NO );
        gui::dialog::IMessageDialog::Buttons button = dialog.show();

        actionIsConfirmed = (button == gui::dialog::IMessageDialog::YES);
    }
