...
const std::string ISlideViewBuilder::REGISTRY_KEY = "::gui::SlideViewBuilder";
...
void ISlideViewBuilder::initialize(core::runtime::ConfigurationElement::sptr _config)
{
    ...
    {
        FW_DEPRECATED_MSG("::gui::builder::ISlideViewBuilder deprecated attribute 'size'", "21.0");
        size = std::stoi(_config->getExistingAttributeValue("size"));
    }

    if(_config->hasAttribute("align"))
    {
        FW_DEPRECATED_MSG("::gui::builder::ISlideViewBuilder deprecated attribute 'align'", "21.0");
...
gui::container::fwContainer::sptr ISlideViewBuilder::getContainer() const
{
    return m_container;
}
