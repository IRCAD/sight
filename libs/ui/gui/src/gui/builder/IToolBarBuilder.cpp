...
/**
 * @file gui/builder/IToolBarBuilder.cpp
...
const IToolBarBuilder::RegistryKeyType IToolBarBuilder::REGISTRY_KEY = "::gui::ToolBarBuilder";
...
gui::container::fwToolBar::sptr IToolBarBuilder::getToolBar()
{
