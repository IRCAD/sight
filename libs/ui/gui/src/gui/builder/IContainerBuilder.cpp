...
/**
 * @file gui/builder/IContainerBuilder.cpp
...
const IContainerBuilder::RegistryKeyType IContainerBuilder::REGISTRY_KEY = "::gui::ContainerBuilder";
...
gui::container::fwContainer::sptr IContainerBuilder::getContainer()
{
