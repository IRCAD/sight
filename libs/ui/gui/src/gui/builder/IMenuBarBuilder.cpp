...
/**
 * @file gui/builder/IMenuBarBuilder.cpp
...
const IMenuBarBuilder::RegistryKeyType IMenuBarBuilder::REGISTRY_KEY = "::gui::MenuBarBuilder";
...
gui::container::fwMenuBar::sptr IMenuBarBuilder::getMenuBar()
{
