...
{
    gui::dialog::LoggerDialog dialog(title, message, logger);
    return dialog.show();
}
...
{
    gui::GuiBaseObject::sptr guiObj = gui::factory::New(ILoggerDialog::REGISTRY_KEY);
    m_implementation = gui::dialog::ILoggerDialog::dynamicCast(guiObj);
}
