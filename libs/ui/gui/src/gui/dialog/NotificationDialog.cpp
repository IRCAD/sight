...
{
    gui::dialog::NotificationDialog notif( _message, _type, _pos);
    notif.show();
}
...
void NotificationDialog::showNotificationDialog( const std::string& _message,
                                                 INotificationDialog::Type _type, INotificationDialog::Position _pos)
{
    gui::dialog::NotificationDialog::show(_message, _type, _pos);
}
...
NotificationDialog::NotificationDialog()
{
    services::registry::ActiveWorkers::getDefaultWorker()->postTask<void>( std::function<void()>([&]
            {
                gui::GuiBaseObject::sptr guiObj = gui::factory::New(INotificationDialog::REGISTRY_KEY);
                m_implementation = gui::dialog::INotificationDialog::dynamicCast(guiObj);
            })).wait();
}
