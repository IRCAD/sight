...
LocationDialog::LocationDialog()
{
    ...
    services::registry::ActiveWorkers::getDefaultWorker()->postTask< void >(std::function< void() >(
                                                                                [&]
            {
                gui::GuiBaseObject::sptr guiObj = gui::factory::New(ILocationDialog::REGISTRY_KEY);
                m_implementation = gui::dialog::ILocationDialog::dynamicCast(guiObj);
            })
                                                                            ).wait();
}
...
ILocationDialog& LocationDialog::setOption( gui::dialog::ILocationDialog::Options option)
{
