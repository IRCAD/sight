...
const IFrameLayoutManager::RegistryKeyType IFrameLayoutManager::REGISTRY_KEY = "::gui::FrameLayoutManager";
...
{
    CloseCallback fct = std::bind( &gui::layoutManager::IFrameLayoutManager::defaultCloseCallback, this);
