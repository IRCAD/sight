...
/**
 * @file gui/layoutManager/IMenuBarLayoutManager.cpp
...
const IMenuBarLayoutManager::RegistryKeyType IMenuBarLayoutManager::REGISTRY_KEY = "::gui::MenuBarLayoutManager";
...
std::vector< gui::container::fwMenu::sptr > IMenuBarLayoutManager::getMenus()
{
    return this->m_menus;
}
