...
const IMenuLayoutManager::RegistryKeyType IMenuLayoutManager::REGISTRY_KEY = "::gui::MenuLayoutManager";
...
std::vector< gui::container::fwMenuItem::sptr > IMenuLayoutManager::getMenuItems()
{
...
std::vector< gui::container::fwMenu::sptr > IMenuLayoutManager::getMenus()
{
    return this->m_menus;
}
