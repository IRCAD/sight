...
const IToolBarLayoutManager::RegistryKeyType IToolBarLayoutManager::REGISTRY_KEY = "::gui::ToolBarLayoutManager";
...
{
    for( gui::container::fwMenuItem::sptr menuItem :  m_menuItems)
    {
        menuItem->destroyContainer();
    }
    m_menuItems.clear();
    for( gui::container::fwMenu::sptr menu :  m_menus)
    {
        menu->destroyContainer();
    }
    m_menus.clear();
    for( gui::container::fwContainer::sptr container :  m_containers)
    {
...
std::vector< gui::container::fwMenuItem::sptr > IToolBarLayoutManager::getMenuItems()
{
...
std::vector< gui::container::fwMenu::sptr > IToolBarLayoutManager::getMenus()
{
    return this->m_menus;
}
...
std::vector< gui::container::fwContainer::sptr > IToolBarLayoutManager::getContainers()
{
