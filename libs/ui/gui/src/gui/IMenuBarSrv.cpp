...
void IMenuBarSrv::initialize()
{
    ...
    m_registrar = gui::registrar::MenuBarRegistrar::New(this->getID());
...
{
    gui::container::fwMenuBar::sptr menuBar = m_registrar->getParent();
...
{
    gui::container::fwMenu::sptr menu = m_registrar->getFwMenu(menuSrvSID, m_layoutManager->getMenus());
...
void IMenuBarSrv::initializeLayoutManager(ConfigurationType layoutConfig)
{
    ...
    gui::GuiBaseObject::sptr guiObj = gui::factory::New(
        gui::layoutManager::IMenuBarLayoutManager::REGISTRY_KEY);
    m_layoutManager = gui::layoutManager::IMenuBarLayoutManager::dynamicCast(guiObj);
    SLM_ASSERT("ClassFactoryRegistry failed for class "<< gui::layoutManager::IMenuBarLayoutManager::REGISTRY_KEY,
               m_layoutManager);
