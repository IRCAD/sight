...
#include "gui/layoutManager/IViewLayoutManager.hpp"
...
void IGuiContainerSrv::create()
{
    ...
    gui::container::fwContainer::sptr parent = m_viewRegistrar->getParent();
    ...
    services::registry::ActiveWorkers::getDefaultWorker()->postTask< void >([this, &parent]
        {
            ...
            gui::GuiBaseObject::sptr guiObj =
                gui::factory::New(gui::builder::IContainerBuilder::REGISTRY_KEY);
            m_containerBuilder = gui::builder::IContainerBuilder::dynamicCast(guiObj);

            SLM_ASSERT("Cannot create main container: factory failed for '"
                       + gui::builder::IContainerBuilder::REGISTRY_KEY + "'",
                       m_containerBuilder);
            m_containerBuilder->createContainer(parent);

            gui::container::fwContainer::sptr container = m_containerBuilder->getContainer();
            ...
            if ( m_viewLayoutManagerIsCreated )
            {
                ...
                std::vector< gui::container::fwContainer::sptr > views = m_viewLayoutManager->getSubViews();
...
void IGuiContainerSrv::initializeLayoutManager(ConfigurationType layoutConfig)
{
    ...
    gui::GuiBaseObject::sptr guiObj = gui::factory::New(layoutManagerClassName);
    m_viewLayoutManager = gui::layoutManager::IViewLayoutManager::dynamicCast(guiObj);
...
void IGuiContainerSrv::initializeSlideViewBuilder(ConfigurationType slideViewConfig)
{
    ...
    gui::GuiBaseObject::sptr guiObj = gui::factory::New(
        gui::builder::ISlideViewBuilder::REGISTRY_KEY);
    gui::builder::ISlideViewBuilder::sptr slideViewBuildfer = gui::builder::ISlideViewBuilder::dynamicCast(
        guiObj);
    SLM_ASSERT("ClassFactoryRegistry failed for class "+ gui::builder::ISlideViewBuilder::REGISTRY_KEY,
               slideViewBuildfer);
...
gui::container::fwContainer::sptr IGuiContainerSrv::getContainer()
{
...
{
    gui::container::fwContainer::sptr container = m_viewRegistrar->getParent();
