...
gui::container::fwMenu::sptr MenuRegistrar::getParent()
{
    return gui::GuiRegistry::getSIDMenu(m_sid);
}

//-----------------------------------------------------------------------------

gui::container::fwMenuItem::sptr MenuRegistrar::getFwMenuItem(std::string actionSid,
...
void MenuRegistrar::manage(std::vector< gui::container::fwMenuItem::sptr > menuItems )
{
...
void MenuRegistrar::manage(std::vector< gui::container::fwMenu::sptr > menus )
{
