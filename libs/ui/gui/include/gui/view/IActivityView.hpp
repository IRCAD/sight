 ...
 */
class GUI_CLASS_API IActivityView : public gui::IGuiContainerSrv,
                                    public activities::IActivityLauncher
{
public:

    fwCoreClassMacro(IActivityView, gui::IGuiContainerSrv)

    GUI_API static const core::com::Slots::SlotKeyType s_LAUNCH_ACTIVITY_SLOT;
    GUI_API static const core::com::Slots::SlotKeyType s_LAUNCH_ACTIVITY_SERIES_SLOT;
...
protected:
    ...
    GUI_API virtual ~IActivityView() override;
     ...
     */
    GUI_API virtual void launchActivity(data::ActivitySeries::sptr activitySeries) = 0;

    /**
     * @brief Slot: Launch the given activity in a new tab.
     * @note The same activity series cannot be launch in two different tabs.
     */
    GUI_API virtual void launchActivitySeries(data::Series::sptr series);

    /**
     * @brief Check if the activity is valid by calling the activity validator.
     * @return Return true if the given activity is valid
     */
    GUI_API virtual bool validateActivity(data::ActivitySeries::sptr activitySeries) const;

    /// Create the activity series given in 'mainActivity' configuration
    GUI_API virtual data::ActivitySeries::sptr createMainActivity() const override;
