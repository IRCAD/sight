 ...
 */
class GUI_CLASS_API TabLayoutManagerBase : public IViewLayoutManager
{

public:

    fwCoreClassMacro(TabLayoutManagerBase, gui::layoutManager::IViewLayoutManager)
    ...
    GUI_API TabLayoutManagerBase();

    /// Destructor. Do nothing.
    GUI_API virtual ~TabLayoutManagerBase();
     ...
     * @code{.xml}
       <service uid="subView3" type="::modules::gui::view::SDefaultView" autoConnect="no" >
           <gui>
               <layout type="::gui::TabLayoutManager" >
       ...
       @endcode
     *  - \<layout type="::gui::TabLayoutManager" \> : define a tab layout.
