 ...
 */
class GUI_CLASS_API CardinalLayoutManagerBase : public IViewLayoutManager
{

public:

    fwCoreClassMacro(CardinalLayoutManagerBase, gui::layoutManager::IViewLayoutManager)
    ...
    GUI_API CardinalLayoutManagerBase();

    /// Destructor. Do nothing.
    GUI_API virtual ~CardinalLayoutManagerBase();
     ...
     * @code{.xml}
       <service uid="subView2" type="::modules::gui::view::SDefaultView" autoConnect="no" >
           <gui>
               <layout type="::gui::CardinalLayoutManager" >
       ...
       @endcode
     *  - \<layout type="::gui::CardinalLayoutManager" \> : define a cardinal layout.
    ...
    GUI_API virtual void initialize( ConfigurationType configuration) override;
