 ...
 */
class GUI_CLASS_API ToolboxLayoutManagerBase : public IViewLayoutManager
{

public:

    fwCoreClassMacro(ToolboxLayoutManagerBase, gui::layoutManager::IViewLayoutManager)
    ...
    GUI_API ToolboxLayoutManagerBase();

    /// Destructor. Do nothing.
    GUI_API virtual ~ToolboxLayoutManagerBase();
     ...
     * @code{.xml}
       <service uid="subView2" type="::modules::gui::view::SDefaultView" autoConnect="no" >
           <gui>
               <layout type="::gui::ToolboxLayoutManager">
       ...
       @endcode
     *  - \<layout type="::gui::ToolboxLayoutManager" \> : define a toolbox layout.
