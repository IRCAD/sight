 ...
 */
class GUI_CLASS_API IFrameLayoutManager : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(IFrameLayoutManager, gui::GuiBaseObject)
    ...
    GUI_API IFrameLayoutManager();

    /// Destructor. Do nothing.
    GUI_API virtual ~IFrameLayoutManager();
     ...
     */
    GUI_API virtual void createFrame() = 0;

    /**
     * @brief Destroy frame.
     */
    GUI_API virtual void destroyFrame() = 0;

    /// Return the frame container
    virtual gui::container::fwContainer::sptr getFrame()
    {
        return m_frame;
    }

    /// Return the first container into the frame
    virtual gui::container::fwContainer::sptr getContainer()
    {
        return m_container;
    }

    typedef std::function< void () > CloseCallback;
    GUI_API virtual void setCloseCallback(CloseCallback fct);
...
protected:
    ...
    gui::container::fwContainer::sptr m_frame;
