 ...
 */
class GUI_CLASS_API LineLayoutManagerBase : public IViewLayoutManager
{

public:

    fwCoreClassMacro(LineLayoutManagerBase, gui::layoutManager::IViewLayoutManager)
    ...
    GUI_API LineLayoutManagerBase();

    /// Destructor. Do nothing.
    GUI_API virtual ~LineLayoutManagerBase();
     ...
     * @code{.xml}
       ...
       @endcode
     *  - \<layout type="::gui::LineLayoutManager" \> : define a line layout.
