 ...
 */
class GUI_CLASS_API SelectorDialog : public ISelectorDialog
{

public:

    fwCoreClassMacro(SelectorDialog, gui::dialog::ISelectorDialog, new SelectorDialog)
     ...
     */
    GUI_API static std::string showSelectorDialog(const std::string& title, const std::string& message,
                                                  std::vector< std::string > _selections);

    /// will instanciate the concrete implementation
    GUI_API SelectorDialog();
     ...
     * @param _selections list of choices in the selector
     */
    GUI_API SelectorDialog(const std::string& title, const std::string& message,
                           std::vector< std::string > _selections);
    ...
    GUI_API virtual void setSelections(std::vector< std::string > _selections) override;

    /// Show the selector and return the selection.
    GUI_API std::string show() override;
...
protected:
    ...
    gui::dialog::ISelectorDialog::sptr m_implementation;
