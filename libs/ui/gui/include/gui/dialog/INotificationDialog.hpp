 ...
 */
class GUI_CLASS_API INotificationDialog : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(INotificationDialog, gui::GuiBaseObject)
    ...
    GUI_API INotificationDialog();

    /// Destructor. Does nothing.
    GUI_API virtual ~INotificationDialog() override;
     ...
     */
    GUI_API virtual void setMessage(const std::string& _msg);

    /**
     * @brief Sets the notification type.
     * @param _type notification type @see Type.
     */
    GUI_API virtual void setType( Type _type);

    /**
     * @brief Sets the position.
     * @param _position notification position @see Position.
     */
    GUI_API virtual void setPosition( Position _position);
     ...
     */
    GUI_API virtual void setSize(unsigned int _width, unsigned int _height);
     ...
     */
    GUI_API virtual void setIndex(unsigned int _index);
     ...
     */
    GUI_API virtual void setDuration(int _durationInMs);
...
protected:
    ...
    gui::container::fwContainer::csptr m_parentContainer {nullptr};
