 ...
 */
class GUI_CLASS_API IProgressDialog : public gui::GuiBaseObject,
                                      public ::boost::signals2::trackable
{

public:

    fwCoreClassMacro(IProgressDialog, gui::GuiBaseObject, progressDialogFactory)
    ...
    GUI_API virtual ~IProgressDialog();
    GUI_API IProgressDialog();
    ...
    GUI_API virtual void operator()(float percent, std::string msg) = 0;

    GUI_API virtual void setCancelCallback(CancelCallbackType callback);
...
protected:
    ...
    GUI_API virtual void cancelPressed();
...
protected:
    ...
    static sptr progressDialogFactory()
    {
        gui::GuiBaseObject::sptr guiObj = gui::factory::New(
            gui::dialog::IProgressDialog::REGISTRY_KEY);
        gui::dialog::IProgressDialog::sptr progressDlg = gui::dialog::IProgressDialog::dynamicCast(guiObj);
        return progressDlg;
    }
