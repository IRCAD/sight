 ...
 */
class GUI_CLASS_API LoggerDialog : public ILoggerDialog
{

public:

    fwCoreClassMacro(LoggerDialog, gui::dialog::ILoggerDialog, new LoggerDialog)
     ...
     */
    GUI_API static bool showLoggerDialog(const std::string& title, const std::string& message,
                                         const core::log::Logger::sptr& logger);

    /// Constructor that will instantiate the concrete implementation
    GUI_API LoggerDialog();

    /// Destructor
    GUI_API virtual ~LoggerDialog();
     ...
     * @param[in] logger Logger of the dialog
     */
    GUI_API LoggerDialog(const std::string& title, const std::string& message,
                         const core::log::Logger::sptr& logger);
     ...
     */
    GUI_API virtual void setMessage(const std::string& message) override;

    /**
     * @brief Set the dialog logger.
     * @param[in] logger Dialog logger
     */
    GUI_API virtual void setLogger(const core::log::Logger::sptr& logger) override;

    /**
     * @brief Show the dialog and return whether the user has selected the Ok or Cancel button
     */
    GUI_API virtual bool show() override;

protected:

    gui::dialog::ILoggerDialog::sptr m_implementation;
