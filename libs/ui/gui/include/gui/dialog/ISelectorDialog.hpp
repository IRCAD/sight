 ...
 */
class GUI_CLASS_API ISelectorDialog : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(ISelectorDialog, gui::GuiBaseObject)
     ...
     */
    GUI_API ISelectorDialog();

    /// Destructor. Do nothing.
    GUI_API virtual ~ISelectorDialog();

    /**
     * @brief The string list that can be chosen by the selector.
     */
    GUI_API virtual void setSelections(std::vector< std::string > _selections) = 0;
     ...
     */
    GUI_API virtual std::string show() = 0;
