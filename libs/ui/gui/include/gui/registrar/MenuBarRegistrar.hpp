 ...
 */
class GUI_CLASS_API MenuBarRegistrar : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(MenuBarRegistrar, gui::GuiBaseObject)
    ...
    /// Constructor.
    GUI_API MenuBarRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    GUI_API virtual ~MenuBarRegistrar();

    /// Return the parent container
    GUI_API virtual gui::container::fwMenuBar::sptr getParent();
     ...
     */
    GUI_API virtual gui::container::fwMenu::sptr getFwMenu(std::string menuSid,
