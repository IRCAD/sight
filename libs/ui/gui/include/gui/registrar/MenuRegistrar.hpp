 ...
 */
class GUI_CLASS_API MenuRegistrar : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(MenuRegistrar, gui::GuiBaseObject)
    ...
    /// Constructor.
    GUI_API MenuRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    GUI_API virtual ~MenuRegistrar();

    /// Return the parent container
    GUI_API virtual gui::container::fwMenu::sptr getParent();
     ...
     */
    GUI_API virtual void manage(std::vector< gui::container::fwMenuItem::sptr > menuItems );
     ...
     * @pre sub menu items must be instanced before.
     */
    GUI_API virtual void manage(std::vector< gui::container::fwMenu::sptr > menus );
