 ...
 */
class GUI_CLASS_API ToolBarRegistrar : public gui::GuiBaseObject
{

public:

    fwCoreClassMacro(ToolBarRegistrar, gui::GuiBaseObject)
    ...
    /// Constructor.
    GUI_API ToolBarRegistrar( const std::string& sid);

    /// Destructor. Do nothing
    GUI_API virtual ~ToolBarRegistrar();

    /// Return the parent container
    GUI_API virtual gui::container::fwToolBar::sptr getParent();
     ...
     */
    GUI_API virtual gui::container::fwMenuItem::sptr getFwMenuItem(std::string actionSid,
     ...
     * @code{.xml}
           <service uid="toolbar2" type="::gui::IToolBarSrv" impl="::modules::gui::aspect::SDefaultToolBar"
     * autoConnect="no" >
               <gui>
                   <layout>
     ...
     * @see gui::registrar::MenuRegistrar for more information on interaction between menubar and toolbar.
     *
     * @pre ToolBarRegistrar must be initialized before.
     * @pre sub toolBar items must be instanced before.
     */
    GUI_API virtual void manage(std::vector< gui::container::fwMenuItem::sptr > toolBarItems );
     ...
     * @pre sub toolBar items must be instanced before.
     */
    GUI_API virtual void manage(std::vector< gui::container::fwMenu::sptr > toolBarItems );
     ...
     * @pre sub toolBar items must be instanced before.
     */
    GUI_API virtual void manage(std::vector< gui::container::fwContainer::sptr > toolBarItems );
     ...
     */
    GUI_API virtual void onItemAction();
