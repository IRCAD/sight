...
void overlay::createLayout(ui::container::widget::sptr parent, const std::string& id)
{
    ...
    auto viewportContainer = ui::qt::container::widget::make();
    ...
    for(std::size_t i = 1 ; i < views().size() ; i++)
    {
        ...
        auto widgetContainer = ui::qt::container::widget::make();
