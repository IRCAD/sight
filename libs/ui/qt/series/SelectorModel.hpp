 ...
 */
class UI_QT_CLASS_API_QT SelectorModel : public QStandardItemModel
{
Q_OBJECT
...
public:
    ...
    UI_QT_API_QT SelectorModel(const std::string& displayColumns, QWidget* _parent = nullptr, bool allowRemove = false);

    /// Destroys the selector.
    UI_QT_API_QT ~SelectorModel() override = default;
    ...
    UI_QT_API_QT ItemType getItemType(const QModelIndex& _index);
