...
#include "guiQt/builder/ToolBarBuilder.hpp"
...
fwGuiRegisterMacro( ::sight::gui::builder::ToolBarBuilder, ::sight::gui::builder::IToolBarBuilder::REGISTRY_KEY);
...
ToolBarBuilder::ToolBarBuilder(gui::GuiBaseObject::Key key)
{
}
...
void ToolBarBuilder::createToolBar( gui::container::fwContainer::sptr parent )
{
    ...
    guiQt::container::QtToolBarContainer::sptr toolBarContainer = guiQt::container::QtToolBarContainer::New();
    if (window)
    {
...
void ToolBarBuilder::destroyToolBar()
{
    ...
    if (window)
    {
        guiQt::container::QtToolBarContainer::sptr qtToolBar =
            guiQt::container::QtToolBarContainer::dynamicCast(m_toolBar);
