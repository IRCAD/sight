...
#include "guiQt/util/FuncSlot.hpp"
...
protected:
    ...
    QPointer< guiQt::util::FuncSlot > m_qtFunc;
};
...
{
    QCoreApplication::sendPostedEvents(0, guiQt::WorkerQtTask::s_WORKER_QT_TASK_EVENT_TYPE);
}
...
{
    m_qtFunc = new guiQt::util::FuncSlot();
