...
#include "guiQt/Cursor.hpp"

#include <gui/registry/macros.hpp>

#include <QApplication>

fwGuiRegisterMacro( ::sight::guiQt::Cursor, ::sight::gui::ICursor::REGISTRY_KEY );

namespace sight::guiQt
{
//-----------------------------------------------------------------------------

Cursor::Cursor(gui::GuiBaseObject::Key key)
{
}
...
void Cursor::setCursor( gui::ICursor::CursorType cursor)
{
