...
SliceSelector::SliceSelector(QWidget* const parent ) noexcept :
    QWidget( parent )
{
    m_fctChangeIndexCallback = std::bind( &guiQt::SliceSelector::printIndex, this, std::placeholders:: _1);
    m_fctChangeTypeCallback  = std::bind( &guiQt::SliceSelector::printType, this, std::placeholders:: _1);
