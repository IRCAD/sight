...
#include "guiQt/layoutManager/ToolboxLayoutManager.hpp"
...
fwGuiRegisterMacro( ::sight::gui::ToolboxLayoutManager,
                    ::sight::gui::layoutManager::ToolboxLayoutManagerBase::REGISTRY_KEY );
...
ToolboxLayoutManager::ToolboxLayoutManager(gui::GuiBaseObject::Key key)
{
}
...
void ToolboxLayoutManager::createLayout( gui::container::fwContainer::sptr parent )
{

    guiQt::container::QtContainer::sptr parentContainer =
        guiQt::container::QtContainer::dynamicCast(parent);
    ...
    guiQt::widget::QfwToolBox* toolbox = new guiQt::widget::QfwToolBox(sv);
