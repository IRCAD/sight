...
#include "guiQt/layoutManager/CardinalLayoutManager.hpp"
...
fwGuiRegisterMacro( ::sight::gui::CardinalLayoutManager,
                    ::sight::gui::layoutManager::CardinalLayoutManagerBase::REGISTRY_KEY );
...
CardinalLayoutManager::CardinalLayoutManager(gui::GuiBaseObject::Key key)
{
}
...
void CardinalLayoutManager::createLayout( gui::container::fwContainer::sptr parent )
{
