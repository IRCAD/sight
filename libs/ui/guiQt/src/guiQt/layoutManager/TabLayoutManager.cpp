...
#include "guiQt/layoutManager/TabLayoutManager.hpp"
...
fwGuiRegisterMacro( ::sight::gui::TabLayoutManager, ::sight::gui::layoutManager::TabLayoutManagerBase::REGISTRY_KEY );
...
TabLayoutManager::TabLayoutManager(gui::GuiBaseObject::Key key)
{
}
...
void TabLayoutManager::createLayout( gui::container::fwContainer::sptr parent )
{
