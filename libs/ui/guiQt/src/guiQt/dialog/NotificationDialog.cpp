...
#include "guiQt/dialog/NotificationDialog.hpp"
...
fwGuiRegisterMacro( ::sight::guiQt::dialog::NotificationDialog, ::sight::gui::dialog::INotificationDialog::REGISTRY_KEY)
...
NotificationDialog::NotificationDialog(gui::GuiBaseObject::Key )
{
}
...
void NotificationDialog::show()
{
    ...
    guiQt::container::QtContainer::csptr parentContainer =
        guiQt::container::QtContainer::dynamicCast(m_parentContainer);
