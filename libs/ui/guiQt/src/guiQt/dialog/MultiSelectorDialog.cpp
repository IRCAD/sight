...
#include "guiQt/dialog/MultiSelectorDialog.hpp"
...
fwGuiRegisterMacro( ::sight::guiQt::dialog::MultiSelectorDialog,
                    ::sight::gui::dialog::IMultiSelectorDialog::REGISTRY_KEY );
