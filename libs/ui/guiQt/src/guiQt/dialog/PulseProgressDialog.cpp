...
#include "guiQt/dialog/PulseProgressDialog.hpp"
...
fwGuiRegisterMacro( ::sight::guiQt::dialog::PulseProgressDialog,
                    ::sight::gui::dialog::IPulseProgressDialog::REGISTRY_KEY );
