...
fwGuiRegisterMacro( ::sight::guiQt::dialog::ProgressDialog, ::sight::gui::dialog::IProgressDialog::REGISTRY_KEY );
    ...
    m_pmainWindow( NULL )
{
    ...
    gui::container::fwContainer::sptr progressWidget = gui::IFrameSrv::getProgressWidget();
    QWidget* activeWindow                            =
        guiQt::container::QtContainer::dynamicCast( progressWidget )->getQtContainer();
