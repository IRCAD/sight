...
guiQt::widget::Page* QfwToolBox::page(QWidget* widget) const
{
    if (!widget)
    {
        return 0;
...
guiQt::widget::Page* QfwToolBox::page(int index)
{
...
const guiQt::widget::Page* QfwToolBox::page(int index) const
{
    if (index >= 0 && index < pageList.size())
    {
