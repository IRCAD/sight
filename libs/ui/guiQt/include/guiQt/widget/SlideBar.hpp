...
class GUIQT_CLASS_API SlideBar : public QWidget
{
Q_OBJECT
...
public:
     ...
     */
    GUIQT_API SlideBar(QWidget* _parent,
                       HAlignment _hAlign,
                       VAlignment _vAlign,
                       int _width,
                       bool _percentWidth,
    ...
    GUIQT_API virtual ~SlideBar();

    /// Updates the widget position relative of the parent.
    GUIQT_API void updatePosition();

    /// Sets the widget visibility.
    GUIQT_API virtual void setVisible(bool _visible) override;
