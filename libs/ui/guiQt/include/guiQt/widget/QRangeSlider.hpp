...
class GUIQT_CLASS_API QRangeSlider : public QWidget
{
Q_OBJECT
...
public:
    ...
    GUIQT_API QRangeSlider(QWidget* parent = NULL);
    GUIQT_API virtual ~QRangeSlider();
...
public Q_SLOTS:
    GUIQT_API void setPos(double _min, double _max);
