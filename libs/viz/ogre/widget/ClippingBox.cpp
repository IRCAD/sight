...
ClippingBox::getFacePositions(viz::ogre::vr::IVolumeRenderer::CubeFace _faceName) const
{
...
Ogre::Vector3 ClippingBox::getFaceCenter(viz::ogre::vr::IVolumeRenderer::CubeFace _faceName) const
{
...
void ClippingBox::selectFace(viz::ogre::vr::IVolumeRenderer::CubeFace _faceName)
{
...
void ClippingBox::widgetPicked(::Ogre::MovableObject* _pickedWidget, int _screenX, int _screenY)
{
    ...
    {
        const viz::ogre::vr::IVolumeRenderer::CubeFace widgetFace = face.first;
