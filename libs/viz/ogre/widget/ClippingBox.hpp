...
namespace sight::viz::ogre::widget
{
...
public:
     ...
     */
    VIZ_OGRE_API ClippingBox(const std::string& id,
    ...
    /// Destructor.
    VIZ_OGRE_API virtual ~ClippingBox();
     ...
     */
    VIZ_OGRE_API void widgetPicked(::Ogre::MovableObject* _pickedWidget, int _screenX, int _screenY);

    /// Drops the currently selected widget.
    VIZ_OGRE_API void widgetReleased();
     ...
     */
    VIZ_OGRE_API bool moveClippingBox(int x, int y, int dx, int dy);
     ...
     */
    VIZ_OGRE_API bool scaleClippingBox(int x, int y, int dy);

    /// Returns whether the widgets are visible or hidden.
    VIZ_OGRE_API bool getVisibility() const;

    /// Hides or shows the widget.
    VIZ_OGRE_API void setVisibility(bool visibility);
    ...
    VIZ_OGRE_API void updateFromTransform(const ::Ogre::Matrix4& _clippingMx);
