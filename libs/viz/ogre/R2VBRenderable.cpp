...
viz::ogre::R2VBRenderable* viz::ogre::R2VBRenderable::New(const std::string& _name,
                                                          ...
                                                          const std::string& _mtlName)
{
    ...
    return viz::ogre::R2VBRenderable::New(_name, _sourceObject, _sceneManager, type, _mtlName);
}
...
viz::ogre::R2VBRenderable* viz::ogre::R2VBRenderable::New(const std::string& _name,
                                                          ...
                                                          const std::string& _mtlName)
{
    const auto& factoryName = viz::ogre::factory::R2VBRenderable::FACTORY_TYPE_NAME;
    auto instance           = static_cast< viz::ogre::R2VBRenderable*>
...
viz::ogre::R2VBRenderable::R2VBRenderable(const ::Ogre::String& _name) :
...
void viz::ogre::R2VBRenderable::setOutputSettings(size_t _vertexCount, bool _hasColor, bool _hasTexCoord,
                                                  bool _hasNormals)
{
