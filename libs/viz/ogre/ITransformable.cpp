...
void ITransformable::setTransformId(viz::ogre::SRender::OgreObjectIdType _id)
{
    m_transformId = _id;
}
...
viz::ogre::SRender::OgreObjectIdType ITransformable::getTransformId() const
{
                                                    ...
                                                    ::Ogre::SceneNode* const _parentNode)
{
    ...
    auto transformNode = viz::ogre::helper::Scene::getNodeById(_name, _parentNode);
