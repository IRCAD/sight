...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::viz::ogre::ut::UtilsTest );
...
void UtilsTest::convertOgreColorToFwColor()
{
    ...
    data::Color::sptr resultColor = viz::ogre::Utils::convertOgreColorToFwColor(::Ogre::ColourValue());
...
void UtilsTest::convertOgreMatrixToTM3D()
{
    ...
    // Convert from Sight to ogre and back to Sight.
    {
        ...
        const ::Ogre::Matrix4 ogreMat0 = viz::ogre::Utils::convertTM3DToOgreMx(mat0);
    ...
    // Convert from ogre to Sight and back to ogre.
    {
        ...
        const ::Ogre::Matrix4 ogreMat1Copy = viz::ogre::Utils::convertTM3DToOgreMx(mat1Copy);
