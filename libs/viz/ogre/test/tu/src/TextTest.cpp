...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::viz::ogre::ut::TextTest );
...
void TextTest::factoryTest()
{
    ...
    ::Ogre::MaterialManager::getSingleton().load("Text", viz::ogre::RESOURCE_GROUP);

    ::Ogre::SceneManager* sceneManager = m_ogreRoot->createSceneManager("DefaultSceneManager", "test");
    const auto& factoryName = viz::ogre::factory::Text::FACTORY_TYPE_NAME;
    ...
    viz::ogre::Text* textObj1 = viz::ogre::Text::New("testTest", sceneManager, overlayTextPanel,
