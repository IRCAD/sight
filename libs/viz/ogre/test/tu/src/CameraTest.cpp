...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::viz::ogre::ut::CameraTest );
...
void CameraTest::computeProjectionMatrix()
{
...

    {
        ...
        for(auto tu : permutation)
        {
            ...
            ::Ogre::Matrix4 actual =
                viz::ogre::helper::Camera::computeProjectionMatrix(    *camera,
...
{
    auto* const root         = viz::ogre::Utils::getOgreRoot();
    ...
    camera->setProjectionType(::Ogre::ProjectionType::PT_PERSPECTIVE);
    {
        ...
        const ::Ogre::Vector3 unprojectedPoint =
            viz::ogre::helper::Camera::convertScreenSpaceToViewSpace(*camera, point);
