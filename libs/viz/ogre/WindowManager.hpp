 ...
 */
class VIZ_OGRE_CLASS_API WindowManager : public core::BaseObject
{

public:

    fwCoreClassMacro(WindowManager, viz::ogre::WindowManager, new WindowManager)

    fwCoreAllowSharedFromThis()

    /// Registers an Ogre window.
    VIZ_OGRE_API void registerWindow(::Ogre::RenderWindow* _window);

    /// Unregisters an Ogre window.
    VIZ_OGRE_API void unregisterWindow(::Ogre::RenderWindow* _window);

    /**
     * @brief Gets the unique instance of this class.
     * @return the singleton instance.
     */
    VIZ_OGRE_API static viz::ogre::WindowManager::sptr get();

    /**
     * @brief Returns true if there is at least one window.
     * @@return true if at least one window is registered.
     */
    VIZ_OGRE_API bool hasWindow();
