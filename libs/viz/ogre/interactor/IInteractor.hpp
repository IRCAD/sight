 ...
 */
class VIZ_OGRE_CLASS_API IInteractor
{
...
public:
     ...
     */
    VIZ_OGRE_API IInteractor(SPTR(Layer)_layer = nullptr, bool _layerOrderDependant = true);

    /// Destroys the interactor.
    VIZ_OGRE_API virtual ~IInteractor();

    /// Sets the scene's length, that is the length of the scene's bounding cube.
    VIZ_OGRE_API virtual void setSceneLength(float _sceneLength);
     ...
     */
    VIZ_OGRE_API virtual void mouseMoveEvent(MouseButton _button, Modifier _mods, int _x, int _y, int _dx, int _dy);
     ...
     * @param _y height coordinate of the mouse.
     */
    VIZ_OGRE_API virtual void wheelEvent(Modifier _mods, int _angleDelta, int _x, int _y);
     ...
     * @param _y height coordinate of the mouse.
     */
    VIZ_OGRE_API virtual void buttonReleaseEvent(MouseButton _button, Modifier _mods, int _x, int _y);
     ...
     * @param _y height coordinate of the mouse.
     */
    VIZ_OGRE_API virtual void buttonPressEvent(MouseButton _button, Modifier _mods, int _x, int _y);
     ...
     * @param _y height coordinate of the mouse.
     */
    VIZ_OGRE_API virtual void buttonDoublePressEvent(MouseButton _button, Modifier _mods, int _x, int _y);
     ...
     */
    VIZ_OGRE_API virtual void keyPressEvent(int _key, Modifier _mods, int _mouseX, int _mouseY);
     ...
     * @param _y height coordinate of the mouse at the time of the event.
     */
    VIZ_OGRE_API virtual void keyReleaseEvent(int _key, Modifier _mods, int _mouseX, int _mouseY);
     ...
     */
    VIZ_OGRE_API static bool isInLayer(int _mouseX, int _mouseY, SPTR(Layer) _layer, bool _layerOrderDependant);
     ...
     */
    VIZ_OGRE_API virtual void resizeEvent(int _width, int _height);
