...
#include "viz/ogre/compositor/MaterialMgrListener.hpp"
#include "viz/ogre/factory/R2VBRenderable.hpp"
...
viz::ogre::factory::R2VBRenderable* Utils::s_R2VBRenderableFactory         = nullptr;
viz::ogre::factory::Text* Utils::s_textFactory                             = nullptr;
viz::ogre::vr::GridProxyGeometryFactory* Utils::s_gridProxyGeometryFactory = nullptr;
viz::ogre::compositor::MaterialMgrListener* Utils::s_oitMaterialListener   = nullptr;
...
::Ogre::Root* Utils::getOgreRoot()
{
    ...
    if(root == nullptr)
    {
        const auto& confPath = core::runtime::getLibraryResourceFilePath("viz_ogre-0.1/" PLUGIN_PATH);
        ...
        auto resourcePath = core::runtime::getLibraryResourceFilePath("viz_ogre-0.1/resources.cfg" );
        viz::ogre::Utils::addResourcesPath( resourcePath );

        loadResources();

        // Register factory for Text objects
        s_textFactory = OGRE_NEW viz::ogre::factory::Text();
        ::Ogre::Root::getSingleton().addMovableObjectFactory(s_textFactory);

        // Register factory for R2VB renderables objects
        s_R2VBRenderableFactory = OGRE_NEW viz::ogre::factory::R2VBRenderable();
        ::Ogre::Root::getSingleton().addMovableObjectFactory(s_R2VBRenderableFactory);

        // Register factory for GridProxyGeometry objects
        s_gridProxyGeometryFactory = OGRE_NEW viz::ogre::vr::GridProxyGeometryFactory();
        ...
        s_oitMaterialListener = new viz::ogre::compositor::MaterialMgrListener();
...
void Utils::destroyOgreRoot()
{
    ...
    ::Ogre::Root* root = viz::ogre::Utils::getOgreRoot();
                            ...
                            ::Ogre::TextureType _texType, bool _dynamic)
{
    ...
    if(imageIsValid)
    {
        ...
        ::Ogre::Image ogreImage = viz::ogre::Utils::convertToOgreImage(_image);
            ...
            _texture->getFormat() != pixelFormat )
        {
            ...
            viz::ogre::Utils::allocateTexture(_texture.get(), size[0], size[1], depth,
...
void Utils::convertImageForNegato( ::Ogre::Texture* _texture, const data::Image::sptr& _image )
{
    ...
    {
        viz::ogre::Utils::allocateTexture(_texture, _image->getSize2()[0], _image->getSize2()[1],
