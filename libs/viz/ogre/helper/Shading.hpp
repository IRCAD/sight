...
public:
     ...
     */
    VIZ_OGRE_API static bool isColorTechnique(const ::Ogre::Technique& _tech);

    /**
     * @brief Returns true if the given technique is used for a peel pass in a depth peeling.
     * @param[in] _tech Ogre technique
     */
    VIZ_OGRE_API static bool isPeelTechnique(const ::Ogre::Technique& _tech);

    /**
     * @brief Returns true if the given technique is used in a geometric pass (as opposed to a fullscreen pass).
     * @param[in] _tech Ogre technique
     */
    VIZ_OGRE_API static bool isGeometricTechnique(const ::Ogre::Technique& _tech);

    /**
     * @brief Returns true if the given technique is used in a depth-only pass.
     * @param[in] _tech Ogre technique
     */
    VIZ_OGRE_API static bool isDepthOnlyTechnique(const ::Ogre::Technique& _tech);
     ...
     */
    VIZ_OGRE_API static std::string getPermutation(data::Material::ShadingType _mode, bool _diffuseTexture,
                                                   bool _vertexColor);
    ...
    VIZ_OGRE_API static std::string getR2VBGeometryProgramName(data::Mesh::CellTypesEnum _primitiveType,
     ...
     * @param[in] _hasPrimitiveColor is primitive color enabled bound ?
     */
    VIZ_OGRE_API static std::string getR2VBGeometryProgramName(data::Mesh::CellType _primitiveType,
                                                               bool _diffuseTexture, bool _vertexColor,
                                                               bool _hasPrimitiveColor);
     ...
     */
    VIZ_OGRE_API static std::string setPermutationInProgramName(const std::string& _name,
     ...
     */
    VIZ_OGRE_API static std::string setTechniqueInProgramName(const std::string& _name, const std::string& _tech);
     ...
     */
    VIZ_OGRE_API static ShaderConstantsType findMaterialConstants(::Ogre::Material& _material);
     ...
     * @return vector of constants, each element is a tuple with the constant name, its definition and the shader type.
     */
    VIZ_OGRE_API static ShaderConstantsType findShaderConstants(::Ogre::GpuProgramParametersSharedPtr params,
     ...
     */
    VIZ_OGRE_API static SPTR(data::Object) createObjectFromShaderParameter(::Ogre::GpuConstantType _type,
     ...
     */
    VIZ_OGRE_API static ::Ogre::GpuProgramPtr createProgramFrom(const std::string& _name,
