...
public:
     ...
     */
    static VIZ_OGRE_API Ogre::Matrix4 computeFrustumShearTransform(const Ogre::Camera& _camera, float _angle);

    static VIZ_OGRE_API Ogre::Matrix4 computeProjectionMatrix(const data::Camera& _calibration,
     ...
     */
    static VIZ_OGRE_API ::Ogre::Vector2 convertFromWindowToViewportSpace(const ::Ogre::Camera& _camera,
     ...
     */
    static VIZ_OGRE_API ::Ogre::Vector3 convertScreenSpaceToViewSpace(const ::Ogre::Camera& _camera,
     ...
     */
    static VIZ_OGRE_API ::Ogre::Vector3 convertNDCToViewSpace(const ::Ogre::Camera& _camera,
