...
public:
     ...
     */
    VIZ_OGRE_API static void createCylinder(::Ogre::ManualObject* _object,
     ...
     */
    VIZ_OGRE_API static void createCone(::Ogre::ManualObject* _object,
                                        const std::string& _material,
                                        const ::Ogre::ColourValue& _color = ::Ogre::ColourValue(1.f, 1.f, 1.f),
                                        float _radius                     = 1.f,
                                        float _length                     = 100.f,
     ...
     */
    VIZ_OGRE_API static void createCube(::Ogre::ManualObject* _object,
                                        const std::string& _material,
                                        const ::Ogre::ColourValue& _color = ::Ogre::ColourValue(1.f, 1.f, 1.f),
                                        float _length                     = 100.f);
     ...
     */
    VIZ_OGRE_API static void createSphere(::Ogre::ManualObject* _object,
                                          const std::string& _material,
                                          const ::Ogre::ColourValue& _color = ::Ogre::ColourValue(1.f, 1.f, 1.f),
                                          float _radius                     = 100.f,
