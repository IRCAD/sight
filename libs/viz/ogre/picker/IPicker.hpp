...
class VIZ_OGRE_CLASS_API IPicker
{

public:

    /// Construct all members.
    VIZ_OGRE_API IPicker();

    /// Destruct all members.
    VIZ_OGRE_API virtual ~IPicker();
     ...
     */
    VIZ_OGRE_API bool executeRaySceneQuery(int _x, int _y, std::uint32_t _queryMask);

    /**
     * @brief Get the selected object if there is one.
     * @return The selected object.
     */
    VIZ_OGRE_API ::Ogre::MovableObject* getSelectedObject() const;

    /**
     * @brief Get the intersection position in the world space.
     * @return The intersection position.
     */
    VIZ_OGRE_API ::Ogre::Vector3 getIntersectionInWorldSpace() const;

    /**
     * @brief Get the intersection position in the view space.
     * @return The intersection position.
     */
    VIZ_OGRE_API ::Ogre::Vector2 getIntersectionInViewSpace() const;

    /**
     * @brief Get the intersection position in the screen space.
     * @return The intersection position.
     */
    VIZ_OGRE_API ::Ogre::Vector2 getIntersectionInPixel() const;

    /**
     * @brief Set the scene manager.
     * @param _sceneMgr The scene manager.
     */
    VIZ_OGRE_API void setSceneManager(::Ogre::SceneManager* _sceneMgr);

    /**
     * @brief Check if there is a scene manager.
     * @return True if a scene manager is setted.
     */
    VIZ_OGRE_API bool hasSceneManager();
