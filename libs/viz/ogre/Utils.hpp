 ...
 */
class VIZ_OGRE_CLASS_API Utils
{
public:
     ...
     */
    VIZ_OGRE_API static void addResourcesPath(const std::filesystem::path& path);

    /**
     * @brief getOgreRoot
     * @return OgreRoot, if it doesn't exist initialise Ogre Root and default Ogre behavior
     */
    VIZ_OGRE_API static ::Ogre::Root* getOgreRoot();

    /**
     * @brief destroy the OgreRoot
     */
    VIZ_OGRE_API static void destroyOgreRoot();
     ...
     * @return Ogre image
     */
    VIZ_OGRE_API static ::Ogre::Image convertToOgreImage( const data::Image::csptr imageFw);

    /**
     * @brief Convert an Ogre texture into a Sight image data
     */
    VIZ_OGRE_API static void convertFromOgreTexture( ::Ogre::TexturePtr _texture,
     ...
     */
    VIZ_OGRE_API static ::Ogre::PixelFormat getPixelFormatOgre( data::Image::csptr imageFw );
     ...
     */
    VIZ_OGRE_API static void setPixelFormatFromOgre( data::Image::sptr _image, ::Ogre::PixelFormat _format );
     ...
     * @param _dynamic
     */
    VIZ_OGRE_API static void loadOgreTexture(const data::Image::csptr& _image, ::Ogre::TexturePtr _texture,
     ...
     * @return
     */
    VIZ_OGRE_API static void convertImageForNegato(::Ogre::Texture* _texture, const data::Image::sptr& _image );
     ...
     * @return
     */
    VIZ_OGRE_API static void allocateTexture(::Ogre::Texture* _texture, size_t _width, size_t _height,
                                             size_t _depth, ::Ogre::PixelFormat _format,
                                             ::Ogre::TextureType _texType, bool _dynamic);

    VIZ_OGRE_API static ::Ogre::OverlaySystem* getOverlaySystem();
...
private:
    ...
    static viz::ogre::factory::R2VBRenderable* s_R2VBRenderableFactory;
    static viz::ogre::factory::Text* s_textFactory;
    static viz::ogre::vr::GridProxyGeometryFactory* s_gridProxyGeometryFactory;
    static viz::ogre::compositor::MaterialMgrListener* s_oitMaterialListener;
};
