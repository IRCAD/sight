 ...
 */
class VIZ_OGRE_CLASS_API Text : public ::Ogre::MovableObject
{
public:
     ...
     */
    static VIZ_OGRE_API Text* New(const std::string& _id, ::Ogre::SceneManager* _sm,
     ...
     * @return A new 'Text' instance.
     */
    [[deprecated("Text objects manage their own font now.")]] static VIZ_OGRE_API
    ...
    VIZ_OGRE_API Text(const std::string& _id);

    /// Destructor, destroys the overlay text element.
    VIZ_OGRE_API virtual ~Text();

    /// Displayed text.
    VIZ_OGRE_API void setText(const std::string& _text);

    /// Position in screen coordinates.
    VIZ_OGRE_API void setPosition(float _x, float _y);
    ...
    VIZ_OGRE_API void setCharHeight(float _height);

    /// Gets the text height relatively to that of the screen.
    VIZ_OGRE_API float getTextHeight() const;
    ...
    VIZ_OGRE_API void setTextColor(const ::Ogre::ColourValue& _color);
    ...
    VIZ_OGRE_API void setTextAlignment(const ::Ogre::TextAreaOverlayElement::Alignment _hAlignement,
                                       const ::Ogre::GuiVerticalAlignment _vAlignment = ::Ogre::GVA_TOP);

    /// Returns this MovableObject's type as a string.
    VIZ_OGRE_API virtual const ::Ogre::String& getMovableType() const override;

    /// MovableObject interface. Unused here, always returns an empty bounding box.
    VIZ_OGRE_API virtual const ::Ogre::AxisAlignedBox& getBoundingBox() const override;

    /// MovableObject interface. Unused here, always returns 0.
    VIZ_OGRE_API virtual ::Ogre::Real getBoundingRadius() const override;
     ...
     */
    VIZ_OGRE_API virtual void _updateRenderQueue(::Ogre::RenderQueue* _queue) override;

    /// MovableObject interface. Not used here.
    VIZ_OGRE_API virtual void visitRenderables(::Ogre::Renderable::Visitor* _visitor,
