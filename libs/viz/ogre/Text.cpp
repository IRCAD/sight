                ...
                const std::string& _fontSource, size_t _fontSize, float _fontResolution, ::Ogre::Camera* _cam)
{
    ...
    Text* instance          = static_cast< viz::ogre::Text* >(_sm->createMovableObject(_id, factoryName));
...
void Text::setFont(::Ogre::FontPtr _font)
{
    ...
    const ::Ogre::MaterialPtr& fontMtl = viz::ogre::helper::Font::getFontMtl(_font->getName());
