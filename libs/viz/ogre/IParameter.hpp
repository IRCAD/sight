 ...
 */
class VIZ_OGRE_CLASS_API IParameter : public sight::viz::ogre::IAdaptor
{

public:

    fwCoreClassMacro(IParameter, viz::ogre::IAdaptor)
    ...
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_BOOL_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_COLOR_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE2_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE3_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_INT_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_INT2_PARAMETER_SLOT;
    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SET_INT3_PARAMETER_SLOT;

    ///@}

    VIZ_OGRE_API static const std::string s_PARAMETER_INOUT;

    /// Constructor.
    VIZ_OGRE_API IParameter() noexcept;

    /// Destructor. Does nothing
    VIZ_OGRE_API virtual ~IParameter() noexcept;

    /// Set the shaderType by passing the value of the ShaderEnumType of this adaptor.
    VIZ_OGRE_API void setShaderType(::Ogre::GpuProgramType shaderType);

    /// Set the name of the parameter m_paramName.
    VIZ_OGRE_API void setParamName(const std::string& paramName);

    /// Get the name of the parameter m_paramName.
    VIZ_OGRE_API const std::string& getParamName() const;

    /// Get the name of the parameter m_paramName.
    VIZ_OGRE_API const std::string& getDefaultValue() const;
...
protected:
    ...
    VIZ_OGRE_API virtual void updating() override;

    /// Clear the mesh pointer.
    VIZ_OGRE_API virtual void stopping() override;

    /// Set the parameter for a given technique
    VIZ_OGRE_API virtual bool setParameter(::Ogre::Technique& technique);
