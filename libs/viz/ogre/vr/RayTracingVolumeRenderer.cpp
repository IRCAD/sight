...
#include "viz/ogre/compositor/listener/RayExitDepth.hpp"
...
void RayTracingVolumeRenderer::createRayTracingMaterial(const std::string& _sourceFile)
{
    ...
    // Create the material
    ::Ogre::MaterialPtr mat = mm.create(m_currentMtlName, viz::ogre::RESOURCE_GROUP);
...
void RayTracingVolumeRenderer::initEntryPoints()
{
    ...
    m_proxyGeometry = viz::ogre::vr::GridProxyGeometry::New(this->m_parentId + "_GridProxyGeometry",
