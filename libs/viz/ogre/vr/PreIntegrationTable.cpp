...
void PreIntegrationTable::imageUpdate(const data::Image::sptr& _img, const data::TransferFunction::sptr& _tf,
                                      float _samplingRate)
{
    FW_PROFILE("TF Init")
    {
        ::Ogre::PixelFormat pixelFormat = viz::ogre::Utils::getPixelFormatOgre(_img);
