...
void IllumAmbientOcclusionSAT::SATUpdate(::Ogre::TexturePtr _img, const viz::ogre::TransferFunction::sptr& _tf,
...
void IllumAmbientOcclusionSAT::updateTexture()
{
    ...
    textureManager.remove(m_parentId + BUFFER_NAME, viz::ogre::RESOURCE_GROUP);
