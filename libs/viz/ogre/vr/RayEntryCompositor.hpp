 ...
 */
class VIZ_OGRE_CLASS_API RayEntryCompositor
{
public:
    ...
    VIZ_OGRE_API RayEntryCompositor(const std::string& _compositorName, std::uint8_t _rqGroup,
                                    compositor::Core::StereoModeType _stereoMode,
                                    bool _enableMixedRendering = false);

    /// Destructor. Deletes the created compositor.
    VIZ_OGRE_API virtual ~RayEntryCompositor();
