 ...
 */
class VIZ_OGRE_CLASS_API GridProxyGeometry : public R2VBRenderable
{
public:

    static VIZ_OGRE_API GridProxyGeometry* New(const std::string& _name, ::Ogre::SceneManager* _sceneManager,
    ...
    VIZ_OGRE_API void set3DImageTexture(const ::Ogre::TexturePtr& _texture);
 ...
 */
class GridProxyGeometryFactory : public viz::ogre::factory::R2VBRenderable
{
public:

    /// Constructor, does nothing.
    VIZ_OGRE_API GridProxyGeometryFactory()
    {
    }

    /// Destructor, does nothing.
    VIZ_OGRE_API virtual ~GridProxyGeometryFactory() override
    {
    }
...
protected:
    ...
    {
        return new viz::ogre::vr::GridProxyGeometry(name);
    }
};
