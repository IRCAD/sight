                                                                      ...
                                                                      const ::Ogre::Renderable* /*_renderable*/)
{
    ...
    if(_schemeName.find("AutoStereo") != std::string::npos)
    {
        ...
        newTech = viz::ogre::helper::Technique::copyToMaterial(matchingTech, _schemeName, _originalMaterial);
        ...
        const auto pass = newTech->getPass(0);
        {
            ...
            viz::ogre::helper::Shading::createProgramFrom(vpNewName, vpSourceFileName, parameters,
        ...
        if( ::Ogre::StringUtil::startsWith( fpBaseName, "RTV_FP") )
        {
            ...
            viz::ogre::helper::Shading::createProgramFrom(fpNewName, fpSourceFileName, parameters,
