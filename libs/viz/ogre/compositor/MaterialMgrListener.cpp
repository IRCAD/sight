...
::Ogre::Technique* viz::ogre::compositor::MaterialMgrListener::handleSchemeNotFound(unsigned short /*_schemeIndex*/,
                                                                                    ...
                                                                                    /*_renderable*/)
{
    ...
    {
        newTech = viz::ogre::helper::Technique::copyToMaterial(depthTech, _schemeName, _originalMaterial);
    ...
    {
        newTech = viz::ogre::helper::Technique::copyToMaterial(defaultTech, _schemeName, _originalMaterial);
        ...
        for(const auto pass : passes)
        {
               ...
               pass->getName() != "EdgePass")
            {
                ...
                auto newName = viz::ogre::helper::Shading::setTechniqueInProgramName(vpName, algoName);
                pass->setVertexProgram(newName);
            }

            // replace fragment program and build it if needed
            auto fpName  = pass->getFragmentProgramName();
            auto newName = viz::ogre::helper::Shading::setTechniqueInProgramName(fpName, algoName + "/peel");
            ...
            _schemeName == "HybridTransparency/occlusionMap")
    {
        ...
        for(const auto pass : passes)
        {
            ...
            auto fpName  = pass->getFragmentProgramName();
            auto newName =
                viz::ogre::helper::Shading::setTechniqueInProgramName(fpName, algoName+ "/occlusionMap");
            this->ensureFPCreated(newName, algoName, algoPassName, fpName);
            pass->setFragmentProgram(newName);
            ...
            _schemeName == "HybridTransparency/weightBlend")
    {
        ...
        for(const auto pass : passes)
        {
            // replace fragment program and build it if needed
            auto fpName  = pass->getFragmentProgramName();
            auto newName = viz::ogre::helper::Shading::setTechniqueInProgramName(fpName, algoName+ "/weightBlend");
            this->ensureFPCreated(newName, algoName, algoPassName, fpName);
            pass->setFragmentProgram(newName);
            ...
            _schemeName == "HybridTransparency/transmittanceBlend")
    {
        ...
        for(const auto pass : passes)
        {
            // replace fragment program and build it if needed
            auto fpName  = pass->getFragmentProgramName();
            auto newName = viz::ogre::helper::Shading::setTechniqueInProgramName(fpName,
                                                           ...
                                                           const std::string& _baseName)
{
    ...
    viz::ogre::helper::Shading::GpuProgramParametersType parameters;
    ...
    return viz::ogre::helper::Shading::createProgramFrom(_name, sourceFileName, parameters,
