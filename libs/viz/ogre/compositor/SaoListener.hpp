...
class VIZ_OGRE_CLASS_API SaoListener : public ::Ogre::CompositorInstance::Listener
{

public:

    VIZ_OGRE_API SaoListener() = delete;

    VIZ_OGRE_API SaoListener(::Ogre::Viewport* vp) :
        m_viewport(vp)
    {
    }

    /// Method called before a render_target operation involving a material to set dynamically the material parameters.
    VIZ_OGRE_API void notifyMaterialRender(::Ogre::uint32 pass_id, ::Ogre::MaterialPtr& mat);
