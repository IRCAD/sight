...
public:
    ...
    VIZ_OGRE_API void setRenderService(SRender::sptr _service);

    /// @returns the render service using this adaptor
    VIZ_OGRE_API SRender::sptr getRenderService() const;

    /// @returns the layer where this adaptor is attached.
    VIZ_OGRE_API Layer::sptr getLayer() const;
     ...
     * @see setVisible(bool)
     */
    VIZ_OGRE_API void updateVisibility(bool _isVisible);

protected:

    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_UPDATE_VISIBILITY_SLOT;

    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_TOGGLE_VISIBILITY_SLOT;

    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_SHOW_SLOT;

    VIZ_OGRE_API static const core::com::Slots::SlotKeyType s_HIDE_SLOT;

    /// Initializes slots.
    VIZ_OGRE_API IAdaptor() noexcept;

    /// Destroys the adaptor.
    VIZ_OGRE_API ~IAdaptor() noexcept override;
     ...
     */
    VIZ_OGRE_API void info(std::ostream& _sstream) override;
