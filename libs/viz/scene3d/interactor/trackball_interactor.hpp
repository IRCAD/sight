 ...
 */
class SIGHT_VIZ_SCENE3D_CLASS_API trackball_interactor final : public sight::viz::scene3d::interactor::base
{
public:
    ...
    SIGHT_VIZ_SCENE3D_API void button_press_event(mouse_button _button, modifier /*_mods*/, int _x, int _y) final;

    /// Disables mouse movements.
    SIGHT_VIZ_SCENE3D_API void button_release_event(
        mouse_button _button,
        modifier /*_mods*/,
        int /*_x*/,
        int /*_y*/
     ...
     */
    SIGHT_VIZ_SCENE3D_API void wheel_event(modifier /*_mods*/, double _delta, int /*x*/, int /*y*/) final;
     ...
     */
    SIGHT_VIZ_SCENE3D_API void pinch_gesture_event(double _scale_factor, int _center_x, int _center_y) final;
     ...
     */
    SIGHT_VIZ_SCENE3D_API void pan_gesture_move_event(int _x, int _y, int _dx, int _dy) final;
     ...
     */
    SIGHT_VIZ_SCENE3D_API void key_press_event(int _key, modifier /*_mods*/, int _mouse_x, int _mouse_y) final;

    /**
     * @brief Recomputes the camera's aspect ratio when the render window is resized.
     */
    SIGHT_VIZ_SCENE3D_API void resize_event(int /*_width*/, int /*_height*/) final;

    /// Recomputes the mouse's scale and focus point from the updated scene length.
    SIGHT_VIZ_SCENE3D_API void set_scene_length(float _scene_length) final;
