...
void Mesh::generateCellNormals(data::Mesh::sptr mesh)
{
    ...
    if(numberOfCells > 0)
    {
        ...
        data::tools::thread::RegionThreader rt((numberOfCells >= 200000) ? 4 : 1);
...
void Mesh::generatePointNormals(data::Mesh::sptr mesh)
{
    ...
    if(nbOfPoints > 0)
    {
        ...
        data::tools::thread::RegionThreader rt((nbOfPoints >= 100000) ? 4 : 1);
...
void Mesh::shakeNormals(data::Array::sptr array)
{
       ...
       )
    {
        ...
        data::tools::thread::RegionThreader rt((nbOfNormals >= 150000) ? 4 : 1);
                      ...
                      data::TransformationMatrix3D::csptr t )
{
    ...
    const ::glm::dmat4x4 matrix = data::tools::TransformationMatrix3D::getMatrixFromTF3D(t);
...
bool Mesh::isClosed()
{
    ...
    data::Mesh::CellId* cellDataBegin =
        m_helperCellData->begin< data::Mesh::CellId >();
    data::Mesh::CellId* cellDataEnd          = cellDataBegin + cellDataSize;
    data::Mesh::CellId* cellDataOffsetsBegin =
        m_helperCellDataOffsets->begin< data::Mesh::CellId >();
    data::Mesh::CellId* cellDataOffsetsEnd = cellDataOffsetsBegin + nbOfCells;
    data::Mesh::CellTypes* cellTypesBegin  = m_helperCellTypes->begin< data::Mesh::CellTypes >();
