...
CPPUNIT_TEST_SUITE_REGISTRATION( data::tools::ut::MeshTest );
...
{
    {
        ...
        data::tools::Mesh::colorizeMeshPoints(mesh, R, G, B, A);
    ...
    // Check to colorize few points with RGBA
    {
        ...
        // fill color with 0
        data::tools::Mesh::colorizeMeshPoints(mesh, 0, 0, 0, 0);

        data::tools::Mesh::colorizeMeshPoints(mesh, vectorNumTriangle, R, G, B, A);
...
void MeshTest::colorizeCellsTest()
{
    // Check to colorize all the mesh with RGB
    {
        ...
        data::tools::Mesh::colorizeMeshCells(mesh, R, G, B);
    ...
    // Check to colorize all the mesh with RGBA
    {
        ...
        data::tools::Mesh::colorizeMeshCells(mesh, R, G, B, A);
    ...
    // Check to colorize few cells with RGB
    {
        ...
        // fill color with 0
        data::tools::Mesh::colorizeMeshCells(mesh, 0, 0, 0, 0);

        data::tools::Mesh::colorizeMeshCells(mesh, vectorNumTriangle, R, G, B);
    ...
    // Check to colorize few cells with RGBA
    {
        ...
        data::tools::Mesh::colorizeMeshCells(mesh, vectorNumTriangle, R, G, B, A);
...
void MeshTest::transformTest()
{
    ...
    data::tools::TransformationMatrix3D::setTF3DFromMatrix(trans, matrix);

    data::tools::Mesh::transform(meshOrig, mesh, trans);
...
{
    {
        ...
        const bool isClosed = data::tools::Mesh::isClosed(mesh);
...
void MeshTest::cellNormalTest()
{
    ...
    CPPUNIT_ASSERT_NO_THROW(data::tools::Mesh::generateCellNormals(mesh));
...
void MeshTest::pointNormalTest()
{
    ...
    CPPUNIT_ASSERT_NO_THROW(data::tools::Mesh::generatePointNormals(mesh));
