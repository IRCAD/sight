...
CPPUNIT_TEST_SUITE_REGISTRATION( data::tools::ut::TransformationMatrix3DTest );
...
void TransformationMatrix3DTest::identityMatrixTest()
{
    ...
    //test identity
    bool shouldBeTrue = data::tools::TransformationMatrix3D::isIdentity(tm1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("TransformationMatrix3D should be identity", true, shouldBeTrue);
    // dummy precision
    shouldBeTrue = data::tools::TransformationMatrix3D::isIdentity(tm1, 1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("TransformationMatrix3D should be identity", true, shouldBeTrue);
    // high precision
    shouldBeTrue = data::tools::TransformationMatrix3D::isIdentity(tm1, 1e-17);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("TransformationMatrix3D should be identity", true, shouldBeTrue);

    tm1->setCoefficient(0, 2, 3.4);
    tm1->setCoefficient(1, 3, 18);

    bool shouldBeFalse = data::tools::TransformationMatrix3D::isIdentity(tm1);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("TransformationMatrix3D should not be identity", false, shouldBeFalse);
    //Test with dummy precision
    shouldBeTrue = data::tools::TransformationMatrix3D::isIdentity(tm1, 20);
    ...
    shouldBeFalse = data::tools::TransformationMatrix3D::isIdentity(tm1, 1e-14);
    CPPUNIT_ASSERT_EQUAL_MESSAGE("TransformationMatrix3D should not be identity", false, shouldBeFalse);

    data::tools::TransformationMatrix3D::identity(tm1);
    data::tools::TransformationMatrix3D::identity(tm2);
    CPPUNIT_ASSERT( data::tools::TransformationMatrix3D::isIdentity(tm1));
    CPPUNIT_ASSERT( data::tools::TransformationMatrix3D::isIdentity(tm2));

#ifndef FW_PROFILING_DISABLED
    {
        FW_PROFILE("::data::tools::TransformationMatrix3D::multiply");
        for(int i = 0; i < 1000000; ++i)
        {
            data::tools::TransformationMatrix3D::multiply(tm1, tm2, tm3);
        }
    }
#else
    data::tools::TransformationMatrix3D::multiply(tm1, tm2, tm3);
#endif
    CPPUNIT_ASSERT( data::tools::TransformationMatrix3D::isIdentity(tm3));

#ifndef FW_PROFILING_DISABLED
    {
        FW_PROFILE("::data::tools::TransformationMatrix3D::invert");
        for(int i = 0; i < 1000000; ++i)
        {
            data::tools::TransformationMatrix3D::invert(tm1, tm4);
        }
    }
#else
    data::tools::TransformationMatrix3D::invert(tm1, tm4);
#endif
    CPPUNIT_ASSERT( data::tools::TransformationMatrix3D::isIdentity(tm4));
...
#ifndef FW_PROFILING_DISABLED
    {
        ...
        for(int i = 0; i < 1000000; ++i)
        {
            data::tools::TransformationMatrix3D::multiply(tm1, p1, p2);
        }
    }
#else
    data::tools::TransformationMatrix3D::multiply(tm1, p1, p2);
...
void TransformationMatrix3DTest::matrixTest()
{
    ...
    // Test invert
    data::tools::TransformationMatrix3D::invert(tm2, tm4);
...
#ifndef FW_PROFILING_DISABLED
    {
        FW_PROFILE("::data::tools::TransformationMatrix3D::getMatrixFromTF3D");
        for(int i = 0; i < 1000000; ++i)
        {
            glmMat = data::tools::TransformationMatrix3D::getMatrixFromTF3D(mat);
        }
    }
#else
    glmMat = data::tools::TransformationMatrix3D::getMatrixFromTF3D(mat);
...
#ifndef FW_PROFILING_DISABLED
    {
        FW_PROFILE("::data::tools::TransformationMatrix3D::setTF3DFromMatrix");
        for(int i = 0; i < 1000000; ++i)
        {
            data::tools::TransformationMatrix3D::setTF3DFromMatrix(mat, glmMat);
        }
    }
#else
    data::tools::TransformationMatrix3D::setTF3DFromMatrix(mat, glmMat);
