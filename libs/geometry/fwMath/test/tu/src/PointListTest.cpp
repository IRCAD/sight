...
CPPUNIT_TEST_SUITE_REGISTRATION( data::tools::ut::PointListTest );
...
void PointListTest::computeDistance()
{
    ...
    // Simple test with empty point lists
    {
        ...
        data::Array::sptr outputArray = data::tools::helper::PointList::computeDistance(pl1, pl2);
...
void PointListTest::transform()
{
    // Simple test with identity
    {
        ...
        data::tools::helper::PointList::transform(pl1, tf1);
...
void PointListTest::associate()
{
    ...
    // Simple test with empty point lists
    {
        ...
        data::tools::helper::PointList::associate(pl1, pl2);
    ...
    // Associating them should make the x components match
    {
        ...
        data::tools::helper::PointList::transform(pl1, tf1);
        data::tools::helper::PointList::transform(pl2, tf2);
...
void PointListTest::removeClosestPointNominal()
{
    ...
    for(size_t i = 0; i < nbPoints; ++i)
    {
        ...
        CPPUNIT_ASSERT( data::tools::helper::PointList::removeClosestPoint(pl, p,
    ...
    for(size_t i = 0; i < nbPoints; ++i)
    {
        ...
        const auto pRes =
            data::tools::helper::PointList::removeClosestPoint(pl, p, std::numeric_limits<float>::max());
