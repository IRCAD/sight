 ...
 */
class DATA_CLASS_API PointList
{
...
public:
     ...
     */
    DATA_API static data::Array::sptr
     ...
     */
    DATA_API static void transform(data::PointList::sptr& _pointList,
     ...
     */
    DATA_API static void associate(const data::PointList::csptr& _pointList1,
     ...
     */
    DATA_API static const data::Point::sptr removeClosestPoint(const data::PointList::sptr& _pointList,
