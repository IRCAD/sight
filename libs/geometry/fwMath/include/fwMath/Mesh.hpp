...
public:
     ...
     */
    DATA_API static void generateCellNormals(data::Mesh::sptr mesh);
     ...
     * @param[out]  mesh data::Mesh structure to fill with cell normals.
     */
    DATA_API static void generatePointNormals(data::Mesh::sptr mesh);
     ...
     */
    DATA_API static void shakePointNormals(data::Mesh::sptr mesh);
     ...
     * @param[out]  mesh data::Mesh structure to shake normals.
     */
    DATA_API static void shakeCellNormals(data::Mesh::sptr mesh);
     ...
     */
    DATA_API static void shakePoint(data::Mesh::sptr mesh);
     ...
     */
    DATA_API static void colorizeMeshPoints(data::Mesh::sptr mesh);
     ...
     * @param[in]  mesh data::Mesh mesh structure to colorize.
     */
    DATA_API static void colorizeMeshCells(data::Mesh::sptr mesh);
     ...
     */
    DATA_API static bool hasUniqueCellType(data::Mesh::csptr mesh, data::Mesh::CellTypes cell);
     ...
     */
    DATA_API static bool hasUniqueCellType(data::Mesh::csptr mesh, data::Mesh::CellType cell);

    /// Apply a transformation 4x4 from an input mesh to an output mesh
    DATA_API static void transform(data::Mesh::csptr inMesh, data::Mesh::sptr outMesh,
                                   data::TransformationMatrix3D::csptr t );

    /// Apply a transformation 4x4 on a mesh
    DATA_API static void transform( data::Mesh::sptr mesh, data::TransformationMatrix3D::csptr t );
     ...
     */
    DATA_API static void colorizeMeshPoints(const data::Mesh::sptr& mesh, const std::uint8_t colorR,
     ...
     * @pre mesh must only contain triangle
     */
    DATA_API static void colorizeMeshPoints(const data::Mesh::sptr& _mesh,
     ...
     * @pre mesh must only contain triangle
     */
    DATA_API static void colorizeMeshCells(const data::Mesh::sptr& mesh, const std::uint8_t colorR,
                                           const std::uint8_t colorG, const std::uint8_t colorB,
     ...
     * @pre mesh must only contain triangle
     */
    DATA_API static void colorizeMeshCells(const data::Mesh::sptr& mesh,
     ...
     */
    DATA_API static bool isClosed(const data::Mesh::csptr& mesh);
};
