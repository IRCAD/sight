...
public:
     ...
     */
    GEOMETRY_VISION_API ReprojectionError( const ::cv::Mat& _cameraMat, const ::cv::Mat& _distCoef,
    ...
    GEOMETRY_VISION_API static ::ceres::CostFunction* Create(const ::cv::Mat& _cameraMatrix,
