...
)
{
    ...
    const sight::data::point_list::PointListContainer points1 = _pointList1->getPoints();
    const sight::data::point_list::PointListContainer points2 = _pointList2->getPoints();
...
{
    sight::data::point_list::PointListContainer points = _pointList->getPoints();
...
)
{
    ...
    sight::data::point_list::PointListContainer points1 = _pointList1->getPoints();
    sight::data::point_list::PointListContainer points2 = _pointList2->getPoints();
