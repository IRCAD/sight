...
const ::sight::data::Point::sptr PointList::removeClosestPoint(const ::sight::data::PointList::sptr& _pointList,
                                                               const ::sight::data::Point::csptr& _point, float _delta)
{
    // Initial data
