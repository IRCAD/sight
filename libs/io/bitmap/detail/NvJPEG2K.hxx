...
public:
    ...
    inline void write(const data::Image& image, std::ostream& ostream, ExtendedMode mode)
    {
        ...
        encode_config.color_space =
            image.getPixelFormat() == data::Image::GRAY_SCALE
        ...
        // This normally irrelevant for lossless. Set it in case we change for lossy later
        CHECK_CUDA(
...
private:
    ...
    inline void toGPU(const data::Image& image)
    {
        ...
        else if(num_components == 3 || num_components == 4)
        {
            ...
            else if(type == core::Type::INT16 || type == core::Type::UINT16)
            {
