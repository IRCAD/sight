...
class ARSTRUCTURALPATCH_CLASS_API V2ToV3 : public io::atoms::patch::IStructuralPatch
{

public:

    fwCoreClassMacro(V2ToV3, ::arStructuralPatchdata::CameraSeries::V2ToV3, new V2ToV3)
