...
const io::base::services::LocationsType& IWriter::getFiles() const
{
...
void IWriter::setFiles(const io::base::services::LocationsType& files)
{
    FW_RAISE_IF("This reader doesn't manage files", !(this->getIOPathType() & io::base::services::FILES));
    m_locations = files;
}
...
const io::base::services::LocationsType& IWriter::getLocations() const
{
...
void IWriter::configuring()
{
    ...
    SLM_ASSERT("This writer does not manage folders and a folder path is given in the configuration",
               ( this->getIOPathType() & io::base::services::FOLDER ) ||
    ...
    {
        FW_RAISE_IF("This reader cannot manages FILE and FILES.", this->getIOPathType() & io::base::services::FILE );
        std::vector< core::runtime::ConfigurationElement::sptr > config = m_configuration->find("file");
...
io::base::services::IOPathType IWriter::getIOPathType() const
{
