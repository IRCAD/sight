 ...
 */
class IO_BASE_CLASS_API IReader : public sight::services::IService
{

public:
    fwCoreServiceMacro(IReader, sight::services::IService)
     ...
     */
    IO_BASE_API virtual io::base::services::IOPathType getIOPathType() const;
     ...
     */
    IO_BASE_API const io::base::services::LocationsType& getFiles() const;

    /**
     * @brief Sets file paths
     * @pre exception if service does not support FILES mode
     */
    IO_BASE_API void setFiles(const io::base::services::LocationsType& files);
     ...
     * @pre exception if a file path is not defined ( m_locations.empty() )
     */
    IO_BASE_API const io::base::services::LocationsType& getLocations() const;
...
private:
    ...
    /// Slot to read files
    void readFiles(io::base::services::LocationsType files);

    /// Value to stock file or folder paths
    io::base::services::LocationsType m_locations;
};
