...
public:
     ...
     */
    IGTLPROTOCOL_API virtual data::Object::sptr fromIgtlMessage(const ::igtl::MessageBase::Pointer src) const = 0;
     ...
     */
    IGTLPROTOCOL_API virtual ::igtl::MessageBase::Pointer fromFwDataObject (data::Object::csptr src) const = 0;
