...
namespace sight::io::session::detail::CalibrationInfo
{
...
inline static data::CalibrationInfo::sptr read(
...
SIGHT_REGISTER_SERIALIZER(data::CalibrationInfo, write, read);
