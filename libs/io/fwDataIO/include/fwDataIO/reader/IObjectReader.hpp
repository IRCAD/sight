 ...
 * method setOject.
 */
class FWDATAIO_CLASS_API IObjectReader : public core::BaseObject
{
...
public:
     ...
     */
    FWDATAIO_API virtual void setLocation( const data::location::ILocation::sptr _location );
    ...
    FWDATAIO_API virtual SPTR(core::jobs::IJob) getJob() const
    {
        return nullptr;
    }
