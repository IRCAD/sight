 ...
 */
class IO_VTK_CLASS_API meta_image_writer : public writer::generic_object_writer<data::image>,
...
public:
    ...
    //! @brief Constructor.
    IO_VTK_API meta_image_writer();

    //! @brief Destructor.
    IO_VTK_API ~meta_image_writer() override;
