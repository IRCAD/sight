...
class SIGHT_IO_VTK_CLASS_API stl_mesh_writer :
    public writer::generic_object_writer<data::mesh>,
    public core::location::single_file
{
public:

    SIGHT_DECLARE_CLASS(stl_mesh_writer, io::writer::generic_object_writer<data::mesh>)

    /// @brief Constructor.
    SIGHT_IO_VTK_API stl_mesh_writer();

    /// @brief Destructor.
    SIGHT_IO_VTK_API ~stl_mesh_writer() override;
