...
class SIGHT_IO_VTK_CLASS_API ply_mesh_reader :
    public reader::generic_object_reader<data::mesh>,
    public core::location::single_file
{
public:

    SIGHT_DECLARE_CLASS(ply_mesh_reader, io::reader::generic_object_reader<data::mesh>)

    /// @brief Constructor.
    SIGHT_IO_VTK_API ply_mesh_reader();

    /// @brief Destructor.
    SIGHT_IO_VTK_API ~ply_mesh_reader() override;
