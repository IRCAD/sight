...
class IO_VTK_CLASS_API StlMeshReader : public reader::generic_object_reader<data::mesh>,
...
public:
    ...
    SIGHT_DECLARE_CLASS(
        ...
        io::reader::factory::make<StlMeshReader>
    )
    ...
    /// @brief Destructor.
    IO_VTK_API ~StlMeshReader() override;
