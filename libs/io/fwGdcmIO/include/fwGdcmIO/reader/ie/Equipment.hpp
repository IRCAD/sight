 ...
 */
class FWGDCMIO_CLASS_API Equipment : public ::fwGdcmIO::reader::ie::InformationEntity< data::Equipment >
{
...
public:
     ...
     */
    FWGDCMIO_API Equipment(const CSPTR(data::DicomSeries)& dicomSeries,
