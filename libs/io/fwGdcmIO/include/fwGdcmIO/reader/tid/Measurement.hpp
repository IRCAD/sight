 ...
 * @see TID 300
 */
class FWGDCMIO_CLASS_API Measurement : public ::fwGdcmIO::reader::tid::TemplateID< data::Image >
{
...
public:
     ...
     */
    FWGDCMIO_API Measurement(const CSPTR(data::DicomSeries)& dicomSeries,
