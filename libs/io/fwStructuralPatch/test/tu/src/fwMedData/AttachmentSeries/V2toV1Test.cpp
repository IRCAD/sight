...
{
    atoms::Object::sptr attachmentSeriesV2 = atoms::Object::New();
    atoms::Object::sptr attachmentSeriesV1;

    ::fwAtomsPatch::helper::setClassname(attachmentSeriesV2, "::sight::data::AttachmentSeries");
    ...
    {
        attachmentSeriesV1 = atoms::Object::dynamicCast(attachmentSeriesV2->clone());
