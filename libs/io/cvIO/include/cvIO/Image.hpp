...
public:
     ...
     */
    CVIO_API static ::cv::Mat moveToCv(data::Image::sptr& _image);
     ...
     */
    CVIO_API static const ::cv::Mat moveToCv(const data::Image::csptr& _image);
     ...
     */
    CVIO_API static void copyFromCv(data::Image::sptr& _image, const ::cv::Mat& _cvImage);
     ...
     */
    CVIO_API static ::cv::Mat copyToCv(const data::Image::csptr& _image);
