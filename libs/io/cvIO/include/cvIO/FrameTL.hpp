...
public:
     ...
     */
    CVIO_API static void moveToCv(const data::FrameTL::csptr& _timeline,
     ...
     */
    CVIO_API static const ::cv::Mat moveToCv(const data::FrameTL::csptr& _timeline,
                                             const data::FrameTL::BufferType::ElementType* _buffer);

    /**
     * @brief Copy a OpenCV image into our internal image data.
     */
    CVIO_API static void copyFromCv(const data::FrameTL::csptr& _timeline,
                                    data::FrameTL::BufferType::ElementType* _buffer,
     ...
     */
    CVIO_API static void copyToCv(const data::FrameTL::csptr& _timeline,
                                  const data::FrameTL::BufferType::ElementType* _buffer,
                                  ::cv::Mat& _cvImage);
