...
{
    SLM_ASSERT("The type of the previous object (" << io::atoms::patch::helper::getClassname(
                   previous)
                                                   << ") does not match the required type (" << m_originClassname << ").",
               io::atoms::patch::helper::getClassname(previous) == m_originClassname);
    SLM_ASSERT("The version of the previous object (" << io::atoms::patch::helper::getVersion(
                   previous)
