 ...
 */
class SIGHT_IO_DICOM_CLASS_API equipment : public io::dicom::reader::ie::information_entity<data::series>
{
public:
     ...
     * @param[in] _reader GDCM reader that must be used to read equipment.
     * @param[in] _instance DICOM instance used to share informations between modules
     * @param[in] _series Equipment data
     ...
     * @see PS 3.3 C.7.5.1
     */
    SIGHT_IO_DICOM_API virtual void read_general_equipment_module();
};
