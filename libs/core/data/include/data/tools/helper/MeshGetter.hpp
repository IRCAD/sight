...
protected:
    ...
    data::tools::helper::ArrayGetter::uptr m_helperPoints;
    data::tools::helper::ArrayGetter::uptr m_helperCellTypes;
    data::tools::helper::ArrayGetter::uptr m_helperCellData;
    data::tools::helper::ArrayGetter::uptr m_helperCellDataOffsets;
    data::tools::helper::ArrayGetter::uptr m_helperPointColors;
    data::tools::helper::ArrayGetter::uptr m_helperCellColors;
    data::tools::helper::ArrayGetter::uptr m_helperPointNormals;
    data::tools::helper::ArrayGetter::uptr m_helperCellNormals;
    data::tools::helper::ArrayGetter::uptr m_helperPointTexCoords;
    data::tools::helper::ArrayGetter::uptr m_helperCellTexCoords;
