...
fwCampAutoDeclareDataMacro((sight)(data)(TransformationMatrix3D));
 ...
 */
class DATA_CLASS_API TransformationMatrix3D : public Object
{

public:
    fwCoreClassMacro(TransformationMatrix3D, data::Object, data::factory::New< TransformationMatrix3D >)

    fwCampMakeFriendDataMacro((sight)(data)(TransformationMatrix3D));
     ...
     */
    DATA_API TransformationMatrix3D(data::Object::Key key);

    //! @brief destructor
    DATA_API virtual ~TransformationMatrix3D();
