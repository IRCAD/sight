...
template<class C>
class DATA_CLASS_API IContainer : public Object,
                                  public ContainerWrapper<C>
{
public:

    SIGHT_DECLARE_CLASS(IContainer<C>, Object);
    ...
    inline static const core::com::Signals::SignalKeyType s_ADDED_OBJECTS_SIG = "addedObjects";
    ...
    inline static const core::com::Signals::SignalKeyType s_CHANGED_OBJECTS_SIG = "changedObjects";

    /// Type of signal when objects are removed
    using removed_signal_t = core::com::Signal<void (container_type)>;
    inline static const core::com::Signals::SignalKeyType s_REMOVED_OBJECTS_SIG = "removedObjects";
    /// @}
    ...
    {
        constexpr ScopedEmitter(const IContainer& container) noexcept;
