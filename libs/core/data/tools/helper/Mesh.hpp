...
public:
    ...
    /// Shared pointer type
    typedef std::shared_ptr < data::tools::helper::Mesh > sptr;
    /// Const shared pointer type
    typedef std::shared_ptr < const data::tools::helper::Mesh > csptr;
    /// Unique pointer type
    typedef std::unique_ptr < data::tools::helper::Mesh > uptr;
    /// Const unique pointer type
    typedef std::unique_ptr < const data::tools::helper::Mesh > cuptr;

    //------------------------------------------------------------------------------

    static sptr New(data::Mesh::sptr mesh)
    {
        return std::make_shared< data::tools::helper::Mesh >(mesh);
    }
...
protected:
    ...
    data::tools::helper::Array::sptr m_helperPoints;
    data::tools::helper::Array::sptr m_helperCellTypes;
    data::tools::helper::Array::sptr m_helperCellData;
    data::tools::helper::Array::sptr m_helperCellDataOffsets;
    data::tools::helper::Array::sptr m_helperPointColors;
    data::tools::helper::Array::sptr m_helperCellColors;
    data::tools::helper::Array::sptr m_helperPointNormals;
    data::tools::helper::Array::sptr m_helperCellNormals;
    data::tools::helper::Array::sptr m_helperPointTexCoords;
    data::tools::helper::Array::sptr m_helperCellTexCoords;
