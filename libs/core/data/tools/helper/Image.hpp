...
public:
    ...
    /// Shared pointer type
    typedef std::shared_ptr < data::tools::helper::Image > sptr;
    /// Const shared pointer type
    typedef std::shared_ptr < const data::tools::helper::Image > csptr;
    /// Unique pointer type
    typedef std::unique_ptr < data::tools::helper::Image > uptr;
    /// Const unique pointer type
    typedef std::unique_ptr < const data::tools::helper::Image > cuptr;

    //------------------------------------------------------------------------------

    static sptr New(data::Image::sptr image)
    {
        return std::make_shared< data::tools::helper::Image >(image);
    }
     ...
     *
     * @deprecated use::data::tools::fieldHelper::MedicalImageHelpers::checkLandmarks() instead.
     */
    [[deprecated("will be removed in sight 22.0, use "
                 "'::data::tools::fieldHelper::MedicalImageHelpers::checkLandmarks()' instead.")]]
     ...
     *
     * @deprecated use::data::tools::fieldHelper::MedicalImageHelpers::checkTransferFunctionPool() instead.
     */
    [[deprecated("will be removed in sight 22.0, use "
                 "'::data::tools::fieldHelper::MedicalImageHelpers::checkTransferFunctionPool()' instead.")]]
     ...
     *
     * @deprecated use::data::tools::fieldHelper::MedicalImageHelpers::checkImageSliceIndex() instead.
     */
    [[deprecated("will be removed in sight 22.0, use "
                 "'::data::tools::fieldHelper::MedicalImageHelpers::checkImageSliceIndex()' instead.")]]
