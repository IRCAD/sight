...
#include "data/tools/helper/MeshGetter.hpp"
...
MeshGetter::MeshGetter( data::Mesh::csptr mesh ) :
    m_mesh(mesh)
{
    FW_DEPRECATED_MSG("::data::tools::helper::MeshGetter is no longer supported, the methods have been moved to "
                      "::sight::data::Mesh", "22.0")

    typedef data::tools::helper::ArrayGetter ArrayGetter;
