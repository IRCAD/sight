...
void MedicalImage::setOrientation( int orientation )
{
    ...
    this->setOrientation(static_cast< data::tools::helper::MedicalImage::Orientation >(orientation));
}
...
{
    m_weakImage  = image;
    m_axialIndex = image->setDefaultField(data::tools::fieldHelper::Image::m_axialSliceIndexId,
                                          data::Integer::New(0));
    m_frontalIndex = image->setDefaultField(data::tools::fieldHelper::Image::m_frontalSliceIndexId,
                                            data::Integer::New(0));
    m_sagittalIndex = image->setDefaultField(data::tools::fieldHelper::Image::m_sagittalSliceIndexId,
                                             data::Integer::New(0));
}
