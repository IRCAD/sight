...
::fwAtoms::Object::sptr readNavigation( const std::filesystem::path& filePath )
{
...
void writeNavigation( const std::filesystem::path& filePath, const ::fwAtoms::Object::sptr atom )
{
    const std::filesystem::path folderPath = filePath.parent_path();
    const std::filesystem::path filename   = filePath.filename();
...
void NavigationSeriesTest::setUp()
{
    ...
    m_series = data::NavigationSeries::New();
}
...
void NavigationSeriesTest::navigationTest()
{
    ...
    data::NavigationSeries::ContainerType positions =
    {
        {0., {-514.1606513019431, -94.68116795798758, 979.3785055174628}}
    };

    data::NavigationSeries::ContainerType move =
    {
    ...
    data::NavigationSeries::ContainerType lookAt =
    {
    ...
    data::NavigationSeries::sptr navigationSeries;

    object           = ::fwAtomConversion::convert(atom2, ::fwAtomConversion::AtomVisitor::ChangePolicy());
    navigationSeries = data::NavigationSeries::dynamicCast(object);
