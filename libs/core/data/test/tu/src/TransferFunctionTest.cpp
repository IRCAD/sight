...
CPPUNIT_TEST_SUITE_REGISTRATION( data::ut::TransferFunctionTest );
...
void TransferFunctionTest::linearColorTest()
{
    ...
    CPPUNIT_ASSERT(data::TransferFunction::TFColor( 0.1, 0.2, 0.6,
    ...
    CPPUNIT_ASSERT(data::TransferFunction::TFColor( 0.1, 0.2, 0.75, 0.525) == tf->getLinearColor(
                       ((150.0-3.0)/4.0)+3) );
    ...
    CPPUNIT_ASSERT(data::TransferFunction::TFColor( 0.1, 0.2, 0.75,
...
void TransferFunctionTest::nearestColorTest()
{
    ...
    CPPUNIT_ASSERT(data::TransferFunction::TFColor( 0.1, 0.2, 0.3,
    ...
    CPPUNIT_ASSERT(data::TransferFunction::TFColor( 0.1, 0.2, 0.9,
