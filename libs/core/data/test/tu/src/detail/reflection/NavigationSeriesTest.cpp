...
#include "detail/reflection/NavigationSeriesTest.hpp"
...
CPPUNIT_TEST_SUITE_REGISTRATION( sight::data::detail::reflection::ut::NavigationSeriesTest );
...
void NavigationSeriesTest::propertiesTest()
{
    ...
    data::NavigationSeries::sptr obj = data::NavigationSeries::New();
