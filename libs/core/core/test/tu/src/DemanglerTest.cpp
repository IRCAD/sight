...
CPPUNIT_TEST_SUITE_REGISTRATION( core::ut::DemanglerTest );
...
{
    CPPUNIT_ASSERT_EQUAL(std::string("core::ut::IDemanglerTest"), core::ut::IDemanglerTest::classname());
    CPPUNIT_ASSERT_EQUAL(std::string("core::ut::ODemanglerTest"), core::ut::ODemanglerTest::classname());
    ...
    CPPUNIT_ASSERT_EQUAL(std::string("core::ut::ODemanglerTest"), object->getClassname());
    CPPUNIT_ASSERT_EQUAL(std::string("core::ut::ODemanglerTest"), genericObject->getClassname());
