...
public:
    ...
    static void castFloatToIntTest();
    static void castDoubleToIntTest();
    static void castIntToFloatTest();
    static void castDoubleToFloatTest();
    static void castIntToIntTest();
};
