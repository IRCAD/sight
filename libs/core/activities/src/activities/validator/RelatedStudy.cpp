...
#include "activities/validator/RelatedStudy.hpp"
...
fwActivitiesValidatorRegisterMacro(
    activities::validator::RelatedStudy, "::activities::validator::RelatedStudy");

//-----------------------------------------------------------------------------

RelatedStudy::RelatedStudy(activities::IValidator::Key key)
{
}
