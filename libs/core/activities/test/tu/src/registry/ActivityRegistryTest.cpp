...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::activities::ut::ActivityRegistryTest );
...
{
    public:
        activities::registry::Activities::sptr activities;
};
...
void ActivityRegistryTest::setUp()
{
    ...
    m_pimpl->activities = activities::registry::Activities::New();

    core::runtime::addModules(core::runtime::getResourceFilePath("tu_exec_activities-0.0"));
...
struct activities_less_than_key
{
    ...
    inline bool operator() (const activities::registry::ActivityInfo& a,
                            const activities::registry::ActivityInfo& b)
    {
        return (a.id < b.id);
    }
};
...
void ActivityRegistryTest::registryTest()
{
    ...
    activities::registry::Activities::ActivitiesType activities;
    ...
    CPPUNIT_ASSERT_EQUAL( size_t(1), activities.size() );
    const activities::registry::ActivityInfo& info = activities[0];
