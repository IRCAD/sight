...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::activities::ut::ActivitySeriesBuilderTest );
...
{
    m_activities = activities::registry::Activities::New();
...
void ActivitySeriesBuilderTest::buildDataTest()
{
    ...
    activities::registry::ActivityInfo activityInfo = activities[0];
    data::ActivitySeries::sptr actSeries;
    activities::IBuilder::sptr builder;
    builder = activities::builder::factory::New(activityInfo.builderImpl);
