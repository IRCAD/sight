...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::activities::ut::DefaultActivityTest );
...
void DefaultActivityTest::requirementsTest()
{
    activities::IValidator::sptr validator =
        activities::validator::factory::New("::activities::validator::DefaultActivity");
...
void DefaultActivityTest::objectTest()
{
    ...
    }
    {
        ...
        validation = activityValidator->checkObject(vector, "::activities::validator::ImageProperties");
    ...
    }
    {
        ...
        validation = activityValidator->checkObject(vector2, "::activities::validator::ImageProperties");
