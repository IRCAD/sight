...
fwActivitiesBuilderRegisterMacro(activities::builder::ActivitySeries, "::activities::builder::ActivitySeries");

//-----------------------------------------------------------------------------

ActivitySeries::ActivitySeries(activities::IBuilder::Key key)
{
}
...
data::Composite::sptr vectorToComposite(const data::Vector::csptr& vector,
                                        const activities::registry::ActivityRequirement& req)
{
