 ...
 */
class ACTIVITIES_CLASS_API ActivitySeries : public activities::IBuilder
{
public:
    fwCoreClassMacro(ActivitySeries, activities::IBuilder, activities::builder::factory::New< ActivitySeries >)

    typedef std::string RegistryKeyType;

    /// Constructor. Do nothing.
    ACTIVITIES_API ActivitySeries(activities::IBuilder::Key key);

    /// Destructor. Do nothing.
    ACTIVITIES_API virtual ~ActivitySeries();
