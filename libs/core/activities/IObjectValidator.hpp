 ...
 */
class ACTIVITIES_CLASS_API IObjectValidator : public activities::IValidator
{

public:

    fwCoreClassMacro(IObjectValidator, activities::IValidator)
     ...
     */
    ACTIVITIES_API virtual ValidationType validate(const CSPTR(data::Object)& currentData ) const = 0;
