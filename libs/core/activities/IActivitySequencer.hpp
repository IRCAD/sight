 ...
 */
class ACTIVITIES_CLASS_API IActivitySequencer : public IActivityLauncher
{
public:

    /// Constructor. Do nothing.
    ACTIVITIES_API IActivitySequencer();

    /// Destructor. Do nothing.
    ACTIVITIES_API virtual ~IActivitySequencer();
...
protected:
     ...
     */
    ACTIVITIES_API int parseActivities(const data::SeriesDB::sptr& seriesDB);

    /// Store the data of the activity at the given index
    ACTIVITIES_API void storeActivityData(const data::SeriesDB::sptr& seriesDB, int index,
     ...
     */
    ACTIVITIES_API data::ActivitySeries::sptr getActivity(const data::SeriesDB::sptr& seriesDB,
                                                          size_t index,
