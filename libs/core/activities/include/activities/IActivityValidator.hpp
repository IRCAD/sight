 ...
 */
class ACTIVITIES_CLASS_API IActivityValidator : public activities::IValidator
{

public:

    fwCoreClassMacro(IActivityValidator, activities::IValidator)
     ...
     */
    ACTIVITIES_API virtual ValidationType validate(const CSPTR(data::ActivitySeries)& activity ) const = 0;
     ...
     *         (or not valid) data.
     */
    ACTIVITIES_API ValidationType checkRequirements(const CSPTR(data::ActivitySeries)& activity) const;
     ...
     *         (or not valid) data.
     */
    ACTIVITIES_API ValidationType checkParameters(const CSPTR(data::ActivitySeries)& activity) const;
     ...
     * @see activities::IObjectValidator
     */
    ACTIVITIES_API ValidationType checkObject(const CSPTR(data::Object)& object,
