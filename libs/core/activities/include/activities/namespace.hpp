...
/// The namespace sightactivities::builder contains the base interface for data ActivitySeries builder.
namespace builder
{

/// Contains activities::builder::registry details
namespace registry
{
} // namespace registry

/// Contains activities::builder::factory utilities
namespace factory
{
} // namespace factory
...
/// Contains activities::validator::registry details
namespace registry
{
} // namespace registry

/// Contains activities::validator::factory utilities
namespace factory
{
} // namespace factory
 ...
 *
 * An activity is defined by the extension "::activities::registry::Activities". It is used to launch an
 ...
 *   ``activities::builder::ActivitySeries`` : it creates the ``data::ActivitySeries`` and adds the required
 *   data in its composite with de defined key.
 *   The builder ``activities::builder::ActivitySeriesInitData`` allows, in addition to what the default builder
 ...
 *   For example, the validator ``activities::validator::ImageProperties`` checks that all the selected images
 ...
 * activities::IValidator and must implement the methods:
 *
 * @code {.cpp}
 ...
 * It inherits of activities::IActivityValidator and must implement the method:
 *
 * @code {.cpp}
   ValidationType validate(const CSPTR(data::ActivitySeries) &activity ) const;
   @endcode
 *
 * The validator activities::validator::DefaultActivity is applied if no other validator is defined. It checks if
 ...
 * a Composite containing one type of object. It inherits of activities::IObjectValidator and must implement the
 * method:
 *
 * @code {.cpp}
