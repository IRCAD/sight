 ...
 */
class FWDATA_CLASS_API CompareObjects : public ::camp::ExtendedClassVisitor
{
...
public:
     ...
     * @brief Constructor.
     */
    FWDATA_API CompareObjects();

    FWDATA_API virtual ~CompareObjects();
    ...
    FWDATA_API static const std::string s_MISSING_PROPERTY;
