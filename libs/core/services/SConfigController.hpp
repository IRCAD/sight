 ...
 */
class SERVICES_CLASS_API SConfigController : public services::IController
{

public:

    fwCoreServiceMacro(SConfigController, services::IController)

    /// Constructor. Does nothing.
    SERVICES_API SConfigController() noexcept;

    /// Destructor. Does nothing.
    SERVICES_API virtual ~SConfigController() noexcept;
...
protected:
     ...
     * @code{.xml}
       <service impl="::sight::services::SConfigController" type="::sight::services::IController">
            <config>
                <appConfig id="IdOfConfig" >
                    <parameters>
