...
void ServiceFactory::parseBundleInformation()
{
    ...
    extElements = core::runtime::getAllExtensionsForPoint("::sight::services::registry::ServiceFactory");
...
IService::sptr ServiceFactory::create( const std::string& _srvImpl ) const
{
    ...
    service->setWorker( services::registry::ActiveWorkers::getDefaultWorker() );
