 ...
 *        "::sight::services::registry::AppConfigParameters".
 */
class SERVICES_CLASS_API AppConfigParameters : public core::BaseObject
{
...
public:
    ...
    SERVICES_API static AppConfigParameters::sptr getDefault();

    /// Destructor
    SERVICES_API virtual ~AppConfigParameters();
     ...
     * @note This method is thread safe.
     **/
    SERVICES_API const FieldAdaptorType& getParameters( const std::string& extensionId ) const;
...
protected:
    ...
    /// Constructor
    SERVICES_API AppConfigParameters();
