 ...
 */
class SERVICES_CLASS_API IParametersService : public services::IService
{

public:

    fwCoreServiceMacro(IParametersService, services::IService)

    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_BOOL_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_COLOR_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE2_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_DOUBLE3_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_INT_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_INT2_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_INT3_PARAMETER_SLOT;
    SERVICES_API static const core::com::Slots::SlotKeyType s_SET_ENUM_PARAMETER_SLOT;

protected:

    /// Constructor. Create all slots.
    SERVICES_API IParametersService();

    /// Destructor. Do nothing.
    SERVICES_API virtual ~IParametersService();

    /// Slot: This method is used to set an boolean parameter.
    SERVICES_API virtual void setBoolParameter(bool val, std::string key);

    /// Slot: This method is used to set a color parameter.
    SERVICES_API virtual void setColorParameter(std::array<std::uint8_t, 4> color, std::string key);

    /// Slot: This method is used to set a double parameter.
    SERVICES_API virtual void setDoubleParameter(double val, std::string key);

    /// Slot: This method is used to set two double parameters.
    SERVICES_API virtual void setDouble2Parameter(double val0, double val1, std::string key);

    /// Slot: This method is used to set three double parameters.
    SERVICES_API virtual void setDouble3Parameter(double val0, double val1, double val2, std::string key);

    /// Slot: This method is used to set an integer parameter.
    SERVICES_API virtual void setIntParameter(int val, std::string key);

    /// Slot: This method is used to set two int parameters.
    SERVICES_API virtual void setInt2Parameter(int val0, int val1, std::string key);

    /// Slot: This method is used to set three int parameters.
    SERVICES_API virtual void setInt3Parameter(int val0, int val1, int val2, std::string key);

    /// Slot: This method is used to set an enum parameter.
    SERVICES_API virtual void setEnumParameter(std::string val, std::string key);
};
