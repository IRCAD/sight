 ...
 * services.
 *
 * The xml configuration for an application is defines with the extension ``::services::registry::AppConfig``.
 *
 * @code{.xml}
     <extension implements="::sight::services::registry::AppConfig">
         ...
         <config>
             ...
             <object type="data::Composite">
                 ...
                 -->
                 <service uid="myFrame" impl="::modules::ui::base::frame::SDefaultFrame">
                     <gui>
                         <frame>
                             <name>${appName}</name>
