...
fwServicesRegisterMacro( ::sight::services::ut::TestService, ::sight::services::ut::TestServiceImplementation)
fwServicesRegisterObjectMacro( ::sight::services::ut::TestServiceImplementation, ::sight::data::Object);
fwServicesRegisterMacro( ::sight::services::ut::TestService, ::sight::services::ut::TestServiceImplementation2 )
fwServicesRegisterMacro( ::sight::services::ut::TestService, ::sight::services::ut::TestSrvAutoconnect )
fwServicesRegisterMacro( ::sight::services::IService, ::sight::services::ut::TestServiceWithData )
...
const services::IService::KeyType TestServiceWithData::s_INPUT       = "input";
const services::IService::KeyType TestServiceWithData::s_INOUT_GROUP = "inoutGroup";
const services::IService::KeyType TestServiceWithData::s_OUTPUT      = "output";
