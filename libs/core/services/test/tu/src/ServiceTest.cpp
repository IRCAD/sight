...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::services::ut::ServiceTest );
...
void ServiceTest::tearDown()
{
    ...
    auto services = services::OSR::getServices< services::IService >();
...
{
    // Test adding service
    auto srv  = services::add< services::ut::TestService >("::sight::services::ut::TestServiceImplementation");
    auto srv2 = services::add< services::ut::TestService >("::sight::services::ut::TestServiceImplementation");

    CPPUNIT_ASSERT_EQUAL(services::IService::ConfigurationStatus::UNCONFIGURED, srv->getConfigurationStatus());
    CPPUNIT_ASSERT_EQUAL(TestService::s_UNCONFIGURED, srv->getOption());
    srv->configure();
    CPPUNIT_ASSERT_EQUAL(services::IService::ConfigurationStatus::CONFIGURED, srv->getConfigurationStatus());
    ...
    services::IService::ConfigType config2;
    config2.add(TestService::s_OPTION_KEY, OPTION2);

    CPPUNIT_ASSERT_EQUAL(services::IService::ConfigurationStatus::UNCONFIGURED, srv2->getConfigurationStatus());
    CPPUNIT_ASSERT_EQUAL(TestService::s_UNCONFIGURED, srv2->getOption());

    srv2->configure(config2);

    CPPUNIT_ASSERT_EQUAL(services::IService::ConfigurationStatus::CONFIGURED, srv2->getConfigurationStatus());
    CPPUNIT_ASSERT_EQUAL(OPTION2, srv2->getOption());

    // Test erasing service
    services::OSR::unregisterService(srv);
    services::OSR::unregisterService(srv2);
}
...
void ServiceTest::testServiceCreationWithMultipleData()
{
    ...
    CPPUNIT_ASSERT( services::registry::ServiceFactory::getDefault()->support(obj1->getClassname(),
                                                                              "::sight::services::ut::TestService") );
    typedef services::IService::AccessType AccessType;

    // Test adding service
    services::IService::sptr srv = services::add("::sight::services::ut::TestServiceImplementation");
    srv->registerInOut(obj1, dataKey1);
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(dataKey1, AccessType::INOUT, srv));
    CPPUNIT_ASSERT(obj1 == services::OSR::getRegistered(dataKey1, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey2, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey3, AccessType::INOUT, srv));
    ...
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(dataKey2, AccessType::INOUT, srv));
    CPPUNIT_ASSERT(obj2 == services::OSR::getRegistered(dataKey2, AccessType::INOUT, srv));

    // Test getting the service object
    CPPUNIT_ASSERT_EQUAL(obj2, srv->getLockedInOut< data::Integer >(dataKey2).get_shared());

    srv->registerInput(obj3, dataKey3);
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(dataKey3, AccessType::INPUT, srv));
    CPPUNIT_ASSERT(obj3 == services::OSR::getRegistered(dataKey3, AccessType::INPUT, srv));
    ...
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey1, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(dataKey2, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(dataKey3, AccessType::INPUT, srv));
    ...
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey1, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey2, AccessType::INOUT, srv));
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(dataKey3, AccessType::INPUT, srv));
...
void ServiceTest::testServiceCreationWithTemplateMethods()
{
    ...
    // Test if the object support the service
    CPPUNIT_ASSERT( services::registry::ServiceFactory::getDefault()->support(obj->getClassname(),
                                                                              "::sight::services::ut::TestService") );

    // Test adding service
    services::ut::TestService::sptr srv =
        services::add< services::ut::TestService > ("::sight::services::ut::TestServiceImplementation");
    srv->registerInOut(obj, dataKey);
    CPPUNIT_ASSERT(services::OSR::isRegistered(dataKey, services::IService::AccessType::INOUT, srv));
    CPPUNIT_ASSERT(obj == services::OSR::getRegistered(dataKey, services::IService::AccessType::INOUT, srv));
    ...
    CPPUNIT_ASSERT_EQUAL(false,
                         services::OSR::isRegistered(dataKey, services::IService::AccessType::INOUT, srv));
...
void ServiceTest::testServiceCreationWithUUID()
{
    ...
    services::IService::sptr service2;
    ...
    // Test adding service
    service = services::add("::sight::services::ut::TestServiceImplementation", myUUID);
    CPPUNIT_ASSERT(service);
    service->registerInOut(obj, dataKey);

    service2 = services::add("::sight::services::ut::TestServiceImplementation", myUUID2);
    ...
    // Test getting the service its object
    services::IService::sptr service2bis = services::get(myUUID2);
    ...
    CPPUNIT_ASSERT_EQUAL( nbServices, services::OSR::getServices("::sight::services::ut::TestService").size() );

    // Test erasing service
    services::OSR::unregisterService(service);
    nbServices--;
    CPPUNIT_ASSERT_EQUAL( nbServices, services::OSR::getServices("::sight::services::ut::TestService").size() );
    services::OSR::unregisterService(service2);
}
...
void ServiceTest::testStartStopUpdate()
{
    ...
    data::Integer::sptr obj = data::Integer::New();
    services::ut::TestService::sptr service;

    // Add service
    CPPUNIT_ASSERT( services::registry::ServiceFactory::getDefault()->support(obj->getClassname(),
                                                                              "::sight::services::ut::TestService") );
    service = services::add< services::ut::TestService >("::sight::services::ut::TestServiceImplementation", myUUID);
    CPPUNIT_ASSERT(service);
...
void ServiceTest::testStartStopUpdateExceptions()
{
    ...
    {
        auto service = services::add< services::ut::TestService>("::sight::services::ut::TestServiceImplementation");
...
void ServiceTest::testCommunication()
{
    ...
    services::ut::TestService::sptr service1;
    services::ut::TestService::sptr service2;

    // Add services
    services::add("::sight::services::ut::TestServiceImplementation", service1UUID);
    service1 = services::ut::TestService::dynamicCast( services::get(service1UUID) );
    CPPUNIT_ASSERT(service1);
    service1->registerInput(obj, dataKey, true);

    service2 = services::add< services::ut::TestService >("::sight::services::ut::TestServiceImplementation",
                                                          service2UUID);
    CPPUNIT_ASSERT(service2);
    ...
    comHelper.connect(service1, services::IService::s_STARTED_SIG, receiver1, "start");
    comHelper.connect(service1, services::IService::s_UPDATED_SIG, receiver1, "update");
    comHelper.connect(service1, services::IService::s_STOPPED_SIG, receiver1, "stop");
    ...
    comHelper.connect(service2, services::IService::s_STARTED_SIG, receiver2, "start");
    comHelper.connect(service2, services::IService::s_UPDATED_SIG, receiver2, "update");
    comHelper.connect(service2, services::IService::s_STOPPED_SIG, receiver2, "stop");
    ...
    comHelper.connect( service1, services::ut::TestServiceImplementation::s_MSG_SENT_SIG,
                       service2, services::ut::TestServiceImplementation::s_UPDATE2_SLOT );

    CPPUNIT_ASSERT(!service2->getIsUpdated2());

    // Service1 send notification
    services::ut::TestServiceImplementation::MsgSentSignalType::sptr sig;
    sig = service1->signal< services::ut::TestServiceImplementation::MsgSentSignalType >(
        services::ut::TestServiceImplementation::s_MSG_SENT_SIG);
    {
        core::com::SlotBase::sptr slot;
        slot = service1->slot( services::IService::s_UPDATE_SLOT );
    ...
    services::OSR::unregisterService(service1);
    services::OSR::unregisterService(service2);
...
void ServiceTest::testWithInAndOut()
{
    ...
    services::ut::TestServiceWithData::sptr service =
        services::add< services::ut::TestServiceWithData >("::sight::services::ut::TestServiceWithData");

    CPPUNIT_ASSERT(service);
    CPPUNIT_ASSERT_EQUAL(false, service->hasAllRequiredObjects());
    service->registerInput(obj, services::ut::TestServiceWithData::s_INPUT);
    CPPUNIT_ASSERT_EQUAL(true, service->hasAllRequiredObjects());

    service->registerGroup();
    CPPUNIT_ASSERT_EQUAL(false, service->hasAllRequiredObjects());
    service->registerInOut(obj, KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 0));
    CPPUNIT_ASSERT_EQUAL(false, service->hasAllRequiredObjects());
    service->registerInOut(obj2, KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 1));
    CPPUNIT_ASSERT_EQUAL(true, service->hasAllRequiredObjects());

    service->start();
    CPPUNIT_ASSERT(service->isStarted());
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(services::ut::TestServiceWithData::s_INPUT,
                                                           services::IService::AccessType::INPUT, service));
    service->update();
    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(services::ut::TestServiceWithData::s_OUTPUT,
                                                           services::IService::AccessType::OUTPUT, service));
    data::Object::csptr output =
        services::OSR::getRegistered(services::ut::TestServiceWithData::s_OUTPUT,
                                     services::IService::AccessType::OUTPUT, service);
    ...
    data::Integer::csptr outInteger2 = service->getLockedOutput< data::Integer >(
        services::ut::TestServiceWithData::s_OUTPUT).get_shared();
    ...
    auto nullInteger = service->getWeakOutput< data::Integer >( services::ut::TestServiceWithData::s_OUTPUT);
    CPPUNIT_ASSERT(nullInteger.expired());

    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(services::ut::TestServiceWithData::s_OUTPUT,
                                                            services::IService::AccessType::OUTPUT, service));

    CPPUNIT_ASSERT_EQUAL(true, services::OSR::isRegistered(services::ut::TestServiceWithData::s_INPUT,
                                                           services::IService::AccessType::INPUT, service));
    service->unregisterInput(services::ut::TestServiceWithData::s_INPUT);
    CPPUNIT_ASSERT_EQUAL(false, services::OSR::isRegistered(services::ut::TestServiceWithData::s_INPUT,
                                                            services::IService::AccessType::INPUT, service));
    services::OSR::unregisterService(service);
}
