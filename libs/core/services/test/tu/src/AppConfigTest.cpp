...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::services::ut::AppConfigTest );
...
#define WAIT_SERVICE_STARTED(srv)  \
    fwTestWaitMacro(core::tools::fwID::getObject(srv) != nullptr && \
                    services::IService::dynamicCast(core::tools::fwID::getObject(srv))->getStatus() \
                    == services::IService::STARTED)
...
void AppConfigTest::setUp()
{
    ...
    core::runtime::loadModule("::sight::modules::services");
    core::runtime::loadModule("AppConfigTest");

    services::registry::AppConfig::sptr appConfig = services::registry::AppConfig::getDefault();
...
void AppConfigTest::tearDown()
{
    ...
    // Clean up after the test run.
    services::registry::AppConfig::sptr appConfig;
    appConfig = services::registry::AppConfig::getDefault();
...
{
    services::registry::AppConfig::sptr currentAppConfig = services::registry::AppConfig::getDefault();
    ...
    services::registry::FieldAdaptorType replaceFields;
...
services::AppConfigManager::sptr AppConfigTest::launchAppConfigMgr(
    const std::string& name,
    bool autoPrefix)
{
    auto appConfigMgr = services::AppConfigManager::New();
...
void AppConfigTest::startStopTest()
{
    ...
    auto genDataSrv = services::ut::TestService::dynamicCast(core::tools::fwID::getObject("SGenerateData"));
    ...
    // This service has no data and is started by the config
    {
        ...
        auto srv1                        = services::ut::TestService::dynamicCast(gnsrv1);
        CPPUNIT_ASSERT(srv1 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv1->getStatus());
    }
    ...
    // This service has no data and is NOT started by the config
    {
        ...
        auto srv2                        = services::IService::dynamicCast(gnsrv2);
        CPPUNIT_ASSERT(srv2 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv2->getStatus());
        srv2->stop().wait();
        CPPUNIT_ASSERT_EQUAL(services::IService::STOPPED, srv2->getStatus());
        srv2->start().wait();
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv2->getStatus());
    }
    ...
    // This service has a data and is NOT started by the config
    {
        ...
        auto srv3                        = services::IService::dynamicCast(gnsrv3);
        CPPUNIT_ASSERT(srv3 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv3->getStatus());
    }
    ...
    {
        services::OSR::registerServiceOutput(data2, "out2", genDataSrv);
        ...
        // Now the service should have been started automatically
        {
            ...
            auto srv4   = services::IService::dynamicCast(gnsrv4);
            CPPUNIT_ASSERT(srv4 != nullptr);
            CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv4->getStatus());
        }

        // Remove the data
        services::OSR::unregisterServiceOutput("out2", genDataSrv);
...

    {
        ...
        services::OSR::registerServiceOutput(data4, "out4", genDataSrv);
        WAIT_SERVICE_STARTED("TestService5Uid");

        // Now the service should have been started automatically
        {
            auto gnsrv5 = core::tools::fwID::getObject("TestService5Uid");
            auto srv5   = services::IService::dynamicCast(gnsrv5);
            CPPUNIT_ASSERT(srv5 != nullptr);
            CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv5->getStatus());
        }
        ...
        // Put everything back
        services::ut::TestService::s_START_COUNTER  = 0;
        services::ut::TestService::s_UPDATE_COUNTER = 0;
        services::OSR::registerServiceOutput(data2, "out2", genDataSrv);
        WAIT_SERVICE_STARTED("TestService5Uid");
        ...
        {
            auto gnsrv5 = core::tools::fwID::getObject("TestService5Uid");
            auto srv5   = services::ut::TestServiceImplementation::dynamicCast(gnsrv5);
            CPPUNIT_ASSERT(srv5 != nullptr);
            CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv5->getStatus());
            ...
            // Test as well service 4, just to be sure
            auto gnsrv4 = core::tools::fwID::getObject("TestService4Uid");
            auto srv4   = services::ut::TestServiceImplementation::dynamicCast(gnsrv4);
            CPPUNIT_ASSERT(gnsrv4 != nullptr);
...

    {
        ...
        services::OSR::unregisterServiceOutput("out2", genDataSrv);
        fwTestWaitMacro(core::tools::fwID::exist("TestService5Uid") == false);
        services::OSR::registerServiceOutput(data5, "out2", genDataSrv);
        WAIT_SERVICE_STARTED("TestService5Uid");
...
void AppConfigTest::autoConnectTest()
{
...

    {
        ...
        core::tools::Object::sptr gnsrv2 = core::tools::fwID::getObject("TestService2Uid");
        auto srv2                        = services::ut::TestService::dynamicCast(gnsrv2);
        CPPUNIT_ASSERT(srv2 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv2->getStatus());
        CPPUNIT_ASSERT(!srv2->getIsUpdated());

        core::tools::Object::sptr gnsrv3 = core::tools::fwID::getObject("TestService3Uid");
        auto srv3                        = services::ut::TestSrvAutoconnect::dynamicCast(gnsrv3);
        CPPUNIT_ASSERT(srv3 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv3->getStatus());
    ...
    CPPUNIT_ASSERT(genDataSrv != nullptr);
    {
        ...
        services::OSR::registerServiceOutput(data3, "out3", genDataSrv);

        WAIT_SERVICE_STARTED("TestService4Uid");
        WAIT_SERVICE_STARTED("TestService5Uid");
        {
            core::tools::Object::sptr gnsrv4 = core::tools::fwID::getObject("TestService4Uid");
            auto srv4                        = services::ut::TestService::dynamicCast(gnsrv4);
            CPPUNIT_ASSERT(srv4 != nullptr);
            CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv4->getStatus());
            CPPUNIT_ASSERT(!srv4->getIsUpdated());

            core::tools::Object::sptr gnsrv5 = core::tools::fwID::getObject("TestService5Uid");
            auto srv5                        = services::ut::TestSrvAutoconnect::dynamicCast(gnsrv5);
            CPPUNIT_ASSERT(srv5 != nullptr);
            CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv5->getStatus());
        ...
        // Remove one data
        services::OSR::unregisterServiceOutput("out3", genDataSrv);
        fwTestWaitMacro(core::tools::fwID::exist("TestService4Uid") == false &&
...
void AppConfigTest::connectionTest()
{
    ...
    auto srv4                        = services::ut::TestService::dynamicCast(gnsrv4);
    CPPUNIT_ASSERT(srv4 != nullptr);
    fwTestWaitMacro(services::IService::STARTED == srv4->getStatus());
    CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv4->getStatus());
    ...
    {
        core::tools::Object::sptr gnsrv3 = core::tools::fwID::getObject("TestService3Uid");
        auto srv3                        = services::ut::TestService::dynamicCast(gnsrv3);
        CPPUNIT_ASSERT(srv3 != nullptr);
        fwTestWaitMacro(services::IService::STARTED == srv3->getStatus());
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv3->getStatus());
        srv2->resetIsUpdated();
        CPPUNIT_ASSERT(!srv2->getIsUpdated());
        CPPUNIT_ASSERT(!srv3->getIsUpdated());
...
void AppConfigTest::optionalKeyTest()
{
    ...
    core::tools::Object::sptr gnsrv1 = core::tools::fwID::getObject("TestService1Uid");
    auto srv1                        = services::ut::TestServiceImplementation::dynamicCast(gnsrv1);
    CPPUNIT_ASSERT(srv1 != nullptr);
    CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv1->getStatus());
    CPPUNIT_ASSERT(!srv1->getIsUpdated());
    ...
    data::Boolean::sptr data5 = data::Boolean::New();
    {
        ...
        services::OSR::registerServiceOutput(data5, "out5", genDataSrv);
        WAIT_SERVICE_STARTED("TestService2Uid");

        gnsrv2 = core::tools::fwID::getObject("TestService2Uid");
        CPPUNIT_ASSERT(gnsrv2 != nullptr);
        auto srv2 = services::ut::TestServiceImplementation::dynamicCast(gnsrv2);
        CPPUNIT_ASSERT(srv2 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv2->getStatus());
        CPPUNIT_ASSERT(!srv2->getIsUpdated());
        ...
        // Remove data 3 and 4
        services::OSR::unregisterServiceOutput("out3", genDataSrv);
        services::OSR::unregisterServiceOutput("out4", genDataSrv);
    ...
    // Remove data 5
    {
        services::OSR::unregisterServiceOutput("out5", genDataSrv);
...

    {
        ...
        services::OSR::registerServiceOutput(data2b, "out2", genDataSrv);
        ...
        auto genDataSrv2 = services::ut::TestService::dynamicCast(core::tools::fwID::getObject("SGenerateData2"));
        CPPUNIT_ASSERT(genDataSrv2 != nullptr);

        services::OSR::registerServiceOutput(data2bis, "out", genDataSrv2);
        fwTestWaitMacro(!srv2->getWeakInput< data::Object>(
        ...
        CPPUNIT_ASSERT( data2bis ==
                        services::OSR::getRegistered("out2", services::IService::AccessType::OUTPUT,
                                                     genDataSrv));

        // Revert that
        services::OSR::registerServiceOutput(data2b, "out", genDataSrv2);
...
void AppConfigTest::keyGroupTest()
{
...

    {
        WAIT_SERVICE_STARTED("TestService2Uid");
        core::tools::Object::sptr gnsrv2 = core::tools::fwID::getObject("TestService2Uid");
        auto srv2                        = services::ut::TestSrvAutoconnect::dynamicCast(gnsrv2);
        CPPUNIT_ASSERT(srv2 != nullptr);
        CPPUNIT_ASSERT_EQUAL(services::IService::STARTED, srv2->getStatus());
        CPPUNIT_ASSERT(!srv2->getIsUpdated());
...
void AppConfigTest::concurentAccessToAppConfigTest()
{
    ...
    services::registry::AppConfig::getDefault()->clearRegistry();
    std::vector< std::string > allCconfigs = services::registry::AppConfig::getDefault()->getAllConfigs();
...
void AppConfigTest::parameterReplaceTest()
{
    ...
    auto srvInSubConfig = services::ut::TestService::dynamicCast(gnsubsrv);
...
core::runtime::ConfigurationElement::sptr AppConfigTest::buildConfig()
{
    ...
    serviceA->setAttributeValue("type", "::sight::services::ut::TestServiceImplementationImage" );
