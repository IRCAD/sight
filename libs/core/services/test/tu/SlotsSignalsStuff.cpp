...
fwServicesRegisterMacro( ::sight::services::ut::IBasicTest, ::sight::services::ut::SBasicTest )
fwServicesRegisterObjectMacro(  ::sight::services::ut::SBasicTest, services::ut::Buffer );
fwServicesRegisterMacro( ::sight::services::ut::IBasicTest, ::sight::services::ut::SReaderTest )
fwServicesRegisterObjectMacro(  ::sight::services::ut::SReaderTest, services::ut::Buffer );
fwServicesRegisterMacro( ::sight::services::ut::IBasicTest, ::sight::services::ut::SShowTest )
fwServicesRegisterObjectMacro(  ::sight::services::ut::SShowTest, services::ut::Buffer );
fwServicesRegisterMacro( ::sight::services::ut::IBasicTest, ::sight::services::ut::SReader2Test )
fwServicesRegisterObjectMacro(  ::sight::services::ut::SReader2Test, services::ut::Buffer );
fwServicesRegisterMacro( ::sight::services::ut::IBasicTest, ::sight::services::ut::SShow2Test )
fwServicesRegisterObjectMacro(  ::sight::services::ut::SShow2Test, services::ut::Buffer );

const services::IService::KeyType IBasicTest::s_BUFFER_INOUT = "buffer";
...
services::IService::KeyConnectionsMap SShowTest::getAutoConnections() const
{
