 ...
 */
class TestService : public services::IService
{
...
public:
    ...
    fwCoreServiceMacro(TestService, services::IService)
...
public:
    fwCoreServiceMacro(TestServiceImplementation, services::ut::TestService)
...
public:
    fwCoreServiceMacro(TestServiceImplementation2, services::ut::TestService)
...
public:
    fwCoreServiceMacro(TestSrvAutoconnect, services::ut::TestService)
 ...
 */
class TestServiceWithData : public services::IService
{
public:
    ...
    fwCoreServiceMacro(TestServiceWithData, services::IService)
