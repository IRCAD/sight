...
CPPUNIT_TEST_SUITE_REGISTRATION( ::sight::services::ut::AppManagerTest );
...
{
    m_appMgr = std::unique_ptr< services::AppManager >(new services::AppManager);
    CPPUNIT_ASSERT(m_appMgr);

    m_appMgr->create();

    auto service  = m_appMgr->addService("::sight::services::ut::TestServiceImplementation", "srv1Uid", false, false);
    auto service2 = m_appMgr->addService< services::ut::TestService >(
        "::sight::services::ut::TestServiceImplementation", "srv2Uid", true, false);
    auto service3 = m_appMgr->addService< services::ut::TestService >(
        "::sight::services::ut::TestServiceImplementation", true, true);
    auto service4 = m_appMgr->addService("::sight::services::ut::TestServiceImplementation");

    auto service5 =
        services::registry::ServiceFactory::getDefault()->create("::sight::services::ut::TestServiceImplementation");
...
void AppManagerTest::managerWithObjectTest()
{
    ...
    auto service  = m_appMgr->addService("::sight::services::ut::TestServiceImplementation", "srv1Uid", true, false);
    auto service2 = m_appMgr->addService< services::ut::TestService >(
        "::sight::services::ut::TestServiceImplementation", "srv2Uid", true, false);
    auto service3 = m_appMgr->addService< services::ut::TestService >(
        "::sight::services::ut::TestServiceImplementation", "srv3Uid", true, true);
    auto service4 = m_appMgr->addService< services::ut::TestService >(
        "::sight::services::ut::TestServiceImplementation", true, true);
    ...
    service->registerObject(imageId, "data1", services::IService::AccessType::INPUT);
    service2->registerObject(imageId, "data1", services::IService::AccessType::INPUT, true);
    service3->registerObject(imageId, "data1", services::IService::AccessType::INPUT, false, true);
    service3->registerObject(booleanId, "data2", services::IService::AccessType::INPUT, true, true);
    service4->registerObject(booleanId, "data1", services::IService::AccessType::INPUT, true);
    service4->registerObject(imageId, "data2", services::IService::AccessType::INPUT, true);
    ...
    auto service5 = services::add("::sight::services::ut::TestServiceImplementation");
    service5->registerObject(imageId, "data1", services::IService::AccessType::INPUT, false, false);
    service5->registerObject(booleanId, "data2", services::IService::AccessType::INPUT, true, false);
...
void AppManagerTest::managerWithObjectConnectionTest()
{
    ...
    auto service1 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", "myService1", true, false);
    auto service2 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", "myService2", true, false);
    auto service3 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", "myService3",  true, false);
    auto service4 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", "myService4", true, false);
    ...
    service1->registerObject(imageId, "data1", services::IService::AccessType::INPUT);
    service2->registerObject(imageId, "data1", services::IService::AccessType::INPUT, true);
    service3->registerObject(imageId, "data1", services::IService::AccessType::INPUT, false, true);
    service3->registerObject(booleanId, "data2", services::IService::AccessType::INPUT, true, true);
    service4->registerObject(imageId, "data1", services::IService::AccessType::INPUT, true);
    service4->registerObject(booleanId, "data2", services::IService::AccessType::INPUT, true);
    ...
    m_appMgr->removeObject(image, imageId);
    services::helper::ProxyConnections connection(imageChannel);
    connection.addSignalConnection(imageId,  data::Image::s_MODIFIED_SIG);
    connection.addSlotConnection(service1->getID(), services::ut::TestSrvAutoconnect::s_SLOT_1);
...
void AppManagerTest::managerWithServiceConnectionTest()
{
    ...
    auto service1 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", true);
    auto service2 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", true);
    auto service3 = m_appMgr->addService< services::ut::TestSrvAutoconnect >(
        "::sight::services::ut::TestSrvAutoconnect", true);
    ...
    services::helper::ProxyConnections connection1;
    connection1.addSignalConnection(service1->getID(), services::ut::TestSrvAutoconnect::s_SIG_1);
    connection1.addSlotConnection(service2->getID(), services::ut::TestSrvAutoconnect::s_SLOT_1);
    m_appMgr->addProxyConnection(connection1);

    services::helper::ProxyConnections connection2(channel);
    connection2.addSignalConnection(service1->getID(), services::ut::TestSrvAutoconnect::s_UPDATED_SIG);
    connection2.addSlotConnection(service3->getID(), services::ut::TestSrvAutoconnect::s_SLOT_1);
    ...
    auto sig = service1->signal< services::ut::TestSrvAutoconnect::MsgSentSignalType >(
        services::ut::TestSrvAutoconnect::s_SIG_1);
    sig->emit(3);
...
void AppManagerTest::managerWithOutputCreationTest()
{
    ...
    auto service1 = m_appMgr->addService< services::ut::TestServiceWithData >(
        "::sight::services::ut::TestServiceWithData", true, true);
    auto service2 = m_appMgr->addService< services::ut::TestServiceWithData >(
        "::sight::services::ut::TestServiceWithData", true);
    auto service3 = m_appMgr->addService< services::ut::TestServiceWithData >(
        "::sight::services::ut::TestServiceWithData", true);
    auto service4 = m_appMgr->addService< services::ut::TestServiceWithData >(
        "::sight::services::ut::TestServiceWithData", true);
    ...
    service1->setObjectId(services::ut::TestServiceWithData::s_INPUT, integerId);
    service1->setObjectId(services::ut::TestServiceWithData::s_OUTPUT, generatedIntegerId);
    service2->setObjectId(services::ut::TestServiceWithData::s_INPUT, generatedIntegerId);
    service3->setObjectId(services::ut::TestServiceWithData::s_INPUT, integerId);
    service3->setObjectId(services::ut::TestServiceWithData::s_OUTPUT, generatedInteger2Id);
    service4->setObjectId(services::ut::TestServiceWithData::s_INPUT, generatedInteger2Id);
    ...
    auto integer2 = service1->getOutput< data::Integer >(services::ut::TestServiceWithData::s_OUTPUT);
    CPPUNIT_ASSERT(integer2);
    CPPUNIT_ASSERT_EQUAL(integer1->getValue(), integer2->value());
    CPPUNIT_ASSERT(nullptr ==
                   service3->getOutput< data::Integer >(services::ut::TestServiceWithData::s_OUTPUT));

    service3->update().wait();

    auto integer3 = service3->getOutput< data::Integer >(services::ut::TestServiceWithData::s_OUTPUT);
...
void AppManagerTest::managerWithGroupTest()
{
    ...
    CPPUNIT_ASSERT_EQUAL(size_t(2), service1->getKeyGroupSize(services::ut::TestServiceWithData::s_INOUT_GROUP));
    service1->setObjectId(services::ut::TestServiceWithData::s_INPUT, integerId0);
    service1->setObjectId(services::ut::TestServiceWithData::s_INOUT_GROUP, 0, integerId1);
    service1->setObjectId(services::ut::TestServiceWithData::s_INOUT_GROUP, 1, integerId2);
    service1->setObjectId(services::ut::TestServiceWithData::s_INOUT_GROUP, 2, integerId3);
    CPPUNIT_ASSERT_EQUAL(size_t(3), service1->getKeyGroupSize(services::ut::TestServiceWithData::s_INOUT_GROUP));
    m_appMgr->addObject(integer0, integerId0);

    m_appMgr->startServices();

    CPPUNIT_ASSERT_EQUAL(true, service1->hasObjectId(
                             KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 0)));
    CPPUNIT_ASSERT_EQUAL(integerId1, service1->getObjectId(
                             KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 0)));
    CPPUNIT_ASSERT_EQUAL(true, service1->hasObjectId(
                             KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 1)));
    CPPUNIT_ASSERT_EQUAL(integerId2, service1->getObjectId(
                             KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 1)));
    CPPUNIT_ASSERT_EQUAL(true, service1->hasObjectId(
                             KEY_GROUP_NAME(services::ut::TestServiceWithData::s_INOUT_GROUP, 2)));
