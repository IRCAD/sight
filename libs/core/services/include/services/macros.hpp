...
#include "services/ServiceFactoryRegistrar.hpp"
...
#define __FWSERVICES_REGISTER_MACRO( ServiceType, ServiceImpl )                                    \
    ...
    static ::sight::services::ServiceFactoryRegistrar< ServiceImpl >                                    \
...
#define __FWSERVICES_REGISTER_OBJECT_MACRO( ServiceImpl, ServiceObject )                           \
    ...
    static ::sight::services::ServiceObjectFactoryRegistrar                                             \
