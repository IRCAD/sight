 ...
 *        "::sight::services::registry::AppConfig".
 */
class SERVICES_CLASS_API AppConfig : public core::BaseObject
{
...
public:
    ...
    /// Destructor
    SERVICES_API virtual ~AppConfig();
     ...
     * @note This method is thread safe
     */
    SERVICES_API void addAppInfo( const std::string& configId,
     ...
     * @note This method is thread safe.
     */
    SERVICES_API core::runtime::ConfigurationElement::csptr getAdaptedTemplateConfig( const std::string& configId,
     ...
     */
    SERVICES_API std::shared_ptr< core::runtime::Module > getModule(const std::string& _configId);

    /**
     * @brief Return all configurations ( standard and template ) register in the registry.
     * @note This method is thread safe.
     */
    SERVICES_API std::vector< std::string > getAllConfigs() const;

    /**
     * @brief Return all configurations with specified group.
     * @note This method is thread safe.
     */
    SERVICES_API std::vector< std::string > getConfigsFromGroup(const std::string& group) const;
     ...
     * @note This method is thread safe.
     */
    SERVICES_API static std::string getUniqueIdentifier(const std::string& serviceUid = "" );

    /// Return an instance of AppConfig.
    SERVICES_API static AppConfig::sptr getDefault();
