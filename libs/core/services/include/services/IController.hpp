 ...
 */
class SERVICES_CLASS_API IController : public services::IService
{

public:

    fwCoreServiceMacro(IController, services::IService)

protected:

    ///@brief IController constructor. Do nothing.
    SERVICES_API IController();

    ///@brief IController destructor. Do nothing.
    SERVICES_API virtual ~IController();
