...
services::registry::ObjectService::sptr get()
{
    return core::util::LazyInstantiator< services::registry::ObjectService >::getInstance();
}
...
{
    return services::OSR::get()->getRegistryInformation();
}

//------------------------------------------------------------------------------

services::registry::ObjectService::ServiceVectorType getServices( const std::string& serviceType )
{
    return services::OSR::get()->getServices(serviceType);
}

//------------------------------------------------------------------------------

void registerService( services::IService::sptr service )
{
    services::OSR::get()->registerService(service);
}

//------------------------------------------------------------------------------

void registerService( data::Object::sptr obj, const services::IService::KeyType& objKey,
                      services::IService::AccessType access, services::IService::sptr service )
{
    services::OSR::get()->registerService(obj, objKey, access, service);
}

//------------------------------------------------------------------------------

void registerServiceInput( data::Object::csptr obj, const services::IService::KeyType& objKey,
                           services::IService::sptr service )
{
    services::OSR::get()->registerServiceInput(obj, objKey, service);
}

//------------------------------------------------------------------------------

void registerServiceOutput( data::Object::sptr obj, const services::IService::KeyType& objKey,
                            services::IService::sptr service )
{
    services::OSR::get()->registerServiceOutput(obj, objKey, service);
}

//------------------------------------------------------------------------------

void unregisterService(  services::IService::sptr service )
{
    services::OSR::get()->unregisterService(service);
}

//------------------------------------------------------------------------------

void unregisterService(const services::IService::KeyType& objKey, services::IService::AccessType access,
                       IService::sptr service)
{
    services::OSR::get()->unregisterService(objKey, access, service);
}

//------------------------------------------------------------------------------

void unregisterServiceOutput(const services::IService::KeyType& objKey,  IService::sptr service)
{
    services::OSR::get()->unregisterServiceOutput(objKey, service);
}

//------------------------------------------------------------------------------

bool isRegistered(const services::IService::KeyType& objKey,
                  services::IService::AccessType access, IService::sptr service)
{
    return services::OSR::get()->isRegistered(objKey, access, service);
}

//------------------------------------------------------------------------------

data::Object::csptr getRegistered(const services::IService::KeyType& objKey,
                                  services::IService::AccessType access, IService::sptr service)
{
    return services::OSR::get()->getRegistered(objKey, access, service);
}
...
void ObjectService::registerService( services::IService::sptr service )
{
...
void ObjectService::registerService( data::Object::sptr object, const services::IService::KeyType& objKey,
                                     services::IService::AccessType access, services::IService::sptr service)
{
    core::mt::WriteLock writeLock(m_containerMutex);
...
void ObjectService::registerServiceOutput(data::Object::sptr object, const services::IService::KeyType& objKey,
                                          services::IService::sptr service)
{

    core::mt::WriteLock writeLock(m_containerMutex);
    this->internalRegisterService(object, service, objKey, services::IService::AccessType::OUTPUT);
...
void ObjectService::unregisterService( services::IService::sptr service )
{
    core::mt::WriteLock writeLock(m_containerMutex);
...
void ObjectService::unregisterService(const services::IService::KeyType& objKey,
                                      services::IService::AccessType access,
                                      services::IService::sptr service )
{
    core::mt::WriteLock writeLock(m_containerMutex);

    if(access == services::IService::AccessType::INPUT)
    {
        service->m_inputsMap.erase(objKey);
    }
    else if(access == services::IService::AccessType::INOUT)
    {
...
void ObjectService::unregisterServiceOutput( const services::IService::KeyType& objKey,
                                             services::IService::sptr service )
{
    core::mt::WriteLock writeLock(m_containerMutex);
...
bool ObjectService::isRegistered(const services::IService::KeyType& objKey,
                                 services::IService::AccessType access, IService::sptr service) const
{
...
data::Object::csptr ObjectService::getRegistered(const services::IService::KeyType& objKey,
                                                 services::IService::AccessType access,
...
void ObjectService::internalRegisterService(data::Object::sptr object, services::IService::sptr service,
                                            const services::IService::KeyType& objKey,
                                            services::IService::AccessType access)
{
...
void ObjectService::removeFromContainer( services::IService::sptr service )
{
