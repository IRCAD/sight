...
#include "services/factory/new.hpp"
 ...
 */
class SERVICES_CLASS_API IService : public core::tools::Object,
...
public:
    ...
    SERVICES_API static const std::string s_DEFAULT_OBJECT;
     ...
     */
    //@{
    SERVICES_API static const core::com::Signals::SignalKeyType s_STARTED_SIG;
    typedef core::com::Signal<void ()> StartedSignalType;

    SERVICES_API static const core::com::Signals::SignalKeyType s_UPDATED_SIG;
    typedef core::com::Signal<void ()> UpdatedSignalType;

    SERVICES_API static const core::com::Signals::SignalKeyType s_STOPPED_SIG;
    typedef core::com::Signal<void ()> StoppedSignalType;

    SERVICES_API static const core::com::Signals::SignalKeyType s_INFO_NOTIFIED_SIG;
    typedef core::com::Signal<void (std::string)> InfoNotifiedSignalType;

    SERVICES_API static const core::com::Signals::SignalKeyType s_SUCCESS_NOTIFIED_SIG;
    typedef core::com::Signal<void (std::string)> SuccessNotifiedSignalType;

    SERVICES_API static const core::com::Signals::SignalKeyType s_FAILURE_NOTIFIED_SIG;
    ...
    SERVICES_API static const core::com::Slots::SlotKeyType s_START_SLOT;
    typedef core::com::Slot<SharedFutureType()> StartSlotType;

    SERVICES_API static const core::com::Slots::SlotKeyType s_STOP_SLOT;
    typedef core::com::Slot<SharedFutureType()> StopSlotType;

    SERVICES_API static const core::com::Slots::SlotKeyType s_UPDATE_SLOT;
    typedef core::com::Slot<SharedFutureType()> UpdateSlotType;

    SERVICES_API static const core::com::Slots::SlotKeyType s_SWAP_SLOT;
    typedef core::com::Slot<SharedFutureType(data::Object::sptr)> SwapSlotType;

    SERVICES_API static const core::com::Slots::SlotKeyType s_SWAPKEY_SLOT;
    ...
    SERVICES_API void setWorker( SPTR(core::thread::Worker) worker );

    /// Returns associate worker
    SERVICES_API SPTR(core::thread::Worker) getWorker() const;
     ...
     */
    SERVICES_API void setConfiguration( const core::runtime::ConfigurationElement::sptr _cfgElement );
     ...
     * @post m_configurationState == UNCONFIGURED
     */
    SERVICES_API void setConfiguration( const Config& _configuration);
     ...
     * @post m_configurationState == UNCONFIGURED
     */
    SERVICES_API void setConfiguration( const ConfigType& ptree );
     ...
     * @param[in] ptree property tree
     */
    SERVICES_API void configure( const ConfigType& ptree );
     ...
     *
     */
    SERVICES_API SharedFutureType swapKey( const KeyType& _key, data::Object::sptr _obj );
    //@}
     ...
     */
    SERVICES_API core::runtime::ConfigurationElement::sptr getConfiguration() const;

    /**
     * @brief Return the configuration, in an boost property tree
     */
    SERVICES_API ConfigType getConfigTree() const;
    //@}
     ...
     * @return m_inputsMap
     */
    SERVICES_API const InputMapType& getInputs() const;

    /**
     * @brief Return the inouts map associated to service
     * @return m_inoutsMap
     */
    SERVICES_API const InOutMapType& getInOuts() const;

    /**
     * @brief Return the outouts map associated to service
     * @return m_outputsMap
     */
    SERVICES_API const OutputMapType& getOutputs() const;
     ...
     */
    SERVICES_API void setOutput(const services::IService::KeyType& key, const data::Object::sptr& object,
                                size_t index = 0);
     ...
     */
    SERVICES_API friend std::ostream& operator<<(std::ostream& _sstream, IService& _service);

    /**
     * @brief Return true if the object with the given key has an identifier.
     * @param _key object key
     */
    SERVICES_API bool hasObjectId(const KeyType& _key) const;

    /**
     * @brief Return the id of the object, throw if it is not found
     */
    SERVICES_API IdType getObjectId(const KeyType& _key) const;

    /**
     * @brief Set the id of an object key
     */
    SERVICES_API void setObjectId(const KeyType& _key, const IdType& _id);

    /**
     * @brief Set the id of an object key from a group
     */
    SERVICES_API void setObjectId(const IService::KeyType& _key, const size_t index, const IService::IdType& _id);
    //@}
     ...
     */
    SERVICES_API void registerInput(const data::Object::csptr& obj, const std::string& key,
     ...
     * @param[in] key key of the object
     */
    SERVICES_API void unregisterInput(const std::string& key);
     ...
     * @param[in] optional if true, the service can be started even if the objet is not present
     */
    SERVICES_API void registerInOut(const data::Object::sptr& obj, const std::string& key,
                                    const bool autoConnect = false, const bool optional = false);
     ...
     * @param[in] key key of the object
     */
    SERVICES_API void unregisterInOut(const std::string& key);
     ...
     * @param[in] optional if true, the service can be started even if the objet is not present
     */
    SERVICES_API void registerObject(const data::Object::sptr& obj, const std::string& key,
     ...
     * @param[in] optional if true, the service can be started even if the objet is not present
     */
    SERVICES_API void registerObject(const std::string& objId, const std::string& key,
                                     AccessType access, const bool autoConnect = false, const bool optional = false);
     ...
     * @param[in] key key of the object
     */
    SERVICES_API void unregisterObject(const std::string& key, AccessType access);
     ...
     * @param[in] objId identifier of the object to be used by the service.
     */
    SERVICES_API void unregisterObject(const std::string& objId);

    /// Return true if all the non-optional object required by the service are present
    SERVICES_API bool hasAllRequiredObjects() const;
...
protected:
     ...
     */
    SERVICES_API virtual ~IService() override;
     ...
     * @see start()
     */
    SERVICES_API virtual void starting() = 0;
     ...
     * @see stop()
     */
    SERVICES_API virtual void stopping() = 0;
     ...
     * @see configure()
     */
    SERVICES_API virtual void configuring() = 0;
     ...
     * @see configure()
     */
    SERVICES_API virtual void reconfiguring();
     ...
     * @see update()
     */
    SERVICES_API virtual void updating() = 0;
     ...
     */
    SERVICES_API virtual void info( std::ostream& _sstream );

    /**
     * @brief Returns proposals to connect service slots to associated objects signals,
     * this method is used for obj/srv auto connection
     */
    SERVICES_API virtual KeyConnectionsMap getAutoConnections() const;
    //@}
     ...
     * @param[in] optional if true, the service can be started even if the objet is not present
     */
    SERVICES_API void registerObject(const std::string& key, AccessType access, const bool autoConnect = false,
     ...
     */
    SERVICES_API void registerObjectGroup(const std::string& key, AccessType access, const std::uint8_t minNbObject,
...
private:
    ...
    const services::IService::ObjectServiceConfig& getObjInfoFromId(const std::string& objId) const;

    /// Return the information about the required object
    const services::IService::ObjectServiceConfig& getObjInfoFromKey(const std::string& key) const;
     ...
     */
    services::IService::Config m_serviceConfig;
