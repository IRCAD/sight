...
#include "services/parser/Color.hpp"
...
fwServicesRegisterMacro( ::sight::services::IXMLParser, ::sight::services::parser::Color)
fwServicesRegisterObjectMacro( ::sight::services::parser::Color, ::sight::data::Color)
