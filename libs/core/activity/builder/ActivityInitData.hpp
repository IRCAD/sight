 ...
 */
class ACTIVITY_CLASS_API ActivityInitData : public activity::builder::Activity
{
public:
    ...
    SIGHT_DECLARE_CLASS(
        ActivityInitData,
        activity::IBuilder,
        activity::builder::factory::New<ActivityInitData>
    )

    typedef std::string RegistryKeyType;

    /// Constructor. Do nothing.
    ACTIVITY_API ActivityInitData(activity::IBuilder::Key key);

    /// Destructor. Do nothing.
    ACTIVITY_API virtual ~ActivityInitData() = default;

    /**
     * @brief Instanciates a new object where requirement maxOccurs and minOccurs are both set to 0.
     * @see activity::builder::Activity::buildData
     */
